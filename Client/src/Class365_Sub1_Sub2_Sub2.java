...
public class Class365_Sub1_Sub2_Sub2 extends Class365_Sub1_Sub2 implements
	...
	public Class334 method4358(GraphicsToolkit class_ra, byte i) {
		try {
			...
			if (((Class365_Sub1_Sub2_Sub2) this).aClass334_9920 == null)
				((Class365_Sub1_Sub2_Sub2) this).aClass334_9920 = Class472
						.method6063((int) class217.aFloat2451,
								(int) class217.aFloat2455,
								(int) class217.aFloat2454, method4501(class_ra,
										0, (byte) 68), 2029931481);
			return ((Class365_Sub1_Sub2_Sub2) this).aClass334_9920;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("wo.bc(").append(')').toString());
		}
	}
	...
	DrawableModel method4501(GraphicsToolkit class_ra, int i, byte i_0_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("wo.by(").append(')').toString());
		}
	}

	Class454 method4502(GraphicsToolkit class_ra, int i, boolean bool, int i_1_) {
		try {
			ObjectDefinitions class432 = (((Class365_Sub1_Sub2_Sub2) this).aClass433_9918
					.getObjectDefinitions(
							2049836463 * ((Class365_Sub1_Sub2_Sub2) this).anInt9915));
			Class_xa class_xa;
	...
	public void method37(GraphicsToolkit class_ra, int i) {
		try {
			Object object = null;
			Class_na class_na;
			if (((Class365_Sub1_Sub2_Sub2) this).aClass_na9914 == null
					&& ((Class365_Sub1_Sub2_Sub2) this).aBoolean9921) {
				Class454 class454 = method4502(class_ra, 262144, true,
						-1850458180);
	...
	public Class365_Sub1_Sub2_Sub2(Class331 class331, GraphicsToolkit class_ra,
			Class433 class433, ObjectDefinitions class432, int i, int i_9_, int i_10_,
			int i_11_, int i_12_, boolean bool, int i_13_, boolean bool_14_) {
		super(class331, i_10_, i_11_, i_12_, i, i_9_, class432.anInt5418
				* -228547261);
		...
		((Class365_Sub1_Sub2_Sub2) this).aBoolean9919 = class432.anInt5382 * 1532834983 != 0
				&& !bool;
		((Class365_Sub1_Sub2_Sub2) this).aBoolean9912 = bool_14_;
		((Class365_Sub1_Sub2_Sub2) this).aBoolean9921 = (class_ra.method5082()
				&& class432.aBoolean5433
				&& !((Class365_Sub1_Sub2_Sub2) this).aBoolean9916 && Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub7_7581
				.method5650(-1930969884) != 0);
		int i_15_ = 2048;
	...
	public Class334 method4367(GraphicsToolkit class_ra) {
		...
		if (((Class365_Sub1_Sub2_Sub2) this).aClass334_9920 == null)
			((Class365_Sub1_Sub2_Sub2) this).aClass334_9920 = Class472
					.method6063((int) class217.aFloat2451,
							(int) class217.aFloat2455,
							(int) class217.aFloat2454, method4501(class_ra, 0,
									(byte) 71), 1982463178);
		return ((Class365_Sub1_Sub2_Sub2) this).aClass334_9920;
	}
	...
	static final void method4503(Class403 class403, int i) {
		try {
			...
			if (i_26_ < 0
					|| i_26_ >= ((Class403) class403).anIntArray5236[i_25_])
