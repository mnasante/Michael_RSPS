	...
	void decode(RsByteBuffer stream, int i, int i_0_) {
		try {
			if (1 == i) {
				...
				((ObjectDefinitions) this).anInt5392 = stream
						.readByte(-12558881)
						* -62240291;
			else if (39 == i)
				((ObjectDefinitions) this).anInt5393 = stream
						.readByte(-12558881)
						* -1530589831;
			else if (i >= 30 && i < 35)
				aStringArray5394[i - 30] = stream
						.readString(2140843487);
			else if (i == 40) {
				int i_6_ = stream.readUnsignedByte();
				((ObjectDefinitions) this).aShortArray5369 = new short[i_6_];
				aShortArray5367 = new short[i_6_];
				for (int i_7_ = 0; i_7_ < i_6_; i_7_++) {
					((ObjectDefinitions) this).aShortArray5369[i_7_] = (short) stream
							.readUnsignedShort();
					aShortArray5367[i_7_] = (short) stream
							.readUnsignedShort();
				}
			} else if (i == 41) {
				...
				for (int i_9_ = 0; i_9_ < i_8_; i_9_++) {
					((ObjectDefinitions) this).aShortArray5372[i_9_] = (short) stream
							.readUnsignedShort();
					aShortArray5373[i_9_] = (short) stream
							.readUnsignedShort();
				}
			} else if (i == 42) {
				...
				for (int i_11_ = 0; i_11_ < i_10_; i_11_++)
					((ObjectDefinitions) this).aByteArray5371[i_11_] = stream
							.readByte(-12558881);
			} else if (i == 62)
				aBoolean5404 = true;
			else if (64 == i)
				...
				((ObjectDefinitions) this).anInt5406 = stream
						.readUnsignedShort() * 929519655;
			else if (66 == i)
				((ObjectDefinitions) this).anInt5407 = stream
						.readUnsignedShort()
						* -1076239419;
			else if (i == 67)
				((ObjectDefinitions) this).anInt5414 = stream
						.readUnsignedShort() * 1192395179;
			else if (i == 69)
				stream.readUnsignedByte();
			else if (i == 70)
				((ObjectDefinitions) this).anInt5379 = (stream
						.readShort(1954619354) << 2) * 804752437;
			else if (i == 71)
				((ObjectDefinitions) this).anInt5396 = ((stream
						.readShort(1981333343) << 2) * -830213317);
			else if (i == 72)
				((ObjectDefinitions) this).anInt5411 = ((stream
						.readShort(2079097901) << 2) * 1957563615);
			else if (i == 73)
				aBoolean5410 = true;
			else if (i == 74)
				aBoolean5416 = true;
				...
				for (int i_16_ = 0; i_16_ < i_15_; i_16_++)
					anIntArray5429[i_16_] = stream
							.readUnsignedShort();
			} else if (81 == i) {
				((ObjectDefinitions) this).aByte5363 = (byte) 2;
				((ObjectDefinitions) this).anInt5384 = stream
						.readUnsignedByte()
						* -1868938496;
			} else if (i == 82)
				aBoolean5432 = true;
				...
				for (int i_19_ = 0; i_19_ < i_17_; i_19_++) {
					((ObjectDefinitions) this).anIntArray5378[i_19_] = stream
							.readBigSmart(1235052657);
					i_18_ += ((ObjectDefinitions) this).anIntArray5390[i_19_] = stream
							.readUnsignedByte();
				}
				...
				((ObjectDefinitions) this).aByte5417 = stream
						.readByte(-12558881);
				((ObjectDefinitions) this).aByte5375 = stream
						.readByte(-12558881);
				((ObjectDefinitions) this).aByte5415 = stream
						.readByte(-12558881);
				((ObjectDefinitions) this).aByte5377 = stream
						.readByte(-12558881);
			} else if (i == 164)
				((ObjectDefinitions) this).anInt5412 = stream
						.readShort(2119621102)
						* -1121469985;
			else if (165 == i)
				((ObjectDefinitions) this).anInt5413 = stream
						.readShort(1762145274) * 1097094883;
			else if (166 == i)
				((ObjectDefinitions) this).anInt5419 = stream
						.readShort(1892618723)
						* -870210675;
			else if (i == 167)
				...
				anInt5437 = stream.readUnsignedByte()
						* -1122029857;
			else if (i == 189)
				aBoolean5441 = true;
			else if (i == 249) {
				...
				for (int i_29_ = 0; i_29_ < aByteArray5430.length; i_29_++) {
					if (aByteArray5430[i_29_] == i) {
						for (int i_30_ = 0; i_30_ < modelIds[i_29_].length; i_30_++) {
							if (!((Class433) ((ObjectDefinitions) this).aClass433_5403).aClass243_5447
									.method2290(
											modelIds[i_29_][i_30_],
											0, -1404450418))
								bool = false;
						}
					}
			...
			synchronized (((Class433) ((ObjectDefinitions) this).aClass433_5403).aClass243_5447) {
				for (int i_31_ = 0; i_31_ < modelIds.length; i_31_++) {
					for (int i_32_ = 0; i_32_ < modelIds[i_31_].length; i_32_++)
						bool &= (((Class433) ((ObjectDefinitions) this).aClass433_5403).aClass243_5447
								.method2290(modelIds[i_31_][i_32_],
										0, -1427920512));
				}
			}
			return bool;
		...
		try {
			...
			if (((ObjectDefinitions) this).aByte5363 == 3)
				...
				if (((ObjectDefinitions) this).aByte5363 != 0
						|| 0 != 52797131 * ((ObjectDefinitions) this).anInt5413)
					i |= 0x2;
		...
		try {
			...
			if (i_44_ == 0) {
				if (-166422633 * ((ObjectDefinitions) this).anInt5406 != 128
						|| ((ObjectDefinitions) this).anInt5379 * -1514641891 != 0)
					i |= 0x1;
				if (128 != ((ObjectDefinitions) this).anInt5414 * -895192829
						|| 0 != 2145431327 * ((ObjectDefinitions) this).anInt5411)
					i |= 0x4;
			} else
				i |= 0xd;
			if (128 != 668312333 * ((ObjectDefinitions) this).anInt5407
					|| ((ObjectDefinitions) this).anInt5396 * 1536191987 != 0)
				i |= 0x2;
			...
			if (null != aByteArray5430) {
				...
				if (i_49_ == -1)
					return null;
				int[] is = ((class435 != null && ((Class435) class435).anIntArray5463 != null) ? ((Class435) class435).anIntArray5463
						: modelIds[i_49_]);
				int i_51_ = is.length;
				if (i_51_ > 0) {
					...
					if (null == drawableModel
						...
						synchronized (((Class433) ((ObjectDefinitions) this).aClass433_5403).aClass64Array5443) {
							for (int i_54_ = 0; i_54_ < i_51_; i_54_++) {
								synchronized (((Class433) (((ObjectDefinitions) this).aClass433_5403)).aClass243_5447) {
									class64 = (Class64
											.method751(
													(((Class433) (((ObjectDefinitions) this).aClass433_5403)).aClass243_5447),
													is[i_54_], 0));
								}
								if (null == class64) {
								...
								if (class64.anInt630 < 13)
									class64.method755(2);
								if (i_51_ > 1)
									((Class433) ((ObjectDefinitions) this).aClass433_5403).aClass64Array5443[i_54_] = class64;
							}
							if (i_51_ > 1)
								class64 = new Class64(
						...
						drawableModel = class_ra
								.method5037(
										class64,
										i_53_,
										(((Class433) (((ObjectDefinitions) this).aClass433_5403)).anInt5453)
			...
			if (null != ((ObjectDefinitions) this).aShortArray5369) {
				short[] is;
				if (class435 != null
						&& ((Class435) class435).aShortArray5462 != null)
			...
			if (null != ((ObjectDefinitions) this).aShortArray5372) {
				short[] is;
				if (null != class435
						&& null != ((Class435) class435).aShortArray5461)
	...
	public final ObjectDefinitions method5777(Interface23 interface23, int i) {
		try {
			...
			if (((ObjectDefinitions) this).anInt5420 * 1064010385 != -1)
				i_61_ = interface23.method250(
						(((ObjectDefinitions) this).anInt5420 * 1064010385), (byte) 36);
			else if (-1128963393 * ((ObjectDefinitions) this).anInt5421 != -1)
				i_61_ = interface23.method252(
						(((ObjectDefinitions) this).anInt5421 * -1128963393), (byte) 99);
			if (i_61_ < 0 || i_61_ >= anIntArray5366.length - 1
					|| -1 == anIntArray5366[i_61_]) {
				int i_62_ = anIntArray5366[anIntArray5366.length - 1];
				if (-1 != i_62_)
					return ((ObjectDefinitions) this).aClass433_5403.getObjectDefinitions(i_62_);
				return null;
			}
			return ((ObjectDefinitions) this).aClass433_5403.getObjectDefinitions(
					anIntArray5366[i_61_]);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("rw.x(").append(')').toString());
		}
	}
		...
		try {
			...
			for (int i_67_ = 0; i_67_ < anIntArray5366.length; i_67_++) {
				if (anIntArray5366[i_67_] != -1) {
					ObjectDefinitions class432_68_ = ((ObjectDefinitions) this).aClass433_5403
							.getObjectDefinitions(anIntArray5366[i_67_]);
					if (-1 != 393750945 * class432_68_.anInt5422
							|| null != class432_68_.anIntArray5429)
						return true;
				}
			}
			return false;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("rw.n(").append(')').toString());
		}
	}

	public final synchronized Class454 method5785(GraphicsToolkit class_ra, int i,
			int i_69_, int i_70_, Class_xa class_xa, Class_xa class_xa_71_,
			int i_72_, int i_73_, int i_74_, boolean bool, Class435 class435,
			int i_75_) {
		try {
			...
			if (3 == ((ObjectDefinitions) this).aByte5363)
				...
				if (0 != ((ObjectDefinitions) this).aByte5363
						|| 52797131 * ((ObjectDefinitions) this).anInt5413 != 0)
					i_76_ |= 0x2;
				if (945504799 * ((ObjectDefinitions) this).anInt5412 != 0)
					i_76_ |= 0x1;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("rw.k(").append(')').toString());
		}
	}

	public static Interface19 method5786(RsByteBuffer class298_sub53, byte i) {
		try {
			Class337 class337 = Class291.method2789(class298_sub53
