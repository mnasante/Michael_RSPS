...
public class NPC extends Entity {
	...
	public Class503 aClass503_10190;
	int anInt10191;
	int anInt10192;
	int anInt10193;
	...
	void method4453(int i) {
		try {
			((NPC) this).anInt10188 = (32 + (int) (Math
					.random() * 4.0))
					* -1382184985;
			((NPC) this).anInt10191 = (3 + (int) (Math
					.random() * 2.0))
					* -1827850421;
			((NPC) this).anInt10192 = (16 + (int) (Math
					.random() * 3.0))
					* -1891288283;
			if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub16_7557
					.method5687(2100839354) == 1)
				((NPC) this).anInt10193 = (int) (Math
						.random() * 6.0) * 818502475;
			else
				((NPC) this).anInt10193 = (int) (Math
						.random() * 12.0) * 818502475;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ake.gf(").append(')').toString());
		}
	}

	void method4373(GraphicsToolkit class_ra) {
		if (aClass503_10190 != null
				&& (((NPC) this).aBoolean10128 || method4454(
						class_ra, 0, 498700808))) {
	...
	Class335 method4394(GraphicsToolkit class_ra, int i) {
		try {
			if (aClass503_10190 == null
					|| !method4454(class_ra, 526336, -1241441124))
				return null;
			Class222 class222 = method4347();
			Class235 class235 = method4337();
			Class222 class222_2_ = class_ra.method5178();
			...
			class222_2_
					.method2064(
							0.0F,
							(float) (-20 - ((NPC) this).anInt10122
									* -661498661), 0.0F);
			Class350 class350 = method4426(1744135386);
			Class503 class503 = (aClass503_10190.anIntArray6188 != null ? aClass503_10190
					.method6240(Class128.aClass148_6331, 1631739764)
					: aClass503_10190);
			((NPC) this).aBoolean10129 = false;
			Class335 class335 = null;
			if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub18_7561
					.method5693(-1104068428) == 1
					&& class503.aBoolean6165 && class350.aBoolean3756) {
				Class438 class438 = ((aClass438_10078.method5819((byte) -29) && aClass438_10078
			...
			if (((NPC) this).aClass351_10067 != null) {
				Class69 class69 = ((NPC) this).aClass351_10067
						.method4229();
	...
	boolean method4454(GraphicsToolkit class_ra, int i, int i_8_) {
		try {
			...
			Class438 class438 = ((aClass438_10078.method5819((byte) -97) && !aClass438_10078
					.method5826(-65534)) ? aClass438_10078 : null);
			Class438 class438_10_ = ((aClass438_10077.method5819((byte) -121) && (!aBoolean10094 || null == class438)) ? aClass438_10077
					: null);
			int i_11_ = 250567115 * class350.anInt3735;
			int i_12_ = 1110265995 * class350.anInt3736;
			if (0 != i_11_ || i_12_ != 0
					|| class350.anInt3748 * 1185872679 != 0
					|| -330229359 * class350.anInt3751 != 0)
				i |= 0x7;
			boolean bool = (0 != aByte10130
					&& 443738891 * client.anInt8884 >= anInt10105 * 1920148979 && client.anInt8884 * 443738891 < anInt10106 * 1953154657);
			if (bool)
				i |= 0x80000;
	...
	public final void method4455(Class274 class274, int i, short i_15_) {
		try {
				...
				if (currentGraphics[i_18_].id * -967533709 != -1) {
					Class398 class398 = (Class158_Sub1.aClass389_8568
							.method4857(-967533709
									* currentGraphics[i_18_].id,
									-1708083255));
					if (class398.aBoolean5215
							&& class398.anInt5205 * 1505778629 != -1
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ake.gk(").append(')').toString());
		}
	}

	public void method4456(int i, int i_20_, int i_21_, boolean bool,
			int i_22_, byte i_23_) {
		try {
			plane = aByte7724 = (byte) i;
			if (client.aClass283_8716.method2654(1132456995).method2320(i_20_,
					i_21_, 1587070733))
				aByte7724++;
			...
			for (int i_24_ = 0; i_24_ < currentGraphics.length; i_24_++) {
				if (-1 != currentGraphics[i_24_].id * -967533709) {
					Class398 class398 = (Class158_Sub1.aClass389_8568
							.method4857(-967533709
									* currentGraphics[i_24_].id,
									-1738473272));
					if (class398.aBoolean5215
							&& -1 != 1505778629 * class398.anInt5205
			...
			class217.method2006();
			if (((NPC) this).aClass351_10067 != null)
				((NPC) this).aClass351_10067
						.method4220();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ake.gr(").append(')').toString());
		}
	}
	...
	int method4432(int i) {
		try {
			...
			if (null != aClass503_10190.anIntArray6188) {
				Class503 class503 = aClass503_10190.method6240(
						Class128.aClass148_6331, 1794284929);
	...
	public int method4427(byte i) {
		try {
			if (null != aClass503_10190.anIntArray6188) {
				Class503 class503 = aClass503_10190.method6240(
						Class128.aClass148_6331, 1605369279);
	...
	boolean method4350(GraphicsToolkit class_ra, int i, int i_28_, byte i_29_) {
		try {
			if (aClass503_10190 == null
					|| !method4454(class_ra, 131072, -1046532898))
				return false;
			Class222 class222 = method4347();
			boolean bool = false;
	...
	public Class62 method4437(int i) {
		try {
			if (((NPC) this).aClass62_10118 != null
					&& ((Class62) (((NPC) this).aClass62_10118)).aString608 == null)
				return null;
			return ((NPC) this).aClass62_10118;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ake.bl(").append(')').toString());
		}
	}
	...
	public int method4435() {
		if (aClass503_10190.anIntArray6188 != null) {
			Class503 class503 = aClass503_10190.method6240(
					Class128.aClass148_6331, 1815832117);
			if (null != class503 && class503.anInt6143 * -1575020259 != -1)
				return class503.anInt6143 * -1575020259;
		}
		return (-1575020259 * aClass503_10190.anInt6143 != -1 ? -1575020259
				* aClass503_10190.anInt6143 : super.method4363((byte) -104));
	}

	public int method4436() {
		if (aClass503_10190.anIntArray6188 != null) {
			Class503 class503 = aClass503_10190.method6240(
					Class128.aClass148_6331, 1928445532);
			if (null != class503 && class503.anInt6143 * -1575020259 != -1)
				return class503.anInt6143 * -1575020259;
		}
		return (-1575020259 * aClass503_10190.anInt6143 != -1 ? -1575020259
				* aClass503_10190.anInt6143 : super.method4363((byte) -11));
	}

	Class335 method4370(GraphicsToolkit class_ra) {
		if (aClass503_10190 == null
				|| !method4454(class_ra, 526336, -1153791486))
			return null;
		Class222 class222 = method4347();
		Class235 class235 = method4337();
		Class222 class222_41_ = class_ra.method5178();
		...
		class222_41_.method2064(0.0F,
				(float) (-20 - ((NPC) this).anInt10122
						* -661498661), 0.0F);
		Class350 class350 = method4426(1676580874);
		Class503 class503 = (aClass503_10190.anIntArray6188 != null ? aClass503_10190
				.method6240(Class128.aClass148_6331, 1779938932)
				: aClass503_10190);
		((NPC) this).aBoolean10129 = false;
		Class335 class335 = null;
		if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub18_7561
				.method5693(-1718454976) == 1
				&& class503.aBoolean6165 && class350.aBoolean3756) {
			Class438 class438 = ((aClass438_10078.method5819((byte) -38) && aClass438_10078
					.method5826(-65534)) ? aClass438_10078 : null);
	...
	boolean method4372(GraphicsToolkit class_ra, int i, int i_46_) {
		if (aClass503_10190 == null
				|| !method4454(class_ra, 131072, 1720809223))
			return false;
		Class222 class222 = method4347();
		boolean bool = false;
			...
			if (null != aDrawableModelArray10082[i_47_]) {
				...
				while_56_: do {
					do {
						if (-226722581 * aClass503_10190.anInt6192 <= 0) {
							if (286060383 * aClass503_10190.anInt6189 == -1) {
								if (1 != aClass503_10190.anInt6187
										* -2095128707)
									break;
							} else if (1 != (aClass503_10190.anInt6189 * 286060383))
								break;
	...
	boolean method4385(GraphicsToolkit class_ra, int i, int i_52_) {
		if (aClass503_10190 == null
				|| !method4454(class_ra, 131072, -1030471484))
			return false;
		Class222 class222 = method4347();
		boolean bool = false;
	...
	int method4447() {
		...
		if (null != aClass503_10190.anIntArray6188) {
			Class503 class503 = aClass503_10190.method6240(
					Class128.aClass148_6331, 1618298715);
			if (class503 != null && 525312939 * class503.anInt6132 != -1)
				return 525312939 * class503.anInt6132;
		}
		return aClass503_10190.anInt6132 * 525312939;
	...
	int method4446() {
		...
		if (null != aClass503_10190.anIntArray6188) {
			Class503 class503 = aClass503_10190.method6240(
					Class128.aClass148_6331, 1807692721);
			if (class503 != null && 525312939 * class503.anInt6132 != -1)
				return 525312939 * class503.anInt6132;
		}
		return aClass503_10190.anInt6132 * 525312939;
	...
	int method4438() {
		...
		if (null != aClass503_10190.anIntArray6188) {
			Class503 class503 = aClass503_10190.method6240(
					Class128.aClass148_6331, 1685758496);
			if (class503 != null && 525312939 * class503.anInt6132 != -1)
				return 525312939 * class503.anInt6132;
		}
		return aClass503_10190.anInt6132 * 525312939;
	...
	int method4448() {
		...
		if (null != aClass503_10190.anIntArray6188) {
			Class503 class503 = aClass503_10190.method6240(
					Class128.aClass148_6331, 1859138308);
			if (class503 != null && 525312939 * class503.anInt6132 != -1)
				return 525312939 * class503.anInt6132;
		}
		return aClass503_10190.anInt6132 * 525312939;
	...
	public int method4449() {
		if (null != aClass503_10190.anIntArray6188) {
			Class503 class503 = aClass503_10190.method6240(
					Class128.aClass148_6331, 1923690826);
			if (class503 != null && -1 != 363729791 * class503.anInt6178)
				return 363729791 * class503.anInt6178;
		}
		return 363729791 * aClass503_10190.anInt6178;
	...
	public int method4363(byte i) {
		try {
			if (aClass503_10190.anIntArray6188 != null) {
				Class503 class503 = aClass503_10190.method6240(
						Class128.aClass148_6331, 1652651645);
				if (null != class503 && class503.anInt6143 * -1575020259 != -1)
					return class503.anInt6143 * -1575020259;
			}
			return (-1575020259 * aClass503_10190.anInt6143 != -1 ? -1575020259
					* aClass503_10190.anInt6143 : super.method4363((byte) 61));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ake.bx(").append(')').toString());
		}
	}
	...
	public void method4464(Class503 class503, int i) {
		try {
			if (class503 != aClass503_10190 && Class436.aBoolean5478
					&& Class518.method6313(anInt10064 * 1888274983, 351851633))
	...
	final void method4355(GraphicsToolkit class_ra, Class365_Sub1 class365_sub1,
			int i, int i_59_, int i_60_, boolean bool, int i_61_) {
		try {
			throw new IllegalStateException();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ake.bk(").append(')').toString());
		}
	}
	...
	final void method4375(GraphicsToolkit class_ra, Class365_Sub1 class365_sub1,
			int i, int i_62_, int i_63_, boolean bool) {
		throw new IllegalStateException();
	}
