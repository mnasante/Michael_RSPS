...
public class Class365_Sub1_Sub3_Sub2 extends Class365_Sub1_Sub3 implements
		Interface3 {
	Class334 aClass334_9922;
	Class433 aClass433_9923;
	Class_na aClass_na9924;
	DrawableModel aDrawableModel_9925;
	int anInt9926;
	byte aByte9927;
	byte aByte9928;
	...
	boolean method4365() {
		if (null != ((Class365_Sub1_Sub3_Sub2) this).aDrawableModel_9925)
			return !((Class365_Sub1_Sub3_Sub2) this).aDrawableModel_9925.u();
		return true;
	}
	...
	boolean method4376(short i) {
		try {
			if (null != ((Class365_Sub1_Sub3_Sub2) this).aDrawableModel_9925)
				return ((Class365_Sub1_Sub3_Sub2) this).aDrawableModel_9925.i();
			return false;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("wq.be(").append(')').toString());
		}
	}

	public int method4361(int i) {
		try {
			return (((Class365_Sub1_Sub3_Sub2) this).aDrawableModel_9925 != null ? ((Class365_Sub1_Sub3_Sub2) this).aDrawableModel_9925
					.YA()
					: 0);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("wq.bm(").append(')').toString());
		}
	}

	DrawableModel method4510(GraphicsToolkit class_ra, int i, int i_0_) {
		try {
			if (((Class365_Sub1_Sub3_Sub2) this).aDrawableModel_9925 != null
					&& class_ra
							.method5017(
									((Class365_Sub1_Sub3_Sub2) this).aDrawableModel_9925
											.m(), i) == 0)
				return ((Class365_Sub1_Sub3_Sub2) this).aDrawableModel_9925;
	...
	public void method37(GraphicsToolkit class_ra, int i) {
		try {
			Object object = null;
			Class_na class_na;
			if (((Class365_Sub1_Sub3_Sub2) this).aClass_na9924 == null
					&& ((Class365_Sub1_Sub3_Sub2) this).aBoolean9931) {
				Class454 class454 = method4511(class_ra, 262144, true,
						-1658395754);
	...
	Class335 method4394(GraphicsToolkit class_ra, int i) {
		try {
			...
			Class335 class335 = Class73
					.method818((((Class365_Sub1_Sub3_Sub2) this).aBoolean9930),
							1295089573);
			((Class365_Sub1_Sub3_Sub2) this).aDrawableModel_9925.method4739(
					class222, aClass302_Sub1Array7726[0], 0);
			return class335;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("wq.bo(").append(')').toString());
		}
	}
	...
	public int method30(short i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("wq.b(").append(')').toString());
		}
	}

	boolean method4350(GraphicsToolkit class_ra, int i, int i_1_, byte i_2_) {
		try {
			DrawableModel drawableModel = method4510(class_ra, 131072, 1991691041);
	...
	public Class334 method4367(GraphicsToolkit class_ra) {
		...
		if (((Class365_Sub1_Sub3_Sub2) this).aClass334_9922 == null)
			((Class365_Sub1_Sub3_Sub2) this).aClass334_9922 = Class472
					.method6063((int) class217.aFloat2451,
							(int) class217.aFloat2455,
							(int) class217.aFloat2454, method4510(class_ra, 0,
									2120690814), 2092013456);
	...
	public void method31(byte i) {
		try {
			if (null != ((Class365_Sub1_Sub3_Sub2) this).aDrawableModel_9925)
				((Class365_Sub1_Sub3_Sub2) this).aDrawableModel_9925.method4784();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("wq.p(").append(')').toString());
		}
	}
	...
	public void method33(GraphicsToolkit class_ra, int i) {
		try {
			Object object = null;
			Class_na class_na;
			if (null == ((Class365_Sub1_Sub3_Sub2) this).aClass_na9924
					&& ((Class365_Sub1_Sub3_Sub2) this).aBoolean9931) {
				Class454 class454 = method4511(class_ra, 262144, true,
						443427270);
	...
	public Class365_Sub1_Sub3_Sub2(Class331 class331, GraphicsToolkit class_ra,
			Class433 class433, ObjectDefinitions class432, int i, int i_3_, int i_4_,
			int i_5_, int i_6_, boolean bool, int i_7_, int i_8_, int i_9_,
			int i_10_) {
		...
		((Class365_Sub1_Sub3_Sub2) this).aBoolean9930 = 0 != class432.anInt5382 * 1532834983
				&& !bool;
		((Class365_Sub1_Sub3_Sub2) this).aBoolean9931 = (class_ra.method5082()
				&& class432.aBoolean5433
				&& !((Class365_Sub1_Sub3_Sub2) this).aBoolean9929 && Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub7_7581
				.method5650(-208809184) != 0);
		int i_11_ = 2048;
		if (class432.aBoolean5441)
			i_11_ |= 0x80000;
		Class454 class454 = method4511(class_ra, i_11_,
				((Class365_Sub1_Sub3_Sub2) this).aBoolean9931, -772904584);
		if (null != class454) {
			((Class365_Sub1_Sub3_Sub2) this).aDrawableModel_9925 = (DrawableModel) class454.anObject5645;
			((Class365_Sub1_Sub3_Sub2) this).aClass_na9924 = (Class_na) class454.anObject5646;
			if (class432.aBoolean5441) {
				((Class365_Sub1_Sub3_Sub2) this).aDrawableModel_9925 = ((Class365_Sub1_Sub3_Sub2) this).aDrawableModel_9925
						.method4755((byte) 0, i_11_, false);
				if (class432.aBoolean5441) {
					Class287 class287 = client.aClass283_8716
							.method2632(-2114342399);
					((Class365_Sub1_Sub3_Sub2) this).aDrawableModel_9925.PA(
		...
		try {
			...
			if (((Class365_Sub1_Sub3_Sub2) this).aClass334_9922 == null)
				((Class365_Sub1_Sub3_Sub2) this).aClass334_9922 = Class472
						.method6063((int) class217.aFloat2451,
								(int) class217.aFloat2455,
								(int) class217.aFloat2454, method4510(class_ra,
										0, 1964135899), 2090651504);
			return ((Class365_Sub1_Sub3_Sub2) this).aClass334_9922;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("wq.bc(").append(')').toString());
		}
	}
	...
	Class335 method4370(GraphicsToolkit class_ra) {
		...
		Class335 class335 = Class73.method818(
				((Class365_Sub1_Sub3_Sub2) this).aBoolean9930, 1438144079);
		((Class365_Sub1_Sub3_Sub2) this).aDrawableModel_9925.method4739(class222,
	...
	boolean method4372(GraphicsToolkit class_ra, int i, int i_12_) {
		DrawableModel drawableModel = method4510(class_ra, 131072, 1910114060);
		if (drawableModel != null) {
			Class222 class222 = method4347();
			return drawableModel.method4787(i, i_12_, class222, false, 0);
		}
		return false;
	}

	boolean method4385(GraphicsToolkit class_ra, int i, int i_13_) {
		DrawableModel drawableModel = method4510(class_ra, 131072, 2092256266);
		if (drawableModel != null) {
			Class222 class222 = method4347();
			return drawableModel.method4787(i, i_13_, class222, false, 0);
		}
		return false;
	}

	boolean method4352(GraphicsToolkit class_ra, int i, int i_14_) {
		DrawableModel drawableModel = method4510(class_ra, 131072, 2046392588);
		if (drawableModel != null) {
			Class222 class222 = method4347();
			return drawableModel.method4787(i, i_14_, class222, false, 0);
		}
		return false;
	}
	...
	Class454 method4511(GraphicsToolkit class_ra, int i, boolean bool, int i_15_) {
		try {
			ObjectDefinitions class432 = (((Class365_Sub1_Sub3_Sub2) this).aClass433_9923
					.getObjectDefinitions(
							2016845759 * ((Class365_Sub1_Sub3_Sub2) this).anInt9926));
			Class_xa class_xa;
			...
			return (class432.method5785(class_ra, i,
					((Class365_Sub1_Sub3_Sub2) this).aByte9927,
					((Class365_Sub1_Sub3_Sub2) this).aByte9928, class_xa,
					class_xa_16_, (int) class217.aFloat2451,
					(int) class217.aFloat2455, (int) class217.aFloat2454, bool,
					null, -911505460));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("wq.bl(").append(')').toString());
		}
	}
	...
	public static void method4512(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("wq.ak(").append(')').toString());
		}
	}

	public static int[] method4513(int i, int i_17_, int i_18_, int i_19_,
			int i_20_, float f, boolean bool, int i_21_) {
		try {
			int[] is = new int[i];
			Class298_Sub32_Sub34 class298_sub32_sub34 = new Class298_Sub32_Sub34();
			((Class298_Sub32_Sub34) class298_sub32_sub34).anInt9543 = -1333197873
					* i_17_;
			...
			((Class298_Sub32_Sub34) class298_sub32_sub34).anInt9547 = -1820512295
					* i_20_;
	...
	static void method4514(int i, int i_22_, int i_23_, int i_24_, int i_25_,
			int i_26_, int i_27_) {
		try {
			int i_28_ = i_26_ + i_23_;
			int i_29_ = i_24_ - i_26_;
			for (int i_30_ = i_23_; i_30_ < i_28_; i_30_++)
				Class82_Sub22.method940(
						(Class372_Sub3.anIntArrayArray4047[i_30_]), i, i_22_,
						i_25_, 1081395615);
			for (int i_31_ = i_24_; i_31_ > i_29_; i_31_--)
				Class82_Sub22.method940(
						(Class372_Sub3.anIntArrayArray4047[i_31_]), i, i_22_,
						i_25_, -1329971917);
			int i_32_ = i + i_26_;
