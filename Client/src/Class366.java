...
public class Class366 {
	...
	void method4542(int i) {
		try {
			...
			if (((Class366) this).aClass464Array3971 != null) {
				for (int i_8_ = 0; i_8_ < ((Class366) this).aClass464Array3971.length; i_8_++) {
					if (((Class366) this).aClass464Array3971[i_8_] != null) {
						...
						int[] is_9_;
						if (aBoolean3977) {
							is = (((Class366) this).aClass464Array3971[i_8_].anIntArray5695);
							is_9_ = (((Class366) this).aClass464Array3971[i_8_].anIntArray5697);
						} else {
							is = (((Class366) this).aClass464Array3971[i_8_].anIntArray5694);
							is_9_ = (((Class366) this).aClass464Array3971[i_8_].anIntArray5690);
						}
						if (null != is) {
						...
						if ((((Class366) this).aClass464Array3971[i_8_].aShortArray5698) != null) {
							for (int i_12_ = 0; i_12_ < (((Class366) this).aClass464Array3971[i_8_].aShortArray5698).length; i_12_++) {
								((Class366) this).aLong3975 = (1662367026201571203L * ((((Class366) this).aLong3975 * 5093099708756449067L) >>> 8 ^ (ls[(int) (((5093099708756449067L * (((Class366) this).aLong3975)) ^ (long) ((((Class366) this).aClass464Array3971[i_8_].aShortArray5698[i_12_]) >> 8)) & 0xffL)])));
								((Class366) this).aLong3975 = (1662367026201571203L * ((5093099708756449067L * ((Class366) this).aLong3975) >>> 8 ^ (ls[(int) (((5093099708756449067L * (((Class366) this).aLong3975)) ^ (long) (((Class366) this).aClass464Array3971[i_8_].aShortArray5698[i_12_])) & 0xffL)])));
							}
						}
						if (null != (((Class366) this).aClass464Array3971[i_8_].aShortArray5699)) {
							for (int i_13_ = 0; i_13_ < (((Class366) this).aClass464Array3971[i_8_].aShortArray5699).length; i_13_++) {
								((Class366) this).aLong3975 = (1662367026201571203L * ((5093099708756449067L * ((Class366) this).aLong3975) >>> 8 ^ (ls[(int) (((5093099708756449067L * (((Class366) this).aLong3975)) ^ (long) ((((Class366) this).aClass464Array3971[i_8_].aShortArray5699[i_13_]) >> 8)) & 0xffL)])));
								((Class366) this).aLong3975 = (1662367026201571203L * ((5093099708756449067L * ((Class366) this).aLong3975) >>> 8 ^ (ls[(int) (((5093099708756449067L * (((Class366) this).aLong3975)) ^ (long) (((Class366) this).aClass464Array3971[i_8_].aShortArray5699[i_13_])) & 0xffL)])));
							}
						}
					}
				}
			...
			((Class366) this).aLong3975 = (((Class366) this).aLong3975 * 5093099708756449067L >>> 8 ^ ls[(int) (((((Class366) this).aLong3975 * 5093099708756449067L) ^ (long) (aBoolean3977 ? 1
					: 0)) & 0xffL)]) * 1662367026201571203L;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pf.k(").append(')').toString());
		}
	}
		...
		try {
			if (-1 != anInt3974 * 164936249)
				return (class507.method6269(anInt3974 * 164936249, 491367243)
						.method6237(class_ra, i, interface23, class438, null,
								-218177955));
			...
			if (drawableModel == null
				...
				for (int i_18_ = 0; i_18_ < ((Class366) this).anIntArray3969.length; i_18_++) {
					...
					Class464 class464 = null;
					if ((i_19_ & 0x40000000) != 0) {
						if (null != ((Class366) this).aClass464Array3971
								&& (((Class366) this).aClass464Array3971[i_18_] != null))
							class464 = ((Class366) this).aClass464Array3971[i_18_];
						if (!class477
								.getItemDefinitions(i_19_ & 0x3fffffff)
								.method6035(aBoolean3977, class464, (byte) 0))
							bool = true;
					} else if ((i_19_ & ~0x7fffffff) != 0
							&& !class144.method1579(i_19_ & 0x3fffffff,
									-939984800).method1475(-783889357))
						bool = true;
				}
				if (bool)
					return null;
				Class64[] class64s = new Class64[((Class366) this).anIntArray3969.length];
				int i_20_ = 0;
				for (int i_21_ = 0; i_21_ < ((Class366) this).anIntArray3969.length; i_21_++) {
					...
					if (0 != (i_22_ & 0x40000000)) {
						if (((Class366) this).aClass464Array3971 != null
								&& (((Class366) this).aClass464Array3971[i_21_] != null))
							class464 = ((Class366) this).aClass464Array3971[i_21_];
						Class64 class64 = (class477.getItemDefinitions(
								i_22_ & 0x3fffffff).method6040(
								aBoolean3977, class464, 327827223));
						if (class64 != null)
							class64s[i_20_++] = class64;
					} else if ((i_22_ & ~0x7fffffff) != 0) {
						Class64 class64 = class144.method1579(
								i_22_ & 0x3fffffff, -276971058).method1476(
								1209505122);
						if (null != class64)
							class64s[i_20_++] = class64;
					}
		...
		try {
			...
			do {
				if (drawableModel == null
					...
					int i_32_ = 0;
					if (class144.method1579(i_26_, -1760783131).method1475(
							-783889357)
							&& class144.method1579(i_27_, -1162557302)
									.method1475(-783889357)
							&& class144.method1579(i_28_, -839635617)
									.method1475(-783889357)) {
						Class64 class64 = class144
								.method1579(i_26_, -156721354).method1476(
										1042420956);
						if (class64 != null)
							class64s[i_32_++] = class64;
						class64 = class144.method1579(i_27_, 773247218)
								.method1476(74933704);
						if (class64 != null)
							class64s[i_32_++] = class64;
						class64 = class144.method1579(i_28_, 744132841)
								.method1476(552695292);
						if (null != class64)
							class64s[i_32_++] = class64;
		...
		try {
			if (anInt3974 * 164936249 != -1)
				return (class507.method6269(anInt3974 * 164936249, 1899433887)
						.method6246(class_ra, i, class349, interface23,
								class438, class438_35_, class438s, is, i_36_,
								null, -884053309));
			int i_38_ = i;
			...
			if (null != class438) {
				...
				if (null != class391
						&& (609841829 * class391.anInt4179 >= 0 || 1548903495 * class391.anInt4180 >= 0)) {
					...
					if (class391.anInt4179 * 609841829 >= 0
							&& -1 != -817429509 * class405.anInt5266) {
						bool_40_ = true;
					...
					if (1548903495 * class391.anInt4180 >= 0
							&& -1 != class405.anInt5270 * -2126257265) {
						bool_41_ = true;
			...
			if (null == drawableModel
				...
				for (int i_54_ = 0; i_54_ < is_39_.length; i_54_++) {
					...
					if ((i_55_ & 0x40000000) != 0) {
						if (!bool_56_
								&& null != ((Class366) this).aClass464Array3971
								&& (((Class366) this).aClass464Array3971[i_54_] != null))
							class464 = ((Class366) this).aClass464Array3971[i_54_];
						if (!class477
								.getItemDefinitions(i_55_ & 0x3fffffff)
								.method6034(aBoolean3977, class464, (byte) -1))
							bool_53_ = true;
					} else if ((i_55_ & ~0x7fffffff) != 0
							&& !class144.method1579(i_55_ & 0x3fffffff,
									1033806901).method1477(169549971))
						bool_53_ = true;
				}
				if (bool_53_) {
					...
					for (int i_59_ = 0; i_59_ < is_39_.length; i_59_++) {
						...
						Class464 class464 = null;
						boolean bool_61_ = 5 == i_59_ && bool_40_ || i_59_ == 3
								&& bool_41_;
						if (0 != (i_60_ & 0x40000000)) {
							if (!bool_61_
									&& null != ((Class366) this).aClass464Array3971
									&& (((Class366) this).aClass464Array3971[i_59_] != null))
								class464 = (((Class366) this).aClass464Array3971[i_59_]);
							Class64 class64 = (class477.getItemDefinitions(
									i_60_ & 0x3fffffff).method6028(
									aBoolean3977, class464, -1675025463));
							if (null != class64)
								class64s[i_59_] = class64;
						} else if (0 != (i_60_ & ~0x7fffffff)) {
							Class64 class64 = class144.method1579(
									i_60_ & 0x3fffffff, -959041423).method1474(
									(byte) 93);
							if (null != class64)
								class64s[i_59_] = class64;
						}
						...
						for (int i_62_ = 0; i_62_ < class350.anIntArrayArray3710.length; i_62_++) {
							if (class64s[i_62_] == null) {
								...
								if (0 != i_66_ || i_67_ != 0 || i_68_ != 0)
									class64s[i_62_].method754(i_66_, i_67_,
											i_68_);
								if (0 != i_63_ || 0 != i_64_ || i_65_ != 0)
									class64s[i_62_].method753(i_63_, i_64_,
											i_65_);
							}
						}
					}
	...
	public void method4546(int i, int[] is, Class464[] class464s, int[] is_75_,
			boolean bool, int i_76_, int i_77_) {
		try {
