...
public class Class398 {
	...
	void method4916(RsByteBuffer class298_sub53, int i, int i_1_) {
		try {
			if (1 == i)
				((Class398) this).anInt5204 = class298_sub53
						.readBigSmart(1235052657) * 422607467;
			else if (i == 2)
				anInt5205 = class298_sub53.readBigSmart(1235052657) * 761293581;
			else if (4 == i)
				((Class398) this).anInt5217 = class298_sub53
						.readUnsignedShort()
						* -1420991257;
			else if (i == 5)
				((Class398) this).anInt5211 = class298_sub53
						.readUnsignedShort()
						* -586540739;
			else if (i == 6)
				((Class398) this).anInt5212 = class298_sub53
						.readUnsignedShort()
						* -79411937;
			else if (7 == i)
				((Class398) this).anInt5213 = class298_sub53
						.readUnsignedByte() * 1905965041;
			else if (8 == i)
				((Class398) this).anInt5214 = class298_sub53
						.readUnsignedByte()
						* -241990007;
			else if (9 == i) {
				aByte5216 = (byte) 3;
				...
				aByte5216 = (byte) 2;
				((Class398) this).anInt5203 = class298_sub53
						.readUnsignedByte()
						* -497453824;
			} else if (i == 15) {
				aByte5216 = (byte) 3;
				((Class398) this).anInt5203 = class298_sub53
						.readUnsignedShort() * 48388469;
			} else if (16 == i) {
				aByte5216 = (byte) 3;
				((Class398) this).anInt5203 = class298_sub53
						.readInt((byte) 52) * 48388469;
			} else if (40 == i) {
				...
				for (int i_3_ = 0; i_3_ < i_2_; i_3_++) {
					((Class398) this).aShortArray5206[i_3_] = (short) class298_sub53
							.readUnsignedShort();
					((Class398) this).aShortArray5207[i_3_] = (short) class298_sub53
							.readUnsignedShort();
				}
			} else if (41 == i) {
				...
				for (int i_5_ = 0; i_5_ < i_4_; i_5_++) {
					((Class398) this).aShortArray5208[i_5_] = (short) class298_sub53
							.readUnsignedShort();
					((Class398) this).aShortArray5209[i_5_] = (short) class298_sub53
							.readUnsignedShort();
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qm.f(").append(')').toString());
		}
	}
		...
		try {
			...
			if (drawableModel == null
				...
				Class64 class64 = Class64
						.method751(
								(((Class389) ((Class398) this).aClass389_5210).aClass243_4160),
								(((Class398) this).anInt5204 * -283549117), 0);
				if (class64 == null)
					return null;
				...
				drawableModel = (class_ra
						.method5037(
								...
								i_15_,
								-258957271
										* ((Class389) (((Class398) this).aClass389_5210)).anInt4163,
								64 + -2043193071 * ((Class398) this).anInt5213,
	...
	public final boolean method4919(byte i) {
		try {
			if (((Class398) this).anInt5204 * -283549117 == -1)
				return true;
			return (((Class389) ((Class398) this).aClass389_5210).aClass243_4160
					.method2290(-283549117 * ((Class398) this).anInt5204, 0,
							-676484272));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qm.i(").append(')').toString());
		}
	}

	static boolean method4920(int i, short i_19_) {
		try {
			if (i == 18 || 19 == i || 20 == i || i == 21 || 22 == i
					|| 1004 == i)
				return true;
			if (17 == i)
				return true;
		...
		try {
			if (Class82_Sub6.aClass7Array6846 != null) {
				...
				Class298_Sub36 class298_sub36 = Class18.method359(
						OutcommingPacket.KICK_FRIEND_CHAT_PACKET, class25.aClass449_330,
						(byte) 6);
				class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(Class58
						.method693(string, 1482909411));
				class298_sub36.aClass298_Sub53_Sub2_7396.writeString(string,
						2132300359);
				class25.method390(class298_sub36, (byte) -58);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qm.mr(").append(')').toString());
		}
	}

	static final void method4923(int i, int i_22_, int i_23_, int i_24_,
			int i_25_, int i_26_, int i_27_, int i_28_, int i_29_) {
		try {
			if (i_23_ >= 1
					&& i_24_ >= 1
					&& i_23_ <= client.aClass283_8716.method2629(-1936425983) - 2
					&& (i_24_ <= client.aClass283_8716.method2630(-1245034974) - 2)) {
				int i_30_ = i;
				if (i_30_ < 3
						&& client.aClass283_8716.method2654(511320643)
								.method2320(i_23_, i_24_, 549965572))
					i_30_++;
				if (client.aClass283_8716.method2675(-1611682495) != null) {
					client.aClass283_8716.method2644(-1368274969).method2234(
							Class373.aClass_ra4071, i, i_22_, i_23_, i_24_,
							client.aClass283_8716.getSceneClipDataPlane(i),
							366084983);
					if (i_25_ >= 0) {
						int i_31_ = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub2_7547
								.method5629(-810781268);
						Class422_Sub25.aClass298_Sub48_8425
								.method3540(
										(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub2_7547),
										1, 650835797);
						client.aClass283_8716.method2644(-630573167)
								.method2243(
										...
										i_26_,
										i_27_,
										client.aClass283_8716.getSceneClipDataPlane(i), i_28_, 2073430416);
						Class422_Sub25.aClass298_Sub48_8425
								.method3540(
										(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub2_7547),
										i_31_, 631929348);
	...
	static final void method4925(Class403 class403, int i) {
		try {
			Class422_Sub25.aClass298_Sub48_8425
					.method3540(
							Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub28_7573,
							(((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]) != 0 ? 1
									: 0, -856880407);
			Class3.method300(656179282);
			client.aClass283_8716.method2667(1778418334);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qm.aip(").append(')').toString());
		}
	}
}
