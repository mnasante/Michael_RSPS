...
public abstract class Entity extends Class365_Sub1_Sub1 {
	...
	public void method4413(int i, int i_0_, int i_1_, int i_2_, int i_3_,
			int i_4_, int i_5_, int i_6_, int i_7_) {
		try {
			if (method4439(-1427124632))
				client.method2800(aClass119_10131, aClass119_10131
						.method1295((byte) 20), -1, i, i_0_, i_1_, i_2_, i_3_,
						i_4_, i_5_, i_6_);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akn.cx(").append(')').toString());
		}
	}
	...
	public void method4415(int i, boolean bool, int i_10_) {
		try {
			...
			if (bool || -2079528661 * class350.anInt3744 != 0
					|| 907865649 * anInt10115 != 0) {
				anInt10068 = (i & 0x3fff) * 1874549911;
				aClass386_10084
						.method4718(2145248039 * anInt10068, -1986657311);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akn.f(").append(')').toString());
		}
	}
	...
	public boolean method4417(int i, int i_11_, byte i_12_) {
		try {
			...
			int i_14_ = 256;
			if (class350.anIntArray3742 != null
					&& class350.anIntArray3742[i] > 0)
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akn.i(").append(')').toString());
		}
	}

	public final void sendGraphics(int graphicId, int positioning, int rotation, int i_23_,
			boolean bool, int graphicIndex, int i_25_) {
		try {
			...
			graphics.aClass438_569.method5824((-1 != graphicId ? ((Class158_Sub1.aClass389_8568.method4857(graphicId, -2144045629).anInt5205) * 1505778629) : -1),
					positioning & 0xffff, i_30_, false, (byte) 0);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akn.d(").append(')').toString());
		}
	}
	...
	public final void method4419(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akn.u(").append(')').toString());
		}
	}

	public final void method4420(int i, int i_31_, int i_32_, int i_33_,
			int i_34_, int i_35_, int i_36_, byte i_37_) {
		try {
			boolean bool = true;
			...
			int i_42_ = 0;
			if (i >= 0) {
				Class358 class358 = Class500.aClass347_6117.method4176(i,
						-1682094753);
	...
	public int method4363(byte i) {
		try {
			...
			if (null != aClass331_7722
					&& i_48_ >= 1
					&& i_49_ >= 1
					&& i_48_ <= client.aClass283_8716.method2629(-2008930035) - 1
					&& i_49_ <= client.aClass283_8716.method2630(-33342416) - 1) {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akn.bx(").append(')').toString());
		}
	}

	public void method4421(int i, int i_50_) {
		try {
			((Entity) this).anInt10065 = -1934893373 * i;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akn.r(").append(')').toString());
		}
	}

	public int getSize() {
		try {
			return 1173963243 * ((Entity) this).anInt10065;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akn.q(").append(')').toString());
		}
	}
	...
	void method4423(DrawableModel drawableModel, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akn.n(").append(')').toString());
		}
	}

	void method4424(GraphicsToolkit class_ra, Class350 class350, int i, int i_55_,
		...
		try {
			for (int i_59_ = 0; i_59_ < currentGraphics.length; i_59_++) {
				...
				if (-1 != class56.id * -967533709
						&& !class56.aClass438_569.method5826(-65534)) {
					Class398 class398 = (Class158_Sub1.aClass389_8568
							.method4857(class56.id * -967533709,
									-2040253952));
					...
					if (null != drawableModel) {
						if (class56.anInt568 * -1418960779 >= 0
								...
								&& (class350.anIntArrayArray3710[-1418960779
										* class56.anInt568]) != null) {
							int i_62_ = 0;
							int i_63_ = 0;
							int i_64_ = 0;
							if (null != class350.anIntArrayArray3710
									&& (null != (class350.anIntArrayArray3710[class56.anInt568
											* -1418960779]))) {
								i_62_ += (class350.anIntArrayArray3710[-1418960779
										* class56.anInt568][0]);
								i_63_ += (class350.anIntArrayArray3710[-1418960779
										* class56.anInt568][1]);
								i_64_ += (class350.anIntArrayArray3710[class56.anInt568
										* -1418960779][2]);
							}
							if (class350.anIntArrayArray3753 != null
									&& (null != (class350.anIntArrayArray3753[class56.anInt568
											* -1418960779]))) {
								i_62_ += (class350.anIntArrayArray3753[-1418960779
										* class56.anInt568][0]);
								i_63_ += (class350.anIntArrayArray3753[class56.anInt568
										* -1418960779][1]);
								i_64_ += (class350.anIntArrayArray3753[class56.anInt568
										* -1418960779][2]);
							}
							if (0 != i_64_ || i_62_ != 0) {
								int i_65_ = i_57_;
								if (null != anIntArray10085
										&& anIntArray10085[(class56.anInt568 * -1418960779)] != -1)
									i_65_ = (anIntArray10085[-1418960779
											* class56.anInt568]);
	...
	void method4425(int i, int i_70_, int i_71_, int i_72_, int i_73_, int i_74_) {
		try {
			...
			int i_83_ = Class70.method807(i_81_ + (int) class217.aFloat2451,
					(int) class217.aFloat2454 + i_82_, i_75_, i_76_, plane,
					(byte) 13);
			int i_84_ = i_70_ / 2;
			int i_85_ = -i_71_ / 2;
			int i_86_ = i_84_ * i_78_ + i_77_ * i_85_ >> 14;
			int i_87_ = i_85_ * i_78_ - i_84_ * i_77_ >> 14;
			int i_88_ = Class70.method807(i_86_ + (int) class217.aFloat2451,
					(int) class217.aFloat2454 + i_87_, i_75_, i_76_, plane,
					(byte) -9);
			int i_89_ = -i_70_ / 2;
			int i_90_ = i_71_ / 2;
			int i_91_ = i_89_ * i_78_ + i_90_ * i_77_ >> 14;
			int i_92_ = i_78_ * i_90_ - i_77_ * i_89_ >> 14;
			int i_93_ = Class70.method807((int) class217.aFloat2451 + i_91_,
					i_92_ + (int) class217.aFloat2454, i_75_, i_76_, plane,
					(byte) 105);
			int i_94_ = i_70_ / 2;
			int i_95_ = i_71_ / 2;
			int i_96_ = i_78_ * i_94_ + i_77_ * i_95_ >> 14;
			int i_97_ = i_95_ * i_78_ - i_77_ * i_94_ >> 14;
			int i_98_ = Class70.method807(i_96_ + (int) class217.aFloat2451,
					i_97_ + (int) class217.aFloat2454, i_75_, i_76_, plane,
					(byte) 97);
			...
			((Entity) this).anInt10097 = ((int) (Math.atan2(
					(double) (i_99_ - i_100_), (double) i_71_) * 2607.5945876176133) & 0x3fff) * 1814320247;
			((Entity) this).anInt10073 = ((int) (Math.atan2(
					(double) (i_102_ - i_101_), (double) i_70_) * 2607.5945876176133) & 0x3fff)
					* -1037987721;
			if (0 != ((Entity) this).anInt10097 * -155466425
					&& i_72_ != 0) {
			...
			if (-197572281 * ((Entity) this).anInt10073 != 0
					&& i_73_ != 0) {
				int i_104_ = 16384 - i_73_;
				if (((Entity) this).anInt10073 * -197572281 > 8192) {
					if ((((Entity) this).anInt10073 * -197572281) < i_104_)
						((Entity) this).anInt10073 = i_104_
								* -1037987721;
				} else if ((-197572281 * ((Entity) this).anInt10073) > i_73_)
					((Entity) this).anInt10073 = i_73_
							* -1037987721;
			}
			((Entity) this).anInt10074 = (i_83_ + i_98_) * 1400968295;
			if (i_88_ + i_93_ < -104151209
					* ((Entity) this).anInt10074)
				((Entity) this).anInt10074 = 1400968295 * (i_88_ + i_93_);
			((Entity) this).anInt10074 = (1400968295 * ((((Entity) this).anInt10074
					* -104151209 >> 1) - (int) class217.aFloat2455));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akn.z(").append(')').toString());
		}
	}
	...
	public void method4428(int i) {
		try {
			if (((Entity) this).aClass62_10118 != null
					&& null != ((Class62) (((Entity) this).aClass62_10118)).aString608) {
				((Class62) ((Entity) this).aClass62_10118).anInt611 -= -1979671751;
				if (((Class62) (((Entity) this).aClass62_10118)).anInt611
						* -1542462711 == 0)
					((Class62) ((Entity) this).aClass62_10118).aString608 = null;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akn.v(").append(')').toString());
		}
	}

	public abstract boolean method4429(byte i);

	public void method4430(String string, int i, int i_106_, int i_107_,
			byte i_108_) {
		try {
			if (((Entity) this).aClass62_10118 == null)
				((Entity) this).aClass62_10118 = new Class62();
			((Class62) ((Entity) this).aClass62_10118).aString608 = string;
			((Class62) ((Entity) this).aClass62_10118).anInt607 = -883265885
					* i;
			((Class62) ((Entity) this).aClass62_10118).anInt609 = -998781563
					* i_106_;
			((Class62) ((Entity) this).aClass62_10118).anInt611 = (((Class62) ((Entity) this).aClass62_10118).anInt610 = i_107_
					* -1166793105) * 1683680471;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akn.br(").append(')').toString());
		}
	}
	...
	public int method4435() {
		...
		if (null != aClass331_7722 && i_111_ >= 1 && i_112_ >= 1
				&& i_111_ <= client.aClass283_8716.method2629(-2022187323) - 1
				&& i_112_ <= client.aClass283_8716.method2630(1908645218) - 1) {
	...
	public int method4436() {
		...
		if (null != aClass331_7722 && i_113_ >= 1 && i_114_ >= 1
				&& i_113_ <= client.aClass283_8716.method2629(-2141154955) - 1
				&& i_114_ <= client.aClass283_8716.method2630(145346949) - 1) {
	...
	boolean method4439(int i) {
		try {
			if (((Entity) this).anInt10107 * 1992528251 == -1)
				return false;
			return method4433(
					(1992528251 * ((Entity) this).anInt10107),
					-1999241902);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akn.cm(").append(')').toString());
		}
	}
	...
	public void method4441(int i, int i_115_, int i_116_, int i_117_,
			int i_118_, int i_119_, int i_120_, byte i_121_) {
		try {
			if (!method4439(-377564191)) {
				...
				Class422_Sub24.method5714(aClass119_10131
						.method1295((byte) -37), -1, i_115_, i_116_, i_117_,
						i_118_, i_119_, i_120_, i, false, (byte) 0);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akn.cp(").append(')').toString());
		}
	}
	...
	void method4445(GraphicsToolkit class_ra, DrawableModel[] drawableModels, Class222 class222,
		...
		try {
			if (!bool) {
				...
				if ((((Entity) this).aClass351_10067 == null || (((Entity) this).aClass351_10067.aBoolean3772))
						&& (i_127_ > 0 || i_129_ > 0))
					((Entity) this).aClass351_10067 = Class351
							.method4232(client.anInt8884 * 443738891, true);
						...
						for (int i_139_ = 0; i_139_ < drawableModels.length; i_139_++) {
							if (class68s[i_139_] != null) {
								System.arraycopy(class68s[i_139_], 0,
										...
										class68s[i_139_].length);
								i_138_ += class68s[i_139_].length;
							}
						}
					}
					((Entity) this).aClass351_10067
							.method4231(class_ra,
									(long) (443738891 * client.anInt8884),
									class85s_133_, class68s_137_, false);
					((Entity) this).aBoolean10128 = true;
				}
			} else if (((Entity) this).aClass351_10067 != null)
				((Entity) this).aClass351_10067
						.method4233((long) (client.anInt8884 * 443738891));
			if (null != ((Entity) this).aClass351_10067)
				((Entity) this).aClass351_10067.method4227(
						plane, aShort9798, aShort9796, aShort9795,
						aShort9797);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akn.k(").append(')').toString());
		}
	}
	...
	public int method4450(short i) {
		try {
			...
			boolean bool;
			if (class350.anInt3744 * -2079528661 != 0)
				bool = aClass386_10084.method4717(anInt10068 * 2145248039,
						(-2079528661 * class350.anInt3744),
						(class350.anInt3745 * -1460258951), (byte) -24);
			else
				bool = aClass386_10084.method4717(anInt10068 * 2145248039,
						907865649 * anInt10115, anInt10115 * 907865649,
						(byte) -44);
			...
			if (bool) {
				if (0 != class350.anInt3726 * 1496476593) {
					if (i_141_ > 0)
						aClass386_10113.method4717(
								class350.anInt3748 * 1185872679,
								class350.anInt3726 * 1496476593,
								827802659 * class350.anInt3747, (byte) -96);
					else
						aClass386_10113.method4717(
								-(class350.anInt3748 * 1185872679),
								1496476593 * class350.anInt3726,
								class350.anInt3747 * 827802659, (byte) -111);
				}
				if (class350.anInt3720 * 847512459 != 0)
					aClass386_10111.method4717(-330229359 * class350.anInt3751,
							847512459 * class350.anInt3720,
							class350.anInt3750 * 1308368525, (byte) -37);
			} else {
				if (0 != 1496476593 * class350.anInt3726)
					aClass386_10113.method4717(0,
							class350.anInt3726 * 1496476593,
							827802659 * class350.anInt3747, (byte) -2);
				else
					aClass386_10113.method4718(0, -1696263872);
				if (class350.anInt3720 * 847512459 != 0)
					aClass386_10111.method4717(0,
							847512459 * class350.anInt3720,
							class350.anInt3750 * 1308368525, (byte) -85);
				else
