...
public class Class503 {
	...
	void method6235(RsByteBuffer class298_sub53, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uu.a(").append(')').toString());
		}
	}

	public final DrawableModel method6236(GraphicsToolkit class_ra, int i,
                                          Class349 class349, Interface23 interface23, Class438 class438,
                                          Class438 class438_1_, Class438[] class438s, int[] is, int i_2_,
                                          Class498 class498, int i_3_, boolean bool, int i_4_) {
		try {
			if (null != anIntArray6188) {
				Class503 class503_5_ = method6240(interface23, 1886245346);
				if (null == class503_5_)
					return null;
				return class503_5_.method6236(class_ra, i, class349,
						interface23, class438, class438_1_, class438s, is,
						i_2_, class498, i_3_, bool, -679459424);
			}
			int i_6_ = i;
			if (-1282053981 * ((Class503) this).anInt6160 != 128)
				i_6_ |= 0x2;
			if (128 != -2086573057 * ((Class503) this).anInt6150)
				i_6_ |= 0x5;
			...
			synchronized (((Class507) ((Class503) this).aClass507_6125).aClass348_6204) {
				drawableModel = (DrawableModel) ((Class507) ((Class503) this).aClass507_6125).aClass348_6204
						.method4184(l);
			}
			...
			if (!bool && i_3_ != -1)
				...
				class350 = class349
						.method4202(anInt6132 * 525312939, (byte) 89);
			if (drawableModel == null || (drawableModel.m() & i_6_) != i_6_) {
				if (null != drawableModel)
					i_6_ |= drawableModel.m();
				int i_10_ = i_6_;
				if (((Class503) this).aShortArray6133 != null)
					i_10_ |= 0x4000;
				if (((Class503) this).aShortArray6136 != null)
					i_10_ |= 0x8000;
				if (((Class503) this).aByte6141 != 0)
					i_10_ |= 0x80000;
				int[] is_11_ = (null != class498
						&& class498.anIntArray6108 != null ? class498.anIntArray6108
						: anIntArray6129);
				boolean bool_12_ = false;
				synchronized (((Class507) ((Class503) this).aClass507_6125).aClass243_6208) {
					for (int i_13_ = 0; i_13_ < is_11_.length; i_13_++) {
						if (is_11_[i_13_] == -1) {
							if (i_4_ != -679459424)
								throw new IllegalStateException();
						} else if (!((Class507) ((Class503) this).aClass507_6125).aClass243_6208
								.method2290(is_11_[i_13_], 0, -1819291215))
							bool_12_ = true;
					}
				}
				if (bool_12_)
					return null;
				Class64[] class64s = new Class64[is_11_.length];
				for (int i_14_ = 0; i_14_ < is_11_.length; i_14_++) {
					if (is_11_[i_14_] == -1) {
						...
						synchronized (((Class507) ((Class503) this).aClass507_6125).aClass243_6208) {
							class64s[i_14_] = Class64
									.method751(
											(((Class507) (((Class503) this).aClass507_6125)).aClass243_6208),
											is_11_[i_14_], 0);
						}
						if (class64s[i_14_] != null) {
							if (class64s[i_14_].anInt630 < 13)
								class64s[i_14_].method755(2);
							if (((Class503) this).anIntArrayArray6166 != null
									&& (((Class503) this).anIntArrayArray6166[i_14_]) != null)
								class64s[i_14_]
										.method753(
												(((Class503) this).anIntArrayArray6166[i_14_][0]),
												(((Class503) this).anIntArrayArray6166[i_14_][1]),
												(((Class503) this).anIntArrayArray6166[i_14_][2]));
						}
					}
				}
						...
						if (i_15_ < class64s.length) {
							if (null == class64s[i_15_]) {
								...
								if (0 != i_19_ || 0 != i_20_ || 0 != i_21_)
									class64s[i_15_].method754(i_19_, i_20_,
											i_21_);
								if (0 != i_16_ || i_17_ != 0 || i_18_ != 0)
									class64s[i_15_].method753(i_16_, i_17_,
											i_18_);
							}
						}
					}
				...
				if (1 == class64s.length)
					...
					class64 = new Class64(class64s, class64s.length);
				drawableModel = (class_ra
						.method5037(
								class64,
								i_10_,
								299909243 * ((Class507) (((Class503) this).aClass507_6125)).anInt6210,
								-335572127 * ((Class503) this).anInt6137 + 64,
								850 + -1208973327 * ((Class503) this).anInt6156));
				if (null != ((Class503) this).aShortArray6133) {
					short[] is_22_;
					if (class498 != null && null != class498.aShortArray6109)
						is_22_ = class498.aShortArray6109;
					else
						is_22_ = aShortArray6134;
					for (int i_23_ = 0; i_23_ < ((Class503) this).aShortArray6133.length; i_23_++) {
						if (null != ((Class503) this).aByteArray6135
								&& i_23_ < ((Class503) this).aByteArray6135.length)
							drawableModel
									.X(
											(((Class503) this).aShortArray6133[i_23_]),
											aShortArray6182[(((Class503) this).aByteArray6135[i_23_]) & 0xff]);
						else
							drawableModel.X(
									(((Class503) this).aShortArray6133[i_23_]),
									is_22_[i_23_]);
				...
				if (null != ((Class503) this).aShortArray6136) {
					short[] is_24_;
					if (class498 != null && null != class498.aShortArray6107)
						is_24_ = class498.aShortArray6107;
					else
						is_24_ = aShortArray6154;
					for (int i_25_ = 0; i_25_ < ((Class503) this).aShortArray6136.length; i_25_++)
						drawableModel.W(((Class503) this).aShortArray6136[i_25_],
								is_24_[i_25_]);
				}
				if (0 != ((Class503) this).aByte6141)
					drawableModel.PA(((Class503) this).aByte6138,
							((Class503) this).aByte6139,
							((Class503) this).aByte6157,
							((Class503) this).aByte6141 & 0xff);
				drawableModel.KA(i_6_);
				synchronized (((Class507) ((Class503) this).aClass507_6125).aClass348_6204) {
					((Class507) ((Class503) this).aClass507_6125).aClass348_6204
							.method4194(drawableModel, l);
				}
			}
			DrawableModel drawableModel_26_ = drawableModel.method4755((byte) 4, i_6_, true);
			...
			if (bool_27_ && null != class222s) {
				for (int i_29_ = 0; i_29_ < 12; i_29_++) {
					if (class222s[i_29_] != null)
						drawableModel_26_.method4741(class222s[i_29_], 1 << i_29_,
								true);
				}
			}
			int i_30_ = 0;
			...
			while (i_30_ < i_8_) {
				if (class438s[i_30_] == null) {
					...
					class438s[i_30_].method5830(drawableModel_26_, 0, i_31_,
							(byte) 125);
				i_30_++;
				i_31_ <<= 1;
			}
				...
				for (i_30_ = 0; i_30_ < 12; i_30_++) {
					if (-1 == is[i_30_]) {
						...
						class222.method2059(0.0F, 1.0F, 0.0F, Class220
								.method2049(i_31_));
						drawableModel_26_.method4741(class222, 1 << i_30_, false);
					}
				}
			}
			if (bool_27_ && class222s != null) {
				for (i_30_ = 0; i_30_ < 12; i_30_++) {
					if (class222s[i_30_] != null)
						drawableModel_26_.method4741(class222s[i_30_], 1 << i_30_,
								false);
				}
			}
			if (null != class438 && class438_1_ != null)
				Class400.method4929(drawableModel_26_, class438, class438_1_,
						-1827693647);
			else if (class438 != null)
				class438.method5839(drawableModel_26_, 0, 339112441);
			else if (null != class438_1_)
				class438_1_.method5839(drawableModel_26_, 0, -1538889562);
			if (-2086573057 * ((Class503) this).anInt6150 != 128
					|| 128 != -1282053981 * ((Class503) this).anInt6160)
				drawableModel_26_.oa(((Class503) this).anInt6150 * -2086573057,
						((Class503) this).anInt6160 * -1282053981,
						((Class503) this).anInt6150 * -2086573057);
			drawableModel_26_.KA(i);
			return drawableModel_26_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uu.i(").append(')').toString());
		}
	}

	public final DrawableModel method6237(GraphicsToolkit class_ra, int i,
                                          Interface23 interface23, Class438 class438, Class498 class498,
                                          int i_32_) {
		try {
			if (anIntArray6188 != null) {
				Class503 class503_33_ = method6240(interface23, 1912809157);
				if (null == class503_33_)
					return null;
				return class503_33_.method6237(class_ra, i, interface23,
						class438, class498, -1500196036);
			}
			if (anIntArray6130 == null
					&& (null == class498 || null == class498.anIntArray6108))
				return null;
			int i_34_ = i;
			if (class438 != null)
			...
			DrawableModel drawableModel;
			synchronized (((Class507) ((Class503) this).aClass507_6125).aClass348_6211) {
				drawableModel = (DrawableModel) ((Class507) ((Class503) this).aClass507_6125).aClass348_6211
						.method4184(l);
			}
			if (null == drawableModel || (drawableModel.m() & i_34_) != i_34_) {
				if (null != drawableModel)
					i_34_ |= drawableModel.m();
				int i_35_ = i_34_;
				if (null != ((Class503) this).aShortArray6133)
					i_35_ |= 0x4000;
				if (null != ((Class503) this).aShortArray6136)
				...
				if (((Class503) this).aByte6141 != 0)
					i_35_ |= 0x80000;
				int[] is = (class498 != null && null != class498.anIntArray6108 ? class498.anIntArray6108
						: anIntArray6130);
				boolean bool = false;
				synchronized (((Class507) ((Class503) this).aClass507_6125).aClass243_6208) {
					for (int i_36_ = 0; i_36_ < is.length; i_36_++) {
						if (!((Class507) ((Class503) this).aClass507_6125).aClass243_6208
								.method2290(is[i_36_], 0, -602703169))
							bool = true;
					}
				}
				if (bool)
					return null;
				Class64[] class64s = new Class64[is.length];
				synchronized (((Class507) ((Class503) this).aClass507_6125).aClass243_6208) {
					for (int i_37_ = 0; i_37_ < is.length; i_37_++)
						class64s[i_37_] = Class64
								.method751(
										(((Class507) (((Class503) this).aClass507_6125)).aClass243_6208),
										is[i_37_], 0);
				}
				for (int i_38_ = 0; i_38_ < is.length; i_38_++) {
					if (null != class64s[i_38_]
							&& class64s[i_38_].anInt630 < 13)
				...
				drawableModel = class_ra
						.method5037(
								class64,
								i_35_,
								(((Class507) (((Class503) this).aClass507_6125)).anInt6210) * 299909243,
								64, 768);
				if (((Class503) this).aShortArray6133 != null) {
					short[] is_39_;
					...
					for (int i_40_ = 0; i_40_ < ((Class503) this).aShortArray6133.length; i_40_++) {
						if (null != ((Class503) this).aByteArray6135
								&& i_40_ < ((Class503) this).aByteArray6135.length)
							drawableModel
									.X(
											(((Class503) this).aShortArray6133[i_40_]),
											aShortArray6182[(((Class503) this).aByteArray6135[i_40_]) & 0xff]);
						else
							drawableModel.X(
									(((Class503) this).aShortArray6133[i_40_]),
									is_39_[i_40_]);
				...
				if (((Class503) this).aShortArray6136 != null) {
					...
					for (int i_42_ = 0; i_42_ < ((Class503) this).aShortArray6136.length; i_42_++)
						drawableModel.W(((Class503) this).aShortArray6136[i_42_],
								is_41_[i_42_]);
				}
				if (((Class503) this).aByte6141 != 0)
					drawableModel.PA(((Class503) this).aByte6138,
							...
							((Class503) this).aByte6157,
							((Class503) this).aByte6141 & 0xff);
				drawableModel.KA(i_34_);
				synchronized (((Class507) ((Class503) this).aClass507_6125).aClass348_6211) {
					((Class507) ((Class503) this).aClass507_6125).aClass348_6211
							.method4194(drawableModel, l);
				}
			}
			if (class438 != null) {
				drawableModel = drawableModel.method4755((byte) 1, i_34_, true);
				class438.method5839(drawableModel, 0, -731129719);
			}
			drawableModel.KA(i);
			return drawableModel;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uu.k(").append(')').toString());
		}
	}
	...
	public final boolean method6238(int i) {
		try {
			...
			for (int i_43_ = 0; i_43_ < is.length; i_43_++) {
				int i_44_ = is[i_43_];
				if (!((Class507) ((Class503) this).aClass507_6125).aClass243_6208
						.method2290(i_44_, 0, -463050298))
					bool = false;
			}
			return bool;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uu.d(").append(')').toString());
		}
	}
	...
	public int method6239(int i, int i_45_, byte i_46_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uu.u(").append(')').toString());
		}
	}

	public final Class503 method6240(Interface23 interface23, int i) {
		try {
			int i_47_ = -1;
			if (((Class503) this).anInt6171 * 677538211 != -1)
				i_47_ = interface23.method250(
						(677538211 * ((Class503) this).anInt6171), (byte) 122);
			else if (((Class503) this).anInt6162 * -1248679093 != -1)
				i_47_ = interface23.method252(
						(((Class503) this).anInt6162 * -1248679093), (byte) 49);
			if (i_47_ < 0 || i_47_ >= anIntArray6188.length - 1
					|| -1 == anIntArray6188[i_47_]) {
				int i_48_ = anIntArray6188[anIntArray6188.length - 1];
				if (i_48_ != -1)
					return ((Class503) this).aClass507_6125.method6269(i_48_,
							749174826);
				return null;
			}
			return ((Class503) this).aClass507_6125.method6269(
					anIntArray6188[i_47_], 541835254);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uu.r(").append(')').toString());
		}
	}

	Class503() {
		anInt6132 = 799129853;
		((Class503) this).aByte6141 = (byte) 0;
		...
		aBoolean6148 = true;
		anInt6149 = -954057527;
		((Class503) this).anInt6150 = 1732902784;
		((Class503) this).anInt6160 = 910525824;
		aBoolean6124 = false;
		aBoolean6155 = false;
		aBoolean6173 = false;
		((Class503) this).anInt6137 = 0;
		((Class503) this).anInt6156 = 0;
		anInt6185 = -945207309;
		anInt6178 = 537547649;
		anInt6181 = -68186784;
		((Class503) this).anInt6171 = 70774261;
		((Class503) this).anInt6162 = 1169422749;
		aBoolean6163 = true;
		aBoolean6164 = true;
		aBoolean6165 = true;
		aShort6191 = (short) 0;
	...
	public boolean method6241(Interface23 interface23, int i) {
		try {
			if (null == anIntArray6188)
				return true;
			int i_49_ = -1;
			if (-1 != ((Class503) this).anInt6171 * 677538211)
				i_49_ = interface23.method250(
						(677538211 * ((Class503) this).anInt6171), (byte) 4);
			else if (-1248679093 * ((Class503) this).anInt6162 != -1)
				i_49_ = interface23.method252(
						(-1248679093 * ((Class503) this).anInt6162), (byte) 94);
			if (i_49_ < 0 || i_49_ >= anIntArray6188.length - 1
					|| anIntArray6188[i_49_] == -1) {
	...
	public boolean method6242(byte i) {
		try {
			if (anIntArray6188 == null)
				return (-1 != anInt6151 * 1945943361
						|| -1 != 1105496999 * anInt6169 || -1390399277
						* anInt6176 != -1);
			for (int i_51_ = 0; i_51_ < anIntArray6188.length; i_51_++) {
				if (-1 != anIntArray6188[i_51_]) {
					Class503 class503_52_ = ((Class503) this).aClass507_6125
							.method6269(anIntArray6188[i_51_], -1960092896);
					if (1945943361 * class503_52_.anInt6151 != -1
							|| -1 != class503_52_.anInt6169 * 1105496999
	...
	void method6243(int i) {
		try {
			...
			if (aByte6158 == -1) {
				if ((((Class507) ((Class503) this).aClass507_6125).aClass411_6205) == Class411.aClass411_5320)
					aByte6158 = (byte) 1;
				else
					aByte6158 = (byte) 0;
			}
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uu.b(").append(')').toString());
		}
	}

	void method6244(RsByteBuffer class298_sub53, int i, int i_53_) {
		try {
			if (i == 1) {
				int i_54_ = class298_sub53.readUnsignedByte();
				anIntArray6129 = new int[i_54_];
				for (int i_55_ = 0; i_55_ < i_54_; i_55_++)
					anIntArray6129[i_55_] = class298_sub53
							.readBigSmart(1235052657);
			} else if (i == 2)
				aString6127 = class298_sub53.readString(-1611525197);
			else if (12 == i)
				anInt6187 = class298_sub53.readUnsignedByte()
						* -1690840619;
			else if (i >= 30 && i < 35)
				aStringArray6142[i - 30] = class298_sub53
						.readString(-329838492);
			else if (i == 40) {
				int i_56_ = class298_sub53.readUnsignedByte();
				((Class503) this).aShortArray6133 = new short[i_56_];
				aShortArray6134 = new short[i_56_];
				for (int i_57_ = 0; i_57_ < i_56_; i_57_++) {
					((Class503) this).aShortArray6133[i_57_] = (short) class298_sub53
							.readUnsignedShort();
					aShortArray6134[i_57_] = (short) class298_sub53
							.readUnsignedShort();
				}
			} else if (i == 41) {
				int i_58_ = class298_sub53.readUnsignedByte();
				((Class503) this).aShortArray6136 = new short[i_58_];
				aShortArray6154 = new short[i_58_];
				for (int i_59_ = 0; i_59_ < i_58_; i_59_++) {
					((Class503) this).aShortArray6136[i_59_] = (short) class298_sub53
							.readUnsignedShort();
					aShortArray6154[i_59_] = (short) class298_sub53
							.readUnsignedShort();
				}
			} else if (i == 42) {
				int i_60_ = class298_sub53.readUnsignedByte();
				((Class503) this).aByteArray6135 = new byte[i_60_];
				for (int i_61_ = 0; i_61_ < i_60_; i_61_++)
					((Class503) this).aByteArray6135[i_61_] = class298_sub53
							.readByte(-12558881);
			} else if (i == 60) {
				int i_62_ = class298_sub53.readUnsignedByte();
				anIntArray6130 = new int[i_62_];
				for (int i_63_ = 0; i_63_ < i_62_; i_63_++)
					anIntArray6130[i_63_] = class298_sub53
							.readBigSmart(1235052657);
			} else if (i == 93)
				aBoolean6148 = false;
			else if (i == 95)
				...
				((Class503) this).anInt6150 = class298_sub53
						.readUnsignedShort()
						* -1227975681;
			else if (98 == i)
				((Class503) this).anInt6160 = class298_sub53
						.readUnsignedShort() * 745310987;
			else if (i == 99)
				aBoolean6124 = true;
			else if (i == 100)
				((Class503) this).anInt6137 = class298_sub53
						.readByte(-12558881) * 2012631201;
			else if (101 == i)
				((Class503) this).anInt6156 = class298_sub53
						.readByte(-12558881) * 1653976405;
			else if (i == 102)
				anInt6185 = class298_sub53.readUnsignedShort() * 945207309;
			else if (103 == i)
				anInt6181 = class298_sub53.readUnsignedShort() * -1075872661;
			else if (i == 106 || 118 == i) {
				((Class503) this).anInt6171 = class298_sub53
						.readUnsignedShort()
						* -70774261;
				if (677538211 * ((Class503) this).anInt6171 == 65535)
					((Class503) this).anInt6171 = 70774261;
				((Class503) this).anInt6162 = class298_sub53
						.readUnsignedShort()
						* -1169422749;
				if (((Class503) this).anInt6162 * -1248679093 == 65535)
					((Class503) this).anInt6162 = 1169422749;
				int i_64_ = -1;
				if (i == 118) {
				...
				for (int i_66_ = 0; i_66_ <= i_65_; i_66_++) {
					anIntArray6188[i_66_] = class298_sub53
							.readUnsignedShort();
				...
				((Class503) this).anIntArrayArray6166 = new int[anIntArray6129.length][];
				int i_67_ = class298_sub53.readUnsignedByte();
				for (int i_68_ = 0; i_68_ < i_67_; i_68_++) {
					int i_69_ = class298_sub53.readUnsignedByte();
					int[] is = (((Class503) this).anIntArrayArray6166[i_69_] = new int[3]);
				...
				aClass274_6183 = ((Class274) Class422_Sub20.method5701(Class299
						.method3680(-1901608125), class298_sub53
						.readByte(-12558881), (byte) 2));
			else if (127 == i)
				anInt6132 = class298_sub53.readUnsignedShort() * -799129853;
			else if (128 == i)
				Class422_Sub20.method5701(Class522.method6325((byte) -83),
						class298_sub53.readUnsignedByte(), (byte) 2);
			else if (i == 134) {
				...
				aStringArray6142[i - 150] = class298_sub53
						.readString(1280562882);
				if (!((Class507) ((Class503) this).aClass507_6125).aBoolean6209)
					aStringArray6142[i - 150] = null;
			} else if (i == 155) {
				((Class503) this).aByte6138 = class298_sub53
						.readByte(-12558881);
				((Class503) this).aByte6139 = class298_sub53
						.readByte(-12558881);
				((Class503) this).aByte6157 = class298_sub53
						.readByte(-12558881);
				((Class503) this).aByte6141 = class298_sub53
						.readByte(-12558881);
			} else if (158 == i)
				aByte6158 = (byte) 1;
			else if (i == 159)
				...
				for (int i_71_ = 0; i_71_ < i_70_; i_71_++)
					anIntArray6131[i_71_] = class298_sub53
							.readUnsignedShort();
			} else if (i == 162)
				aBoolean6180 = true;
			else if (i == 163)
				...
				anInt6175 = class298_sub53.readUnsignedByte()
						* -2143657709;
			else if (i == 169)
				aBoolean6193 = false;
			else if (249 == i) {
				...
				for (int i_74_ = 0; i_74_ < i_72_; i_74_++) {
					...
					Class298 class298;
					if (bool)
						class298 = new Class298_Sub29(class298_sub53
								.readString(1107258472));
					else
	...
	public String method6245(int i, String string, int i_76_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uu.x(").append(')').toString());
		}
	}

	public final DrawableModel method6246(GraphicsToolkit class_ra, int i,
                                          Class349 class349, Interface23 interface23, Class438 class438,
                                          Class438 class438_77_, Class438[] class438s, int[] is, int i_78_,
                                          Class498 class498, int i_79_) {
		try {
			return method6236(class_ra, i, class349, interface23, class438,
					class438_77_, class438s, is, i_78_, class498,
					anInt6132 * 525312939, true, -679459424);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uu.p(").append(')').toString());
		}
	}
	...
	public static Class128 method6247(RsByteBuffer class298_sub53, int i) {
		try {
			...
			return new Class128_Sub2(class128.aClass139_6322,
					class128.aClass133_6323, class128.anInt6327 * -39975161,
					1886882435 * class128.anInt6325, class128.anInt6326
							* -944287579, -1387457793 * class128.anInt6330,
					-684094775 * class128.anInt6328,
					955568089 * class128.anInt6329,
					class128.anInt6324 * 782326281, i_80_, i_81_);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uu.i(").append(')').toString());
		}
