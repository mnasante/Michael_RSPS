...
public class Class365_Sub1_Sub1_Sub1 extends Class365_Sub1_Sub1 {
	...
	public final void method4405(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
		try {
			Class217 class217 = Class217
					.method2005(method4337().aClass217_2599);
			if (!((Class365_Sub1_Sub1_Sub1) this).aBoolean10052) {
				...
				if (0.0F != f_5_) {
					class217.aFloat2451 += (float) (732601943 * (((Class365_Sub1_Sub1_Sub1) this).anInt10054))
							* f / f_5_;
					class217.aFloat2454 += (float) (732601943 * (((Class365_Sub1_Sub1_Sub1) this).anInt10054))
							* f_4_ / f_5_;
				}
				if (((Class365_Sub1_Sub1_Sub1) this).aBoolean10051)
					class217.aFloat2455 = (float) (Class356
							.method4271((int) (class217.aFloat2451),
									(int) (class217.aFloat2454), plane,
									-1463922586) - (((Class365_Sub1_Sub1_Sub1) this).anInt10042) * 1403412253);
				method4340(class217);
			}
			double d = (double) (anInt10049 * -1349988959 + 1 - i_2_);
			((Class365_Sub1_Sub1_Sub1) this).aDouble10053 = (double) ((float) i - class217.aFloat2451)
					/ d;
			((Class365_Sub1_Sub1_Sub1) this).aDouble10050 = (double) ((float) i_0_ - class217.aFloat2454)
					/ d;
			((Class365_Sub1_Sub1_Sub1) this).aDouble10055 = Math
					.sqrt((((Class365_Sub1_Sub1_Sub1) this).aDouble10050 * ((Class365_Sub1_Sub1_Sub1) this).aDouble10050)
							+ (((Class365_Sub1_Sub1_Sub1) this).aDouble10053 * (((Class365_Sub1_Sub1_Sub1) this).aDouble10053)));
			if (-1 != ((Class365_Sub1_Sub1_Sub1) this).anInt10048 * 1575706083) {
				if (!((Class365_Sub1_Sub1_Sub1) this).aBoolean10052)
					((Class365_Sub1_Sub1_Sub1) this).aDouble10056 = (-((Class365_Sub1_Sub1_Sub1) this).aDouble10055 * Math
							.tan(0.02454369 * (double) (1575706083 * ((Class365_Sub1_Sub1_Sub1) this).anInt10048)));
				((Class365_Sub1_Sub1_Sub1) this).aDouble10057 = (2.0 * ((double) ((float) i_1_ - class217.aFloat2455) - d
						* ((Class365_Sub1_Sub1_Sub1) this).aDouble10056) / (d * d));
			} else
				((Class365_Sub1_Sub1_Sub1) this).aDouble10056 = (double) ((float) i_1_ - class217.aFloat2455)
						/ d;
			class217.method2006();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aka.a(").append(')').toString());
		}
	}
			...
			if (!((Class365_Sub1_Sub1_Sub1) this).aBoolean10052) {
				if (0 != (((Class365_Sub1_Sub1_Sub1) this).anInt10043 * 132125965)) {
					...
					if (client.anInt8724 * 1596783995 == 0)
						class365_sub1_sub1_sub2 = Class87.aClass94Array794[(((Class365_Sub1_Sub1_Sub1) this).anInt10043 * 132125965) - 1]
								.method1015(1781553547);
					...
					if (class365_sub1_sub1_sub2 != null) {
						Class217 class217 = (class365_sub1_sub1_sub2
								.method4337().aClass217_2599);
						method4341(
								class217.aFloat2451,
								(float) ((Class356.method4271(
										(int) class217.aFloat2451,
										(int) class217.aFloat2454, plane,
										-1098231500)) - (1403412253 * ((Class365_Sub1_Sub1_Sub1) this).anInt10042)),
								class217.aFloat2454);
						if ((((Class365_Sub1_Sub1_Sub1) this).anInt10041 * -1955698847) >= 0) {
							Class350 class350 = class365_sub1_sub1_sub2
									.method4426(399670605);
							int i_8_ = 0;
							int i_9_ = 0;
							if (null != class350.anIntArrayArray3710
									&& null != (class350.anIntArrayArray3710[(((Class365_Sub1_Sub1_Sub1) this).anInt10041)
											* -1955698847])) {
								i_8_ += (class350.anIntArrayArray3710[(-1955698847 * (((Class365_Sub1_Sub1_Sub1) this).anInt10041))][0]);
								i_9_ += (class350.anIntArrayArray3710[(((Class365_Sub1_Sub1_Sub1) this).anInt10041)
										* -1955698847][2]);
							}
							if (class350.anIntArrayArray3753 != null
									&& ((class350.anIntArrayArray3753[-1955698847
											* ((Class365_Sub1_Sub1_Sub1) this).anInt10041]) != null)) {
								i_8_ += (class350.anIntArrayArray3753[(-1955698847 * (((Class365_Sub1_Sub1_Sub1) this).anInt10041))][0]);
								i_9_ += (class350.anIntArrayArray3753[(((Class365_Sub1_Sub1_Sub1) this).anInt10041)
										* -1955698847][2]);
							}
							if (i_8_ != 0 || 0 != i_9_) {
								int i_10_ = class365_sub1_sub1_sub2.aClass386_10084
										.method4719((byte) 0);
								int i_11_ = i_10_;
								if ((class365_sub1_sub1_sub2.anIntArray10085 != null)
										&& (class365_sub1_sub1_sub2.anIntArray10085[(((Class365_Sub1_Sub1_Sub1) this).anInt10041)
												* -1955698847]) != -1)
								...
								i_8_ = i_15_;
								Class217 class217_16_ = Class217
										.method2005(method4337().aClass217_2599);
	...
	public final void method4407(int i, byte i_19_) {
		try {
			...
			class235.aClass217_2599.aFloat2451 += ((Class365_Sub1_Sub1_Sub1) this).aDouble10053
					* (double) i;
			class235.aClass217_2599.aFloat2454 += ((Class365_Sub1_Sub1_Sub1) this).aDouble10050
					* (double) i;
			if (((Class365_Sub1_Sub1_Sub1) this).aBoolean10051)
				class235.aClass217_2599.aFloat2455 = (float) (Class356
						.method4271((int) (class235.aClass217_2599.aFloat2451),
								(int) (class235.aClass217_2599.aFloat2454),
								plane, -1903626222) - 1403412253 * (((Class365_Sub1_Sub1_Sub1) this).anInt10042));
			else if (((Class365_Sub1_Sub1_Sub1) this).anInt10048 * 1575706083 != -1) {
				class235.aClass217_2599.aFloat2455 += ((double) i
						* ((double) i * (0.5 * (((Class365_Sub1_Sub1_Sub1) this).aDouble10057))) + ((double) i * ((Class365_Sub1_Sub1_Sub1) this).aDouble10056));
			...
			class235.aClass218_2600.method2023(1.0F, 0.0F, 0.0F, (float) Math
					.atan2((((Class365_Sub1_Sub1_Sub1) this).aDouble10056),
							(((Class365_Sub1_Sub1_Sub1) this).aDouble10055)));
			...
			class218
					.method2023(
							...
							((float) Math
									.atan2(
											((Class365_Sub1_Sub1_Sub1) this).aDouble10053,
											((Class365_Sub1_Sub1_Sub1) this).aDouble10050) - 3.1415927F));
			class235.aClass218_2600.method2026(class218);
			class218.method2029();
			method4339(class235);
			if (((Class365_Sub1_Sub1_Sub1) this).aClass438_10047.method5822(1,
					1832022530)
					&& ((Class365_Sub1_Sub1_Sub1) this).aClass438_10047
							.method5832(588331212))
				((Class365_Sub1_Sub1_Sub1) this).aClass438_10047
						.method5834(981301272);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aka.b(").append(')').toString());
		}
	}
	...
	final boolean method4366(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aka.bw(").append(')').toString());
		}
	}

	final void method4355(GraphicsToolkit class_ra, Class365_Sub1 class365_sub1,
			int i, int i_22_, int i_23_, boolean bool, int i_24_) {
		try {
			throw new IllegalStateException();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aka.bk(").append(')').toString());
		}
	}
	...
	final void method4398(byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aka.bq(").append(')').toString());
		}
	}

	Class335 method4394(GraphicsToolkit class_ra, int i) {
		try {
			DrawableModel drawableModel = method4410(class_ra, 2048, -1431142826);
			if (drawableModel == null)
				return null;
			Class222 class222 = method4347();
			method4408(class_ra, drawableModel, class222, 752544216);
			...
			if (null != ((Class365_Sub1_Sub1_Sub1) this).aClass351_10061) {
				Class69 class69 = ((Class365_Sub1_Sub1_Sub1) this).aClass351_10061
						.method4229();
				class_ra.method5042(class69);
			}
			((Class365_Sub1_Sub1_Sub1) this).aBoolean10060 = drawableModel.i();
			drawableModel.n();
			((Class365_Sub1_Sub1_Sub1) this).anInt10059 = drawableModel.YA()
					* -1389603713;
			return class335;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aka.bo(").append(')').toString());
		}
	}

	void method4408(GraphicsToolkit class_ra, DrawableModel drawableModel, Class222 class222,
                    int i) {
		try {
			drawableModel.method4786(class222);
			Class85[] class85s = drawableModel.method4781();
			Class68[] class68s = drawableModel.method4728();
			if ((null == ((Class365_Sub1_Sub1_Sub1) this).aClass351_10061 || (((Class365_Sub1_Sub1_Sub1) this).aClass351_10061.aBoolean3772))
					&& (null != class85s || class68s != null))
				((Class365_Sub1_Sub1_Sub1) this).aClass351_10061 = Class351
						.method4232(client.anInt8884 * 443738891, true);
			if (((Class365_Sub1_Sub1_Sub1) this).aClass351_10061 != null) {
				((Class365_Sub1_Sub1_Sub1) this).aClass351_10061.method4231(
						class_ra, (long) (443738891 * client.anInt8884),
						class85s, class68s, false);
				((Class365_Sub1_Sub1_Sub1) this).aClass351_10061.method4227(
						plane, aShort9798, aShort9796, aShort9795,
						aShort9797);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aka.i(").append(')').toString());
		}
	}
	...
	Class335 method4370(GraphicsToolkit class_ra) {
		...
		if (drawableModel == null)
			return null;
		Class222 class222 = method4347();
		method4408(class_ra, drawableModel, class222, 250084815);
	...
	void method4371(GraphicsToolkit class_ra) {
		DrawableModel drawableModel = method4410(class_ra, 0, -1431142826);
		if (null != drawableModel) {
			Class222 class222 = method4347();
			((Class365_Sub1_Sub1_Sub1) this).anInt10059 = drawableModel.YA()
					* -1389603713;
			drawableModel.n();
			method4408(class_ra, drawableModel, class222, 378749771);
		}
	}
	...
	final void method4388(GraphicsToolkit class_ra, Class365_Sub1 class365_sub1,
	...
	DrawableModel method4410(GraphicsToolkit class_ra, int i, int i_30_) {
		try {
			Class398 class398 = (Class158_Sub1.aClass389_8568.method4857(
					1528803725 * ((Class365_Sub1_Sub1_Sub1) this).anInt10046,
					-1880515681));
			return class398.method4917(class_ra, i,
					(((Class365_Sub1_Sub1_Sub1) this).aClass438_10047),
					(byte) 2, 2089191246);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aka.p(").append(')').toString());
		}
	}
		...
		try {
			...
			if (null != drawableModel) {
				...
				((Class365_Sub1_Sub1_Sub1) this).anInt10059 = drawableModel.YA()
						* -1389603713;
				drawableModel.n();
				method4408(class_ra, drawableModel, class222, 1295394803);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aka.bb(").append(')').toString());
		}
	}
	...
	public Class365_Sub1_Sub1_Sub1(Class331 class331, int i, int i_31_,
			int i_32_, int i_33_, int i_34_, int i_35_, int i_36_, int i_37_,
			int i_38_, int i_39_, int i_40_, int i_41_, int i_42_,
			boolean bool, int i_43_) {
		super(class331, i_31_, i_32_, i_33_, Class356.method4271(i_33_, i_34_,
				i_31_, -1556375135)
				- i_35_, i_34_, i_33_ >> 9, i_33_ >> 9, i_34_ >> 9, i_34_ >> 9,
				false, (byte) 0);
		...
		int i_44_ = (Class158_Sub1.aClass389_8568.method4857(
				((Class365_Sub1_Sub1_Sub1) this).anInt10046 * 1528803725,
	...
	void method4373(GraphicsToolkit class_ra) {
		...
		if (null != drawableModel) {
			...
			((Class365_Sub1_Sub1_Sub1) this).anInt10059 = drawableModel.YA()
					* -1389603713;
			drawableModel.n();
			method4408(class_ra, drawableModel, class222, 1024355071);
		}
	}
