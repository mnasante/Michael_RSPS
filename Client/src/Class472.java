...
public class Class472 {
	...
	public int hashCode() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tl.hashCode(").append(')').toString());
		}
	}
	...
	public static int method6064(int i, int i_7_, int i_8_, byte i_9_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tl.f(").append(')').toString());
		}
	}

	static final void method6065(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			class105.anObjectArray1164 = Class128_Sub2.method1441(string,
					class403, -2046058202);
			class105.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tl.nq(").append(')').toString());
		}
	}
}
