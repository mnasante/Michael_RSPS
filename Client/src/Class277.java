...
public class Class277 {
	...
	public void method2583(int i, int i_0_, int i_1_) {
		try {
			...
			((Class277) this).anInt2961 = -1739514523
					* (i * (i_0_ - -1519560585 * (((Class277) this).anInt2947))
							/ 255 + -1519560585 * ((Class277) this).anInt2947);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lm.b(").append(')').toString());
		}
	}
	...
	public void method2584(Class277 class277_2_, int i) {
		try {
			...
			else if (class277_2_ != null
					&& ((Class277) class277_2_).aBoolean2959)
		...
		try {
			if (-51566561 * ((Class277) this).anInt2963 != i) {
				...
				if (null != ((Class277) this).aClass276Array2949) {
					...
					for (int i_6_ = 0; i_6_ < ((Class277) this).aClass276Array2949.length; i_6_++) {
						...
						if (class276.method2579(
								((Class277) this).anInt2957 * 1173193129,
								796478559 * ((Class277) this).anInt2948,
								-226559159 * ((Class277) this).anInt2962,
								((Class277) this).anInt2963 * -51566561)) {
					...
					Class419.method5602(is,
							((Class277) this).aClass276Array2953, 0,
							(1858024591 * ((Class277) this).anInt2945) - 1,
							-641027314);
				}
			...
			if (((Class277) this).aBoolean2954) {
				...
				for (int i_7_ = ((Class277) this).anInt2945 * 1858024591 - 1; i_7_ >= 0; i_7_--) {
					boolean bool_8_ = (((Class277) this).aClass276Array2953[i_7_]
							.method2575(class_ra,
									((Class277) this).aClass276_2942));
					Class277 class277_9_ = this;
					((Class277) class277_9_).aBoolean2954 = ((Class277) class277_9_).aBoolean2954
							| !bool_8_;
					bool |= bool_8_;
				}
			}
			...
			if (((Class277) this).aClass277_2960 != null
					&& ((Class277) this).aClass277_2960 != this) {
				((Class277) this).aClass277_2960.method2585((byte) -39);
				bool |= ((Class277) this).aClass277_2960.method2588(class_ra,
						i, i_3_, -136782694);
			}
			return bool;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lm.u(").append(')').toString());
		}
	}
	...
	void method2589(GraphicsToolkit class_ra, int i) {
		try {
			try {
				boolean bool = Class465.aClass243_6520
						.method2291(
								(-680590445 * (((Class277) this).anInt2956)),
								581664063);
				if (bool) {
					...
					if (null == is)
						...
						System.arraycopy(is, 0,
								((Class277) this).aByteArray2958, 0, is.length);
					}
				}
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lm.x(").append(')').toString());
		}
	}

	public void method2590(GraphicsToolkit class_ra, int i, int i_10_, int i_11_,
			int i_12_, int i_13_, int i_14_, int i_15_, int i_16_, int i_17_,
			int i_18_) {
		try {
			method2591(class_ra, i, i_10_, i_11_, i_12_, i_13_, i_14_, i_15_,
					0, i_17_, true, false, (byte) -1);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lm.r(").append(')').toString());
		}
	}

	public void method2591(GraphicsToolkit class_ra, int i, int i_19_, int i_20_,
			int i_21_, int i_22_, int i_23_, int i_24_, int i_25_, int i_26_,
			boolean bool, boolean bool_27_, byte i_28_) {
		try {
			int i_29_ = 0;
			if (((Class277) this).aBoolean2959)
			...
			if (null != ((Class277) this).aClass277_2960) {
				...
				class277_30_.method2593(class_ra, i, i_19_, i_20_, i_21_,
						i_22_, i_23_, i_24_, i_25_, i_26_, bool, bool_27_,
						i_29_, 2089062848);
				class277_31_.method2593(class_ra, i, i_19_, i_20_, i_21_,
						i_22_, i_23_, i_24_, i_25_, i_26_, false, bool_27_,
						255 - i_29_, 357729081);
			} else
				method2593(class_ra, i, i_19_, i_20_, i_21_, i_22_, i_23_,
						i_24_, i_25_, i_26_, bool, bool_27_, i_29_, 1191709910);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lm.q(").append(')').toString());
		}
	}

	void method2592(GraphicsToolkit class_ra, int i, int i_32_, int i_33_, int i_34_,
			int i_35_) {
		try {
			Class222 class222 = class_ra.method5044();
			Class222 class222_36_ = new Class222();
			class222_36_.method2062(0.0F, 0.0F, 0.0F);
			class222_36_.method2071(0.0F, -1.0F, 0.0F, Class220
					.method2049(-i_32_ & 0x3fff));
			class222_36_.method2071(-1.0F, 0.0F, 0.0F, Class220
					.method2049(-i & 0x3fff));
			class222_36_.method2071(0.0F, 0.0F, -1.0F, Class220
					.method2049(-i_33_ & 0x3fff));
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lm.s(").append(')').toString());
		}
	}

	void method2593(GraphicsToolkit class_ra, int i, int i_38_, int i_39_, int i_40_,
		...
		try {
			...
			if (((Class277) this).aDrawableModel_2941 == null) {
				...
				if (((Class277) this).anInt2940 * 1461948177 != -1
						&& ((Class277) this).anInt2946 * -1994130525 != 0) {
					Class53 class53 = anInterface_ma2955.method174(
							((((Class277) this).anInt2940) * 1461948177),
							434799685);
					if (null == ((Class277) this).aClass57_2950
							&& anInterface_ma2955
									.method170(
											((((Class277) this).anInt2940) * 1461948177),
											(short) 28045)) {
						int[] is = (2 == -2138060883 * class53.anInt528 ? (anInterface_ma2955
								.method172(
										((Class277) this).anInt2940 * 1461948177,
										0.7F, -1994130525
												* ((Class277) this).anInt2946,
										((Class277) this).anInt2946
												* -1994130525, false, (byte) 2))
								: (anInterface_ma2955
										.method171(
												((Class277) this).anInt2940 * 1461948177,
												0.7F,
						...
						((Class277) this).aClass57_2950 = class_ra.method5031(
								is, 0,
								(((Class277) this).anInt2946 * -1994130525),
								(((Class277) this).anInt2946 * -1994130525),
								(((Class277) this).anInt2946 * -1994130525),
								2072553439);
					}
					int i_50_ = (i_49_ == 255 ? class53.anInt528 * -2138060883 == 2 ? 1
							: 0
							: 1);
					if (1 == i_50_ && bool)
					...
					if (((Class277) this).aClass57_2950 != null) {
						...
						if (((Class277) this).aClass320_2944 == Class320.aClass320_6547) {
							for (int i_53_ = i_52_ - i_41_; i_53_ < i_40_; i_53_ += i_41_)
								((Class277) this).aClass57_2950.method634(i_38_
										+ i_53_, i_51_ + i_39_, i_41_, i_41_,
										0, i_49_ << 24 | 0xffffff, i_50_);
							if ((150420823 * ((Class277) this).anInt2939 & ~0xffffff) != 0)
								class_ra
										.method5015(
												...
												i_40_,
												1 + (i_39_ + i_51_),
												(150420823 * (((Class277) this).anInt2939)),
												(byte) 7);
							if (0 != (((Class277) this).anInt2952 * 1184429967 & ~0xffffff))
								class_ra
										.method5015(
												...
												i_41_
														- (i_41_ + (i_51_ + i_39_)),
												((Class277) this).anInt2952 * 1184429967,
												(byte) 7);
						} else {
							...
							for (int i_54_ = i_52_ - i_41_; i_54_ < i_40_; i_54_ += i_41_) {
								for (int i_55_ = i_51_ - i_41_; i_55_ < i_41_; i_55_ += i_41_)
									((Class277) this).aClass57_2950.method634(
											i_38_ + i_54_, i_39_ + i_55_,
											i_41_, i_41_, 0,
					...
					class_ra.B(i_38_, i_39_, i_40_, i_41_, i_49_ << 24 | i_45_,
							1);
			} else if (bool_46_) {
			...
			for (int i_57_ = ((Class277) this).anInt2945 * 1858024591 - 1; i_57_ >= 0; i_57_--)
				((Class277) this).aClass276Array2953[i_57_].method2577(
						class_ra, i_38_, i_39_, i_40_, i_41_, i_42_, i_43_,
						1173193129 * ((Class277) this).anInt2957,
						((Class277) this).anInt2948 * 796478559,
						((Class277) this).anInt2962 * -226559159, i_49_);
			class_ra.ba(2, 0);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lm.n(").append(')').toString());
		}
	}

	public Class277(int i, Class276[] class276s, int i_58_, int i_59_,
			int i_60_, int i_61_, Class320 class320, int i_62_) {
		((Class277) this).aBoolean2954 = true;
		...
		if (class276s != null) {
			...
			((Class277) this).aClass276_2942 = i_58_ >= 0 ? class276s[i_58_]
					: null;
		} else {
	...
	static final void method2594(IComponentDefinition class105, Class119 class119,
			Class403 class403, int i) {
		try {
			class105.anInt1306 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919])
					* -216431639;
			Tradution.method6054(class105, 2056943984);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lm.dv(").append(')').toString());
		}
	}

	static final void method2595(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lm.jw(").append(')').toString());
		}
	}

	static final void method2596(Class403 class403, int i) {
		try {
			Class390 class390 = (((Class403) class403).aBoolean5261 ? ((Class403) class403).aClass390_5247
					: ((Class403) class403).aClass390_5246);
			IComponentDefinition class105 = ((Class390) class390).aClass105_4168;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lm.qk(").append(')').toString());
		}
	}

	static final void method2597(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (int) client.aFloat8949 >> 3;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lm.agv(").append(')').toString());
		}
	}
	...
	public static void sendWalkPacket(int type , Class336 class336) {
		  	int stepsCount = (Class298_Sub37
										.calculateRoute(
												...
												(Class287.myPlayer.scenePositionYQueue[0]),
												Class287.myPlayer.getSize(), class336,
												(client.aClass283_8716.getSceneClipDataPlane(
														(Class287.myPlayer.plane))), true,
														client.calculatedScenePositionXs,
														client.calculatedScenePositionYs));
		 
		Class298_Sub36 packet = null;
		if (0 == type)
			packet = Class18.method359(OutcommingPacket.WALKING_PACKET,
					client.aClass25_8711.aClass449_330, (byte) 51);
		if (type == 1)
			packet = Class18.method359(OutcommingPacket.MINI_WALKING_PACKET,
	...
	static Class298_Sub36 createWalkPacket(int localX, int localY, int type) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lm.bp(").append(')').toString());
		}
	}

	static final void method2600(Class403 class403, byte i) {
		try {
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = new StringBuilder()
					.append(
							Class465
									.method6017(
											(long) (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]) * 60000L,
											Class321.aClass429_3357
													.method242(694163818),
											true, -1759893587)).append(" UTC")
					.toString();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lm.aam(").append(')').toString());
		}
	}
}
