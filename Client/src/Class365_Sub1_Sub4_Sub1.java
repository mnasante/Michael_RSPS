...
public class Class365_Sub1_Sub4_Sub1 extends Class365_Sub1_Sub4 {
	...
	Class335 method4394(GraphicsToolkit class_ra, int i) {
		try {
			...
			Class322 class322 = aClass331_7722.method4036(plane,
					(int) class217.aFloat2451 >> 9,
					(int) class217.aFloat2454 >> 9, -583169676);
			Class365_Sub1_Sub2 class365_sub1_sub2 = aClass331_7722.method4058(
					plane, (int) class217.aFloat2451 >> 9,
					(int) class217.aFloat2454 >> 9, (byte) 55);
			int i_0_ = 0;
			if (null != class322
					&& class322.aClass365_Sub1_Sub1_3359.aBoolean9799)
				i_0_ = class322.aClass365_Sub1_Sub1_3359.method4361(1951240662);
			if (class365_sub1_sub2 != null
					&& class365_sub1_sub2.aShort9801 > -i_0_)
			...
			if (anInt10142 * -1184748693 == 0) {
				...
				int i_5_ = -i_3_ / 2;
				int i_6_ = -i_4_ / 2;
				int i_7_ = class_xa.method6340(
						i_5_ + (int) class217.aFloat2451,
						(int) class217.aFloat2454 + i_6_, -1982900642);
				int i_8_ = i_3_ / 2;
				int i_9_ = -i_4_ / 2;
				int i_10_ = class_xa.method6340((int) class217.aFloat2451
						+ i_8_, i_9_ + (int) class217.aFloat2454, -1725399320);
				int i_11_ = -i_3_ / 2;
				int i_12_ = i_4_ / 2;
				int i_13_ = class_xa
						.method6340((int) class217.aFloat2451 + i_11_,
								(int) class217.aFloat2454 + i_12_, -1471266970);
				int i_14_ = i_3_ / 2;
				int i_15_ = i_4_ / 2;
				int i_16_ = class_xa.method6340(i_14_
						+ (int) class217.aFloat2451, i_15_
						+ (int) class217.aFloat2454, -1424760570);
				...
				if (i_4_ != 0) {
					int i_21_ = ((int) (Math.atan2((double) (i_17_ - i_18_),
							(double) i_4_) * 2607.5945876176133) & 0x3fff);
					if (i_21_ != 0)
						class222.method2071(1.0F, 0.0F, 0.0F, Class220
								.method2049(i_21_));
				}
				if (i_3_ != 0) {
					int i_22_ = ((int) (Math.atan2((double) (i_20_ - i_19_),
							(double) i_3_) * 2607.5945876176133) & 0x3fff);
					if (i_22_ != 0)
						class222.method2071(0.0F, 0.0F, 1.0F, Class220
								.method2049(-i_22_));
				}
			...
			class222.method2064(class217_24_.aFloat2451,
					class217_24_.aFloat2455 - 10.0F, class217_24_.aFloat2454);
			...
			if (anInt10146 * -1651799761 != -1) {
				DrawableModel drawableModel = (Class298_Sub32_Sub14.aClass477_9400
						...
						.method6029(
								class_ra,
								526336,
								1271433065 * anInt10147,
								null,
								null,
								(1191848641 * ((Class365_Sub1_Sub4_Sub1) this).anInt10151),
								(((Class365_Sub1_Sub4_Sub1) this).anInt10148 * 943545391),
			...
			DrawableModel drawableModel = (Class298_Sub32_Sub14.aClass477_9400
					...
					.method6029(
							class_ra,
							526336,
							825822935 * anInt10143,
							null,
							null,
							((Class365_Sub1_Sub4_Sub1) this).anInt10151 * 1191848641,
							((Class365_Sub1_Sub4_Sub1) this).anInt10148 * 943545391,
							-1436336999
									* ((Class365_Sub1_Sub4_Sub1) this).anInt10153,
							-1595812509
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akc.bo(").append(')').toString());
		}
	}

	void method4516(int i) {
		try {
			((Class365_Sub1_Sub4_Sub1) this).anInt10151 = (32 + (int) (Math
					.random() * 4.0)) * 2009949505;
			((Class365_Sub1_Sub4_Sub1) this).anInt10148 = (3 + (int) (Math
					.random() * 2.0)) * 880372431;
			((Class365_Sub1_Sub4_Sub1) this).anInt10153 = (16 + (int) (Math
					.random() * 3.0))
					* -1003661399;
			if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub16_7557
					.method5687(1941334276) == 1)
				((Class365_Sub1_Sub4_Sub1) this).anInt10154 = (int) (Math
						.random() * 10.0) * 1183208523;
			else
				((Class365_Sub1_Sub4_Sub1) this).anInt10154 = (int) (Math
						.random() * 20.0) * 1183208523;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akc.a(").append(')').toString());
		}
	}
	...
	Class335 method4370(GraphicsToolkit class_ra) {
		...
		Class322 class322 = aClass331_7722.method4036(plane,
				(int) class217.aFloat2451 >> 9, (int) class217.aFloat2454 >> 9,
				1738520080);
		Class365_Sub1_Sub2 class365_sub1_sub2 = aClass331_7722.method4058(
				plane, (int) class217.aFloat2451 >> 9,
				(int) class217.aFloat2454 >> 9, (byte) 15);
		int i = 0;
		...
		if (anInt10142 * -1184748693 == 0) {
			...
			int i_29_ = -i_27_ / 2;
			int i_30_ = -i_28_ / 2;
			int i_31_ = class_xa.method6340(i_29_ + (int) class217.aFloat2451,
					(int) class217.aFloat2454 + i_30_, -1545427351);
			int i_32_ = i_27_ / 2;
			int i_33_ = -i_28_ / 2;
			int i_34_ = class_xa.method6340((int) class217.aFloat2451 + i_32_,
					i_33_ + (int) class217.aFloat2454, -1284070566);
			int i_35_ = -i_27_ / 2;
			int i_36_ = i_28_ / 2;
			int i_37_ = class_xa.method6340((int) class217.aFloat2451 + i_35_,
					(int) class217.aFloat2454 + i_36_, -1982262190);
			int i_38_ = i_27_ / 2;
			int i_39_ = i_28_ / 2;
			int i_40_ = class_xa.method6340(i_38_ + (int) class217.aFloat2451,
					i_39_ + (int) class217.aFloat2454, -1609235363);
			...
			if (i_28_ != 0) {
				int i_45_ = ((int) (Math.atan2((double) (i_41_ - i_42_),
						(double) i_28_) * 2607.5945876176133) & 0x3fff);
				if (i_45_ != 0)
					class222.method2071(1.0F, 0.0F, 0.0F, Class220
							.method2049(i_45_));
			}
			if (i_27_ != 0) {
				int i_46_ = ((int) (Math.atan2((double) (i_44_ - i_43_),
						(double) i_27_) * 2607.5945876176133) & 0x3fff);
				if (i_46_ != 0)
					class222.method2071(0.0F, 0.0F, 1.0F, Class220
							.method2049(-i_46_));
			}
		...
		class222.method2064(class217_48_.aFloat2451,
				class217_48_.aFloat2455 - 10.0F, class217_48_.aFloat2454);
	...
	int method4519() {
		ItemDefinitions class468 = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(
				-441234013 * anInt10152);
		int i = class468.anInt5768 * -427528997;
		if (anInt10150 * -909380271 != -1) {
			ItemDefinitions class468_53_ = Class298_Sub32_Sub14.aClass477_9400
					.getItemDefinitions(anInt10150 * -909380271);
			if (-427528997 * class468_53_.anInt5768 > i)
				i = -427528997 * class468_53_.anInt5768;
		}
		if (-1 != -1651799761 * anInt10146) {
			ItemDefinitions class468_54_ = Class298_Sub32_Sub14.aClass477_9400
					.getItemDefinitions(anInt10146 * -1651799761);
	...
	int method4356(byte i) {
		try {
			...
			if (anInt10150 * -909380271 != -1) {
				ItemDefinitions class468_56_ = Class298_Sub32_Sub14.aClass477_9400
						.getItemDefinitions(anInt10150 * -909380271);
				if (-427528997 * class468_56_.anInt5768 > i_55_)
					i_55_ = -427528997 * class468_56_.anInt5768;
			}
			if (-1 != -1651799761 * anInt10146) {
				ItemDefinitions class468_57_ = Class298_Sub32_Sub14.aClass477_9400
						.getItemDefinitions(anInt10146 * -1651799761);
	...
	public Class365_Sub1_Sub4_Sub1(Class331 class331, int i, int i_59_,
	...
	int method4520() {
		...
		int i = class468.anInt5768 * -427528997;
		if (anInt10150 * -909380271 != -1) {
			ItemDefinitions class468_63_ = Class298_Sub32_Sub14.aClass477_9400
					.getItemDefinitions(anInt10150 * -909380271);
			if (-427528997 * class468_63_.anInt5768 > i)
				i = -427528997 * class468_63_.anInt5768;
		}
		if (-1 != -1651799761 * anInt10146) {
			ItemDefinitions class468_64_ = Class298_Sub32_Sub14.aClass477_9400
					.getItemDefinitions(anInt10146 * -1651799761);
	...
	int method4521() {
		...
		int i = class468.anInt5768 * -427528997;
		if (anInt10150 * -909380271 != -1) {
			ItemDefinitions class468_65_ = Class298_Sub32_Sub14.aClass477_9400
					.getItemDefinitions(anInt10150 * -909380271);
			if (-427528997 * class468_65_.anInt5768 > i)
				i = -427528997 * class468_65_.anInt5768;
		}
		if (-1 != -1651799761 * anInt10146) {
			ItemDefinitions class468_66_ = Class298_Sub32_Sub14.aClass477_9400
					.getItemDefinitions(anInt10146 * -1651799761);
