...
public class Class365_Sub1_Sub5_Sub2 extends Class365_Sub1_Sub5 implements
		Interface3 {
	...
	Class335 method4370(GraphicsToolkit class_ra) {
		DrawableModel drawableModel = aClass60_9935.method700(class_ra, 2048, false,
				true, (byte) 90);
		...
		Class335 class335 = Class73.method818(
				((Class365_Sub1_Sub5_Sub2) this).aBoolean9936, 1239765065);
		int i = (int) class235.aClass217_2599.aFloat2451 >> 9;
		int i_0_ = (int) class235.aClass217_2599.aFloat2454 >> 9;
		aClass60_9935.method701(class_ra, drawableModel, class222, i, i, i_0_, i_0_,
				true, -1223011244);
		drawableModel.method4739(class222, aClass302_Sub1Array7726[0], 0);
		if (null != ((Class60) aClass60_9935).aClass351_602) {
			Class69 class69 = ((Class60) aClass60_9935).aClass351_602
					.method4229();
			class_ra.method5042(class69);
		}
		((Class365_Sub1_Sub5_Sub2) this).aBoolean9939 = drawableModel.i()
				|| null != ((Class60) aClass60_9935).aClass351_602;
		if (null == ((Class365_Sub1_Sub5_Sub2) this).aClass334_9934)
			((Class365_Sub1_Sub5_Sub2) this).aClass334_9934 = Class472
			...
			Class264_Sub2.method2507(
					(((Class365_Sub1_Sub5_Sub2) this).aClass334_9934),
	...
	Class335 method4394(GraphicsToolkit class_ra, int i) {
		try {
			...
			Class335 class335 = Class73
					.method818((((Class365_Sub1_Sub5_Sub2) this).aBoolean9936),
							1511204499);
			int i_1_ = (int) class235.aClass217_2599.aFloat2451 >> 9;
			int i_2_ = (int) class235.aClass217_2599.aFloat2454 >> 9;
			aClass60_9935.method701(class_ra, drawableModel, class222, i_1_, i_1_,
					i_2_, i_2_, true, 327958726);
			drawableModel.method4739(class222, aClass302_Sub1Array7726[0], 0);
			if (null != ((Class60) aClass60_9935).aClass351_602) {
				Class69 class69 = ((Class60) aClass60_9935).aClass351_602
						.method4229();
			...
			((Class365_Sub1_Sub5_Sub2) this).aBoolean9939 = (drawableModel.i() || null != ((Class60) aClass60_9935).aClass351_602);
			if (null == ((Class365_Sub1_Sub5_Sub2) this).aClass334_9934)
				((Class365_Sub1_Sub5_Sub2) this).aClass334_9934 = Class472
						.method6063((int) (class235.aClass217_2599.aFloat2451),
								(int) (class235.aClass217_2599.aFloat2455),
								(int) (class235.aClass217_2599.aFloat2454),
                                drawableModel, 1999876467);
			else
				Class264_Sub2.method2507(
						((Class365_Sub1_Sub5_Sub2) this).aClass334_9934,
						(int) class235.aClass217_2599.aFloat2451,
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("wr.bo(").append(')').toString());
		}
	}

	void method4357(GraphicsToolkit class_ra, int i) {
		try {
			DrawableModel drawableModel = aClass60_9935.method700(class_ra, 262144, true,
					true, (byte) -57);
			if (drawableModel != null) {
				Class222 class222 = method4347();
				Class235 class235 = method4337();
				...
				aClass60_9935.method701(class_ra, drawableModel, class222, i_3_,
						i_3_, i_4_, i_4_, false, -2048622161);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("wr.bb(").append(')').toString());
		}
	}
	...
	void method4371(GraphicsToolkit class_ra) {
		...
		if (drawableModel != null) {
			...
			aClass60_9935.method701(class_ra, drawableModel, class222, i, i, i_5_,
					i_5_, false, -1344370284);
		}
	}
	...
	final void method4355(GraphicsToolkit class_ra, Class365_Sub1 class365_sub1,
		...
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("wr.bk(").append(')').toString());
		}
	}

	boolean method4352(GraphicsToolkit class_ra, int i, int i_9_) {
		DrawableModel drawableModel = aClass60_9935.method700(class_ra, 131072, false,
				false, (byte) 94);
		if (drawableModel == null)
			return false;
	...
	void method4373(GraphicsToolkit class_ra) {
		...
		if (drawableModel != null) {
			...
			aClass60_9935.method701(class_ra, drawableModel, class222, i, i, i_10_,
					i_10_, false, 428224872);
		}
	}
	...
	public Class365_Sub1_Sub5_Sub2(Class331 class331, GraphicsToolkit class_ra,
			Class433 class433, ObjectDefinitions class432, int i, int i_11_, int i_12_,
			int i_13_, int i_14_, boolean bool, int i_15_, int i_16_, int i_17_) {
		super(class331, i_12_, i_13_, i_14_, i, i_11_, Class355.method4263(
				i_15_, i_16_, (byte) -51));
		aClass60_9935 = new Class60(class_ra, class433, class432, i_15_, i_16_,
				plane, i_11_, this, bool, i_17_);
		((Class365_Sub1_Sub5_Sub2) this).aBoolean9936 = 0 != 1532834983 * class432.anInt5382
				&& !bool;
	...
	boolean method4372(GraphicsToolkit class_ra, int i, int i_18_) {
		...
		if (drawableModel == null)
			return false;
		return drawableModel.method4787(i, i_18_, method4347(), false, 0);
	}
	...
	boolean method4350(GraphicsToolkit class_ra, int i, int i_23_, byte i_24_) {
		try {
			DrawableModel drawableModel = aClass60_9935.method700(class_ra, 131072,
					false, false, (byte) 30);
			if (drawableModel == null)
				return false;
			return drawableModel.method4787(i, i_23_, method4347(), false, 0);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("wr.bu(").append(')').toString());
		}
	}
	...
	boolean method4385(GraphicsToolkit class_ra, int i, int i_25_) {
		...
		if (drawableModel == null)
			return false;
		return drawableModel.method4787(i, i_25_, method4347(), false, 0);
	}

	public static void method4533(int i, String string, boolean bool,
			short i_26_) {
		try {
			while_108_: do {
				if (i == 0) {
					Class373.aClass_ra4071 = Class523
							.method6334(
									0,
									Class52_Sub2_Sub1.aCanvas9079,
									Class253.anInterface_ma2785,
									Class82_Sub6.aClass243_6844,
									Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub13_7550
											.method5675(-497177413) * 2,
									-659449737);
					if (null != string) {
						Class373.aClass_ra4071.ba(1, 0);
						Class505 class505 = Class322.method3931(
								Class173.aClass243_1758,
								(Class74.anInt690 * 1178461027), 0, (byte) 84);
						Class264 class264 = (Class373.aClass_ra4071.method5092(
								class505, Class89.method993(
										Class158.aClass243_6364,
										(1178461027 * Class74.anInt690), 0),
								true));
						Class148.method1614((byte) 42);
						Class139.method1548(string, true,
								Class373.aClass_ra4071, class264, class505,
								(byte) -38);
					}
				} else {
					GraphicsToolkit class_ra = null;
					if (null != string) {
						class_ra = Class523.method6334(0,
								(Class52_Sub2_Sub1.aCanvas9079),
								Class253.anInterface_ma2785,
								Class82_Sub6.aClass243_6844, 0, -199455021);
						class_ra.ba(1, 0);
						Class505 class505 = Class322.method3931(
								Class173.aClass243_1758,
								(Class74.anInt690 * 1178461027), 0, (byte) 29);
						Class264 class264 = (class_ra.method5092(class505,
								Class89.method993(Class158.aClass243_6364,
										(Class74.anInt690 * 1178461027), 0),
								true));
						Class148.method1614((byte) 9);
						Class139.method1548(string, true, class_ra, class264,
								class505, (byte) 53);
					}
					do {
						try {
							try {
								...
								if (string != null) {
									...
									Class505 class505 = (Class322.method3931(
											...
											Class74.anInt690 * 1178461027, 0,
											(byte) 32));
									Class264 class264 = (class_ra
											.method5092(
													class505,
													(Class89
															.method993(
																	Class158.aClass243_6364,
																	Class74.anInt690 * 1178461027,
																	0)), true));
									Class148.method1614((byte) 0);
									Class139.method1548(string, true, class_ra,
											class264, class505, (byte) -21);
								}
								if (Class373.aClass_ra4071.method5001()) {
									...
									Class_v class_v;
									if (bool_27_)
										class_v = Class373.aClass_ra4071
												.method5026(146800640);
									else
										class_v = Class373.aClass_ra4071
												.method5026(104857600);
									Class373.aClass_ra4071.method5027(class_v);
								}
							} catch (Throwable throwable) {
								int i_28_ = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571
										.method5677(-1530002941);
								if (i_28_ == 2)
			...
			if (Class373.aClass_ra4071.method5050())
				Class365_Sub1_Sub5_Sub1.method4525(
						Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub6_7551
								.method5647(-1411340111) == 1, -1054485931);
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("wr.fe(").append(')').toString());
		}
	}

	static final void method4534(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub5_7572
					.method5641(-1981564122) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("wr.any(").append(')').toString());
		}
	}

	static final void method4535(Class403 class403, int i) {
		try {
			((Class403) class403).anInt5239 -= -783761378;
			int i_29_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]);
			...
			for (int i_31_ = 0; i_31_ < 1168366243 * Class10.anInt129; i_31_++) {
				...
				if (0 == (Class10.aByteArray131[i_32_] & 0x1)) {
					if (i_30_ > 0) {
						...
						if (0 == i_33_) {
							i_30_ = Class127_Sub3.method1431(
									class298_sub53_sub2, 2074736782);
							Class10.aByteArray131[i_32_] |= 0x2;
						} else
							Class500.method6221(class298_sub53_sub2, i_32_,
									-1265435014);
					}
				}
			}
			...
			for (int i_34_ = 0; i_34_ < Class10.anInt129 * 1168366243; i_34_++) {
				...
				if (0 != (Class10.aByteArray131[i_35_] & 0x1)) {
					if (i_30_ > 0) {
						...
						if (i_36_ == 0) {
							i_30_ = Class127_Sub3.method1431(
									class298_sub53_sub2, 2076159127);
							Class10.aByteArray131[i_35_] |= 0x2;
						} else
							Class500.method6221(class298_sub53_sub2, i_35_,
									-1556347349);
					}
				}
			}
			...
			for (int i_37_ = 0; i_37_ < 1430471535 * Class10.anInt130; i_37_++) {
				...
				if ((Class10.aByteArray131[i_38_] & 0x1) != 0) {
					if (i_30_ > 0) {
						...
						if (0 == i_39_) {
							i_30_ = Class127_Sub3.method1431(
									class298_sub53_sub2, 2121776092);
							Class10.aByteArray131[i_38_] |= 0x2;
						} else if (Class501.method6229(class298_sub53_sub2,
								i_38_, -166989889))
							Class10.aByteArray131[i_38_] |= 0x2;
					}
				}
			...
			for (int i_40_ = 0; i_40_ < Class10.anInt130 * 1430471535; i_40_++) {
				...
				if ((Class10.aByteArray131[i_41_] & 0x1) == 0) {
					if (i_30_ > 0) {
						...
						if (i_42_ == 0) {
							i_30_ = Class127_Sub3.method1431(
									class298_sub53_sub2, 2129494225);
							Class10.aByteArray131[i_41_] |= 0x2;
						} else if (Class501.method6229(class298_sub53_sub2,
								i_41_, -1080126826))
							Class10.aByteArray131[i_41_] |= 0x2;
