...
public class Class365_Sub1_Sub1_Sub3 extends Class365_Sub1_Sub1 {
	...
	void method4479(GraphicsToolkit class_ra, DrawableModel drawableModel, Class222 class222,
		...
		try {
			...
			if (null != ((Class365_Sub1_Sub1_Sub3) this).aClass351_10137) {
				((Class365_Sub1_Sub1_Sub3) this).aClass351_10137.method4231(
						class_ra, (long) (443738891 * client.anInt8884),
						class85s, class68s, false);
				((Class365_Sub1_Sub1_Sub3) this).aClass351_10137.method4227(
						plane, aShort9798, aShort9796, aShort9795,
						aShort9797);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akr.i(").append(')').toString());
		}
	}
	...
	public Class334 method4358(GraphicsToolkit class_ra, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akr.bc(").append(')').toString());
		}
	}

	public Class365_Sub1_Sub1_Sub3(Class331 class331, int i, int i_0_,
			int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_,
			int i_7_, int i_8_, int i_9_, int i_10_, boolean bool) {
		super(class331, i_1_, i_2_, i_3_, i_4_, i_5_, i_6_, i_7_, i_8_, i_9_,
				false, (byte) 0);
		...
		Class398 class398 = (Class158_Sub1.aClass389_8568.method4857(
				((Class365_Sub1_Sub1_Sub3) this).anInt10135 * -743331725,
				-2103306753));
		int i_11_ = 1505778629 * class398.anInt5205;
		if (i_11_ != -1) {
			((Class365_Sub1_Sub1_Sub3) this).aClass438_10136 = new Class438_Sub2(
					this, false);
			int i_12_ = class398.aBoolean5215 ? 0 : 2;
			if (bool)
				i_12_ = 1;
			((Class365_Sub1_Sub1_Sub3) this).aClass438_10136.method5824(i_11_,
					i_0_, i_12_, false, (byte) 0);
		}
	...
	public final boolean method4481(byte i) {
		try {
			return (((Class365_Sub1_Sub1_Sub3) this).aClass438_10136 != null && !((Class365_Sub1_Sub1_Sub3) this).aClass438_10136
					.method5826(-65534));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akr.f(").append(')').toString());
		}
	}
	...
	DrawableModel method4482(GraphicsToolkit class_ra, int i, int i_13_, int i_14_) {
		try {
			...
			Class_xa class_xa_15_ = (aByte7724 < 3 ? aClass331_7722.aClass_xaArray3519[1 + aByte7724]
					: null);
			Class217 class217 = method4337().aClass217_2599;
			return ((((Class365_Sub1_Sub1_Sub3) this).aClass438_10136 != null && !((Class365_Sub1_Sub1_Sub3) this).aClass438_10136
					.method5832(1032843646)) ? class398.method4918(class_ra, i,
					true, class_xa, class_xa_15_, (int) class217.aFloat2451,
					(int) class217.aFloat2455, (int) class217.aFloat2454,
					(((Class365_Sub1_Sub1_Sub3) this).aClass438_10136),
					(byte) 2, 345220259) : class398.method4918(class_ra, i,
					true, class_xa, class_xa_15_, (int) class217.aFloat2451,
					(int) class217.aFloat2455, (int) class217.aFloat2454, null,
					(byte) 2, -2126228993));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akr.p(").append(')').toString());
		}
	}
	...
	final void method4355(GraphicsToolkit class_ra, Class365_Sub1 class365_sub1,
			int i, int i_16_, int i_17_, boolean bool, int i_18_) {
		try {
			throw new IllegalStateException();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akr.bk(").append(')').toString());
		}
	}
	...
	final boolean method4366(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akr.bw(").append(')').toString());
		}
	}

	public final void method4483(int i, int i_21_) {
		try {
			if (((Class365_Sub1_Sub1_Sub3) this).aClass438_10136 != null
					&& !((Class365_Sub1_Sub1_Sub3) this).aClass438_10136
							.method5832(-891942946))
				((Class365_Sub1_Sub1_Sub3) this).aClass438_10136.method5822(i,
						2083264997);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akr.a(").append(')').toString());
		}
	}
	...
	public final boolean method4484(int i) {
		try {
			return (null == ((Class365_Sub1_Sub1_Sub3) this).aClass438_10136 || ((Class365_Sub1_Sub1_Sub3) this).aClass438_10136
					.method5832(1776258671));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akr.b(").append(')').toString());
		}
	}
