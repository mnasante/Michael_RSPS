...
public class ItemDefinitions {
	...
	void method6027(ItemDefinitions class468_1_, ItemDefinitions class468_2_, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("th.p(").append(')').toString());
		}
	}

	public final Class64 method6028(boolean bool, Class464 class464, int i) {
		try {
			int i_3_;
			int i_4_;
			int i_5_;
			if (bool) {
				if (class464 != null && class464.anIntArray5695 != null) {
					...
					i_4_ = ((ItemDefinitions) this).anInt5746 * -1284247975;
				...
				i_4_ = ((ItemDefinitions) this).anInt5737 * 34210967;
				i_5_ = ((ItemDefinitions) this).anInt5759 * 1313278521;
			}
			if (i_3_ == -1)
				return null;
			Class64 class64 = Class64
					.method751(
							(((Class477) (((ItemDefinitions) this).aClass477_5751)).aClass243_5992),
							i_3_, 0);
			if (class64 == null)
				return null;
			...
			if (i_4_ != -1) {
				...
				if (i_5_ != -1) {
					Class64 class64_7_ = Class64
							.method751(
									(((Class477) ((ItemDefinitions) this).aClass477_5751).aClass243_5992),
									i_5_, 0);
					if (class64_7_.anInt630 < 13)
						class64_7_.method755(2);
					Class64[] class64s = { class64, class64_6_, class64_7_ };
					class64 = new Class64(class64s, 3);
				} else {
					Class64[] class64s = { class64, class64_6_ };
					class64 = new Class64(class64s, 2);
				}
			}
			if (!bool
					&& (0 != ((ItemDefinitions) this).anInt5742 * -1268579363
							|| 345393423 * ((ItemDefinitions) this).anInt5744 != 0 || 0 != ((ItemDefinitions) this).anInt5748 * 669576861))
				class64.method753(((ItemDefinitions) this).anInt5742 * -1268579363,
						345393423 * ((ItemDefinitions) this).anInt5744,
						669576861 * ((ItemDefinitions) this).anInt5748);
			if (bool
					&& (0 != -1436808331 * ((ItemDefinitions) this).anInt5743
							|| -92251131 * ((ItemDefinitions) this).anInt5745 != 0 || ((ItemDefinitions) this).anInt5710 * 1813909637 != 0))
				class64.method753(((ItemDefinitions) this).anInt5743 * -1436808331,
						((ItemDefinitions) this).anInt5745 * -92251131,
						1813909637 * ((ItemDefinitions) this).anInt5710);
			if (null != ((ItemDefinitions) this).aShortArray5754) {
				...
				for (int i_8_ = 0; i_8_ < ((ItemDefinitions) this).aShortArray5754.length; i_8_++)
					class64.method756(((ItemDefinitions) this).aShortArray5754[i_8_],
							is[i_8_]);
			}
			if (null != ((ItemDefinitions) this).aShortArray5711) {
				...
				for (int i_9_ = 0; i_9_ < ((ItemDefinitions) this).aShortArray5711.length; i_9_++)
					class64.method752(((ItemDefinitions) this).aShortArray5711[i_9_],
							is[i_9_]);
			}
			return class64;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("th.z(").append(')').toString());
		}
	}
		...
		try {
			if (null != ((ItemDefinitions) this).anIntArray5752 && i_10_ > 1) {
				...
				for (int i_17_ = 0; i_17_ < 10; i_17_++) {
					if (i_10_ >= ((ItemDefinitions) this).anIntArray5753[i_17_]
							&& 0 != ((ItemDefinitions) this).anIntArray5753[i_17_])
						i_16_ = ((ItemDefinitions) this).anIntArray5752[i_17_];
				}
				if (i_16_ != -1)
					return (((ItemDefinitions) this).aClass477_5751.getItemDefinitions(i_16_).method6029(class_ra, i, 1, class366,
							class438, i_11_, i_12_, i_13_, i_14_, 2041211835));
			}
			int i_18_ = i;
			if (null != class438)
			...
			if (null == drawableModel
				...
				Class64 class64 = Class64
						.method751(
								(((Class477) ((ItemDefinitions) this).aClass477_5751).aClass243_5992),
								(((ItemDefinitions) this).anInt5738 * 381556007), 0);
				if (null == class64)
					return null;
				if (class64.anInt630 < 13)
					class64.method755(2);
				drawableModel = (class_ra
						.method5037(
								class64,
								i_19_,
								(((Class477) ((ItemDefinitions) this).aClass477_5751).anInt5991)
										* -424819635,
								64 + 856370373 * ((ItemDefinitions) this).anInt5761,
								((ItemDefinitions) this).anInt5762 * 1055603853 + 850));
		...
		try {
			if (null != ((ItemDefinitions) this).anIntArray5752 && i > 1) {
				...
				for (int i_26_ = 0; i_26_ < 10; i_26_++) {
					if (i >= ((ItemDefinitions) this).anIntArray5753[i_26_]
							&& 0 != ((ItemDefinitions) this).anIntArray5753[i_26_])
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("th.u(").append(')').toString());
		}
	}

	int[] method6031(GraphicsToolkit class_ra, GraphicsToolkit class_ra_27_, int i,
			int i_28_, int i_29_, boolean bool, int i_30_, Class264 class264,
			Class366 class366, int i_31_) {
		//class_ra beeing used to draw
		try {
			Class64 class64 = Class64
					.method751(
							(((Class477) ((ItemDefinitions) this).aClass477_5751).aClass243_5992),
							381556007 * ((ItemDefinitions) this).anInt5738, 0);
			if (null == class64)
				return null;
			if (class64.anInt630 < 13)
				class64.method755(2);
			if (null != ((ItemDefinitions) this).aShortArray5754) {
				for (int i_32_ = 0; i_32_ < ((ItemDefinitions) this).aShortArray5754.length; i_32_++) {
					if (((ItemDefinitions) this).aByteArray5708 != null
							&& i_32_ < ((ItemDefinitions) this).aByteArray5708.length)
						class64
								.method756(
										(((ItemDefinitions) this).aShortArray5754[i_32_]),
										aShortArray5757[(((ItemDefinitions) this).aByteArray5708[i_32_]) & 0xff]);
					else
						class64.method756(
								(((ItemDefinitions) this).aShortArray5754[i_32_]),
								(((ItemDefinitions) this).aShortArray5706[i_32_]));
				}
			}
			if (null != ((ItemDefinitions) this).aShortArray5711) {
				for (int i_33_ = 0; i_33_ < ((ItemDefinitions) this).aShortArray5711.length; i_33_++)
					class64.method752(((ItemDefinitions) this).aShortArray5711[i_33_],
							(((ItemDefinitions) this).aShortArray5712[i_33_]));
			}
			if (null != class366) {
				for (int i_34_ = 0; i_34_ < 10; i_34_++) {
					for (int i_35_ = 0; i_35_ < Class366.aShortArrayArray3970[i_34_].length; i_35_++) {
						if (class366.anIntArray3973[i_34_] < (Class22.aShortArrayArrayArray278[i_34_][i_35_]).length)
							class64
									.method756(
											(Class366.aShortArrayArray3970[i_34_][i_35_]),
											(Class22.aShortArrayArrayArray278[i_34_][i_35_][(class366.anIntArray3973[i_34_])]));
					}
				}
			}
			int i_36_ = 2048;
			...
			if (-1773084507 * ((ItemDefinitions) this).anInt5758 != 128
					|| 128 != 902366341 * ((ItemDefinitions) this).anInt5702
					|| ((ItemDefinitions) this).anInt5739 * -230848851 != 128) {
				bool_37_ = true;
				i_36_ |= 0x7;
			}
			...
			if (-1 != -1673957995 * anInt5755) {
				class57 = (((ItemDefinitions) this).aClass477_5751.method6086(
						class_ra, class_ra_27_, 809765849 * anInt5709, 10, 1,
						0, true, true, 0, class264, class366, -1795675060));
				if (null == class57)
					return null;
			} else if (465190555 * anInt5719 != -1) {
				class57 = (((ItemDefinitions) this).aClass477_5751.method6086(
						class_ra, class_ra_27_, ((ItemDefinitions) this).anInt5756
								* -783380935, i, i_28_, i_29_, false, true, 0,
						class264, class366, 1124646536));
				if (null == class57)
					return null;
			} else if (-1 != anInt5770 * 2083650097) {
				class57 = (((ItemDefinitions) this).aClass477_5751.method6086(
						class_ra, class_ra_27_,
						1981372535 * ((ItemDefinitions) this).anInt5769, i, i_28_,
						i_29_, false, true, 0, class264, class366, 311548691));
				if (null == class57)
					return null;
			}
			int i_38_;
			...
			class233_39_.method2152(16.0F, 16.0F, 512.0F, 512.0F, 50.0F,
					2.14748365E9F, (float) class_ra.method4992((short) -14576)
							.method545(), (float) class_ra.method4992(
							(short) -3255).method552());
			class_ra.method5182(class233_39_);
			class_ra.method5187(0, 0, class_ra.method4992((short) 19509)
					.method545(), class_ra.method4992((short) 21763)
					.method552());
			...
			class222_40_.method2059(0.0F, 0.0F, 1.0F, Class220
					.method2049(-(anInt5716 * -1368639199) << 3));
			class222_40_.method2071(0.0F, 1.0F, 0.0F, Class220
					.method2049(anInt5715 * -3355859 << 3));
			class222_40_
					.method2064(
							...
							(float) ((((Class220.anIntArray2474[330519029 * anInt5714 << 3]) * i_38_) >> 14) + (anInt5718
									* -1811316489 << 2)));
			class222_40_.method2071(1.0F, 0.0F, 0.0F, Class220
					.method2049((anInt5714 * 330519029) << 3) );
			class_ra.ba(2, 0);
			class_ra.L();
			...
			if (-1 != anInt5755 * -1673957995)
				class57.method645(0, 0);
			if (1 == i_30_ || 2 == i_30_
					&& (anInt5704 * 789409129 == 1 || 1 != i) && i != -1)
				class264
						.method2488(
								Class108
										.method1149(
												i,
												(((Class477) (((ItemDefinitions) this).aClass477_5751)).aClass429_5997),
												-2134002342), 0, 9, -256,
								-16777215, 1072909030);
		...
		try {
			for (int i_49_ = 31; i_49_ > 0; i_49_--) {
				...
				for (int i_51_ = 35; i_51_ > 0; i_51_--) {
					if (is[i_51_ + i_50_] == 0
							&& 0 != is[i_50_ + i_51_ - 1 - 36])
						is[i_50_ + i_51_] = i;
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("th.q(").append(')').toString());
		}
	}
		...
		try {
			...
			if (bool) {
				if (class464 != null && class464.anIntArray5695 != null) {
					...
					i_53_ = -1284247975 * ((ItemDefinitions) this).anInt5746;
				...
				i_53_ = ((ItemDefinitions) this).anInt5737 * 34210967;
				i_54_ = 1313278521 * ((ItemDefinitions) this).anInt5759;
			}
			if (-1 == i_52_)
				return true;
			boolean bool_55_ = true;
			if (!((Class477) ((ItemDefinitions) this).aClass477_5751).aClass243_5992
					.method2290(i_52_, 0, -870541215))
				bool_55_ = false;
			if (i_53_ != -1
					&& !((Class477) ((ItemDefinitions) this).aClass477_5751).aClass243_5992
							.method2290(i_53_, 0, -1713048725))
				bool_55_ = false;
			if (i_54_ != -1
					&& !((Class477) ((ItemDefinitions) this).aClass477_5751).aClass243_5992
							.method2290(i_54_, 0, -818152674))
				bool_55_ = false;
			return bool_55_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("th.s(").append(')').toString());
		}
	}
		...
		try {
			...
			if (bool) {
				if (null != class464 && class464.anIntArray5697 != null) {
					...
					i_57_ = ((ItemDefinitions) this).anInt5764 * 1578724433;
				}
				...
				i_57_ = ((ItemDefinitions) this).anInt5749 * 86274879;
			}
			if (i_56_ == -1)
				return true;
			boolean bool_58_ = true;
			if (!((Class477) ((ItemDefinitions) this).aClass477_5751).aClass243_5992
					.method2290(i_56_, 0, -1403829212))
				bool_58_ = false;
			if (-1 != i_57_
					&& !((Class477) ((ItemDefinitions) this).aClass477_5751).aClass243_5992
							.method2290(i_57_, 0, -1542572465))
				bool_58_ = false;
			return bool_58_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("th.y(").append(')').toString());
		}
	}
	...
	void method6036(ItemDefinitions class468_59_, ItemDefinitions class468_60_, int i) {
		try {
			...
			((ItemDefinitions) this).anInt5737 = 1 * ((ItemDefinitions) class468_60_).anInt5737;
			((ItemDefinitions) this).anInt5759 = ((ItemDefinitions) class468_60_).anInt5759 * 1;
			anInt5747 = 1 * class468_60_.anInt5747;
			((ItemDefinitions) this).anInt5746 = ((ItemDefinitions) class468_60_).anInt5746 * 1;
			...
			((ItemDefinitions) this).anInt5749 = ((ItemDefinitions) class468_60_).anInt5749 * 1;
			((ItemDefinitions) this).anInt5750 = ((ItemDefinitions) class468_60_).anInt5750 * 1;
			((ItemDefinitions) this).anInt5764 = ((ItemDefinitions) class468_60_).anInt5764 * 1;
			...
			aStringArray5732[4] = Tradution.aClass470_5903
					.method6049(
							(((Class477) (((ItemDefinitions) this).aClass477_5751)).aClass429_5997),
							-875414210);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("th.k(").append(')').toString());
		}
	}
	...
	void method6038(RsByteBuffer stream, int opcode, boolean oldItems) {
		try {
			if (1 == opcode)
				((ItemDefinitions) this).anInt5738 = (oldItems ? stream.readCustomUnsignedShort() : stream
						.readBigSmart(1235052657))
						* -1019082089;
			else if (2 == opcode)
				...
				anInt5717 = stream.readUnsignedShort()
						* -1497539247;
				...
				anInt5733 = stream.readUnsignedByte()
						* -2026784241;
			else if (14 == opcode)
				...
				anInt5724 = (oldItems ? stream.readCustomUnsignedShort() : stream
						.readBigSmart(1235052657)) * -1612514031;
			else if (opcode == 24)
				((ItemDefinitions) this).anInt5737 = (oldItems ? stream.readCustomUnsignedShort() : stream
						.readBigSmart(1235052657)) * 582597415;
			else if (25 == opcode)
				anInt5747 = (oldItems ? stream.readCustomUnsignedShort() : stream
						.readBigSmart(1235052657)) * -1430077763;
			else if (26 == opcode)
				((ItemDefinitions) this).anInt5746 = (oldItems ? stream.readCustomUnsignedShort() : stream
						.readBigSmart(1235052657))
						* -336299543;
			else if (opcode == 27)
				...
				aStringArray5723[opcode - 30] = stream
						.readString(2111111360);
			else if (opcode >= 35 && opcode < 40)
				aStringArray5732[opcode - 35] = stream
						.readString(-101192414);
			else if (40 == opcode) {
				...
				for (int i_66_ = 0; i_66_ < i_65_; i_66_++) {
					((ItemDefinitions) this).aShortArray5754[i_66_] = (short) stream
							.readUnsignedShort();
					((ItemDefinitions) this).aShortArray5706[i_66_] = (short) stream
							.readUnsignedShort();
				}
			} else if (41 == opcode) {
				...
				for (int i_68_ = 0; i_68_ < i_67_; i_68_++) {
					((ItemDefinitions) this).aShortArray5711[i_68_] = (short) stream
							.readUnsignedShort();
					((ItemDefinitions) this).aShortArray5712[i_68_] = (short) stream
							.readUnsignedShort();
				}
			} else if (opcode == 42) {
				...
				for (int i_70_ = 0; i_70_ < i_69_; i_70_++)
					((ItemDefinitions) this).aByteArray5708[i_70_] = stream
							.readByte(-12558881);
			} else if (43 == opcode) {
				...
				((ItemDefinitions) this).anInt5759 = (oldItems ? stream.readCustomUnsignedShort() : stream
						.readBigSmart(1235052657)) * 756401161;
			else if (opcode == 79)
				((ItemDefinitions) this).anInt5741 = (oldItems ? stream.readCustomUnsignedShort() : stream
						.readBigSmart(1235052657)) * 2098680761;
			else if (opcode == 90)
				((ItemDefinitions) this).anInt5760 = (oldItems ? stream.readCustomUnsignedShort() : stream
						.readBigSmart(1235052657)) * 1319962769;
			else if (opcode == 91)
				((ItemDefinitions) this).anInt5750 = (oldItems ? stream.readCustomUnsignedShort() : stream
						.readBigSmart(1235052657)) * 1598907469;
			else if (opcode == 92)
				((ItemDefinitions) this).anInt5749 = (oldItems ? stream.readCustomUnsignedShort() : stream
						.readBigSmart(1235052657))
						* -1935344449;
			else if (93 == opcode)
				((ItemDefinitions) this).anInt5764 = (oldItems ? stream.readCustomUnsignedShort() : stream
						.readBigSmart(1235052657))
						* -1194369871;
			else if (95 == opcode)
				...
				((ItemDefinitions) this).anIntArray5752[opcode - 100] = stream
						.readUnsignedShort();
				((ItemDefinitions) this).anIntArray5753[opcode - 100] = stream
						.readUnsignedShort();
			} else if (opcode == 110)
				((ItemDefinitions) this).anInt5758 = stream
						.readUnsignedShort()
						* -237762771;
			else if (111 == opcode)
				((ItemDefinitions) this).anInt5702 = stream
						.readUnsignedShort() * 355882061;
			else if (opcode == 112)
				((ItemDefinitions) this).anInt5739 = stream
						.readUnsignedShort() * 1219480869;
			else if (opcode == 113)
				((ItemDefinitions) this).anInt5761 = stream
						.readByte(-12558881) * 712208909;
			else if (opcode == 114)
				((ItemDefinitions) this).anInt5762 = stream
						.readByte(-12558881)
						* -1050247335;
			else if (115 == opcode)
				anInt5700 = stream.readUnsignedByte() * 1325490629;
			else if (121 == opcode)
				((ItemDefinitions) this).anInt5756 = stream
						.readUnsignedShort()
						* -970653687;
			else if (122 == opcode)
				anInt5719 = stream.readUnsignedShort() * 2015131539;
			else if (opcode == 125) {
				((ItemDefinitions) this).anInt5742 = ((stream
						.readByte(-12558881) << 2) * -1833538443);
				((ItemDefinitions) this).anInt5744 = (stream
						.readByte(-12558881) << 2)
						* -25983505;
				((ItemDefinitions) this).anInt5748 = (stream
						.readByte(-12558881) << 2) * 1243416501;
			} else if (opcode == 126) {
				((ItemDefinitions) this).anInt5743 = ((stream
						.readByte(-12558881) << 2) * -1039520547);
				((ItemDefinitions) this).anInt5745 = (stream
						.readByte(-12558881) << 2) * 1803423949;
				((ItemDefinitions) this).anInt5710 = (stream
						.readByte(-12558881) << 2) * 519268429;
			} else if (opcode == 127) {
				...
				anInt5736 = stream.readUnsignedByte()
						* -2098727417;
				...
				for (int i_72_ = 0; i_72_ < i_71_; i_72_++)
					anIntArray5767[i_72_] = stream
							.readUnsignedShort();
			} else if (134 == opcode)
				anInt5768 = stream.readUnsignedByte() * 1394978643;
			else if (139 == opcode)
				((ItemDefinitions) this).anInt5769 = stream
						.readUnsignedShort() * 257950023;
			else if (opcode == 140)
				...
				for (int i_75_ = 0; i_75_ < i_73_; i_75_++) {
					...
					Class298 class298;
					if (bool)
						class298 = new Class298_Sub29(stream
								.readString(-1208778402));
					else
	...
	void method6039(ItemDefinitions class468_77_, ItemDefinitions class468_78_, int i) {
		try {
			...
			((ItemDefinitions) this).anInt5737 = ((ItemDefinitions) class468_78_).anInt5737 * 1;
			((ItemDefinitions) this).anInt5759 = 1 * ((ItemDefinitions) class468_78_).anInt5759;
			anInt5747 = 1 * class468_78_.anInt5747;
			((ItemDefinitions) this).anInt5746 = ((ItemDefinitions) class468_78_).anInt5746 * 1;
			...
			((ItemDefinitions) this).anInt5749 = 1 * ((ItemDefinitions) class468_78_).anInt5749;
			((ItemDefinitions) this).anInt5750 = 1 * ((ItemDefinitions) class468_78_).anInt5750;
			((ItemDefinitions) this).anInt5764 = 1 * ((ItemDefinitions) class468_78_).anInt5764;
			...
			aStringArray5732[4] = Tradution.aClass470_5855
					.method6049(
							(((Class477) (((ItemDefinitions) this).aClass477_5751)).aClass429_5997),
							-875414210);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("th.i(").append(')').toString());
		}
	}

	public final Class64 method6040(boolean bool, Class464 class464, int i) {
		try {
			int i_80_;
			int i_81_;
			if (bool) {
				if (class464 != null && null != class464.anIntArray5697) {
					...
					i_81_ = 1578724433 * ((ItemDefinitions) this).anInt5764;
				}
			} else if (null != class464 && null != class464.anIntArray5690) {
				...
				i_81_ = ((ItemDefinitions) this).anInt5749 * 86274879;
			}
			if (-1 == i_80_)
				return null;
			Class64 class64 = Class64
			...
			if (class64.anInt630 < 13)
				class64.method755(2);
			if (-1 != i_81_) {
				Class64 class64_82_ = Class64
						.method751(
								(((Class477) ((ItemDefinitions) this).aClass477_5751).aClass243_5992),
								i_81_, 0);
				if (class64_82_.anInt630 < 13)
					class64_82_.method755(2);
				Class64[] class64s = { class64, class64_82_ };
				class64 = new Class64(class64s, 2);
			}
			if (null != ((ItemDefinitions) this).aShortArray5754) {
				short[] is;
				...
				for (int i_83_ = 0; i_83_ < ((ItemDefinitions) this).aShortArray5754.length; i_83_++)
					class64.method756(((ItemDefinitions) this).aShortArray5754[i_83_],
							is[i_83_]);
			}
			if (null != ((ItemDefinitions) this).aShortArray5711) {
				short[] is;
				...
				for (int i_84_ = 0; i_84_ < ((ItemDefinitions) this).aShortArray5711.length; i_84_++)
					class64.method752(((ItemDefinitions) this).aShortArray5711[i_84_],
							is[i_84_]);
			}
			return class64;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("th.t(").append(')').toString());
		}
	}
	...
	ItemDefinitions() {
		...
		((ItemDefinitions) this).anInt5737 = -582597415;
		anInt5747 = 1430077763;
		((ItemDefinitions) this).anInt5746 = 336299543;
		...
		((ItemDefinitions) this).anInt5749 = 1935344449;
		((ItemDefinitions) this).anInt5750 = -1598907469;
		((ItemDefinitions) this).anInt5764 = 1194369871;
		anInt5709 = 384973719;
	...
	static final void method6042(int i, int i_86_, int i_87_) {
		try {
			if (Class301_Sub1.aFloat3233 < Class301_Sub1.aFloat3234) {
				...
				Class301_Sub1.aByteArrayArrayArray3229 = IcmpService_Sub1
						.method6381(Class301_Sub1.anInt3254, 818170582);
				...
				Class301_Sub1.anInt3254 = (int) Class301_Sub1.aFloat3233 >> 1;
				Class301_Sub1.aByteArrayArrayArray3229 = IcmpService_Sub1
						.method6381(Class301_Sub1.anInt3254, 1742182898);
			}
			if (Class301_Sub1.anInt7632 * -1198160439 != -1
					&& -1 != -19739017 * Class301_Sub1.anInt7627) {
				...
				Class376.anInt4090 = (i_89_ + 1882038855 * Class376.anInt4090)
						* -435591305;
				if (i_88_ == 0 && i_89_ == 0) {
			...
			if (Class301_Sub1.aBoolean7628 && Class476.aClass453_5986 != null) {
				for (Class298_Sub6 class298_sub6 = ((Class298_Sub6) Class476.aClass453_5986
						.method5939(1766612795)); null != class298_sub6; class298_sub6 = (Class298_Sub6) Class476.aClass453_5986
						.method5944(49146)) {
					Class352 class352 = (Class301_Sub1.aClass339_3251
							.method4116(
									-530122905
											* (((Class298_Sub6) class298_sub6).aClass298_Sub52_7206.anInt7608),
									-1186797555));
					if (class298_sub6.method2862(i, i_86_, (byte) 19)) {
						if (class352.aStringArray3778 != null) {
							if (null != class352.aStringArray3778[4])
								Class234
										.method2174(
												class352.aStringArray3778[4],
												class352.aString3789,
												-1,
												1012,
												-1,
												(long) ((((Class298_Sub6) class298_sub6).aClass298_Sub52_7206.anInt7608) * -530122905),
												class352.anInt3817 * -804513353,
												0,
												true,
												false,
												(long) ((((Class298_Sub6) class298_sub6).aClass298_Sub52_7206.anInt7608) * -530122905),
							...
							if (class352.aStringArray3778[3] != null)
								Class234
										.method2174(
												class352.aStringArray3778[3],
												class352.aString3789,
												-1,
												1011,
												-1,
												(long) (-530122905 * (((Class298_Sub6) class298_sub6).aClass298_Sub52_7206.anInt7608)),
												class352.anInt3817 * -804513353,
												0,
												true,
												false,
						...
						Class126
								.method1405(
										Class502.aClass502_6718,
										(-530122905 * (((Class298_Sub6) class298_sub6).aClass298_Sub52_7206.anInt7608)),
										-804513353 * class352.anInt3817,
										-1187185253);
					}
				}
			}
	...
	public static int method6043(int i, int i_90_, int i_91_) {
		try {
			...
			if (i != Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571
				...
				Class371.method4584(i, (Tradution.aClass470_5789.method6049(
						Class321.aClass429_3357, -875414210)), true, (byte) 53);
				if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571
						.method5677(-1001808225) != i)
					return -1;
			}
			int i_92_;
			try {
				Dimension dimension = Class52_Sub2_Sub1.aCanvas9079.getSize();
				Class139.method1548(Tradution.aClass470_5789.method6049(
				...
				class233.method2152((float) (dimension.width / 2),
						(float) (dimension.height / 2), 512.0F, 512.0F,
						(float) client.aClass283_8716.method2634((byte) -121),
						(float) client.aClass283_8716.method2635(1789119116),
				...
				long l_97_ = ((long) (i_93_ * 1000) / (Class122
						.method1319((byte) 1) - l));
				Class373.aClass_ra4071.ba(3, 0);
				i_92_ = (int) l_97_;
			} catch (Throwable throwable) {
