...
public class Class276 {
	...
	boolean method2575(GraphicsToolkit class_ra, Class276 class276_0_) {
		return (((Class276) this).aClass57_2925 != null || method2578(class_ra,
				class276_0_));
	}
		...
		if (aDrawableModel_2936 == null) {
			...
			for (int i = 0; i <= 24; i++) {
				...
				if (i > 0) {
					int i_9_ = i * 23 + 2;
					int i_10_ = i_9_ - 23;
					class64.method748(0, i_10_, i_9_, (byte) 0, (byte) 0,
							(short) 127, (byte) 0, (short) 0);
					for (int i_11_ = 1; i_11_ < 23; i_11_++) {
						int i_12_ = i_10_ + 1;
						int i_13_ = i_9_ + 1;
						class64.method748(i_10_, i_12_, i_9_, (byte) 0,
								(byte) 0, (short) 127, (byte) 0, (short) 0);
						class64.method748(i_12_, i_13_, i_9_, (byte) 0,
								(byte) 0, (short) 127, (byte) 0, (short) 0);
						i_10_ = i_12_;
						i_9_ = i_13_;
					}
					class64.method748(i_9_, i_10_, 1, (byte) 0, (byte) 0,
							(short) 127, (byte) 0, (short) 0);
				}
			}
	...
	void method2577(GraphicsToolkit class_ra, int i, int i_14_, int i_15_, int i_16_,
		...
		if (((Class276) this).aClass57_2925 != null) {
			...
			if (!(fs[2] < 0.0F)) {
				...
				if (i_27_ < i_16_ && i_27_ + ((Class276) this).anInt2920 > 0
						&& i_26_ < i_15_
						&& i_26_ + ((Class276) this).anInt2920 > 0)
					((Class276) this).aClass57_2925.method634(i_26_, i_27_,
							((Class276) this).anInt2920,
	...
	boolean method2578(GraphicsToolkit class_ra, Class276 class276_28_) {
		if (((Class276) this).aClass57_2925 == null) {
			if (((Class276) this).anInt2928 == 0) {
				if (Class277.anInterface_ma2955.method170(
						(((Class276) this).anInt2918), (short) 14716)) {
					int[] is = (Class277.anInterface_ma2955.method172(
							((Class276) this).anInt2918, 0.7F,
							((Class276) this).anInt2923,
							((Class276) this).anInt2923, false, (byte) 2));
					((Class276) this).aClass57_2925 = class_ra.method5031(is,
							0, ((Class276) this).anInt2923,
							((Class276) this).anInt2923,
							((Class276) this).anInt2923, -1518966523);
				}
	...
	boolean method2579(int i, int i_29_, int i_30_, int i_31_) {
		...
		if (!((Class276) this).aBoolean2913) {
			...
			((Class276) this).anInt2919 = (int) Math.sqrt((double) (i_32_
					* i_32_ + i_33_ * i_33_ + i_34_ * i_34_));
		...
		int i_35_ = (int) (Math
				.sqrt((double) (i_32_ * i_32_ + i_33_ * i_33_ + i_34_ * i_34_)) * 256.0);
		if (i_35_ > 128) {
			i_32_ = (i_32_ << 16) / i_35_;
			i_33_ = (i_33_ << 16) / i_35_;
			i_34_ = (i_34_ << 16) / i_35_;
			((Class276) this).anInt2920 = (((Class276) this).anInt2931 * i_31_ / (((Class276) this).aBoolean2913 ? 1024
					: ((Class276) this).anInt2919));
		} else
			((Class276) this).anInt2920 = 0;
		...
		((Class276) this).anInt2927 = (int) (Math
				.asin((double) ((float) i_33_ / 256.0F)) * 2607.5945876176133) & 0x3fff;
		((Class276) this).anInt2921 = (int) (Math.atan2((double) i_32_,
				(double) -i_34_) * 2607.5945876176133) & 0x3fff;
		((Class276) this).aClass57_2925 = null;
		return true;
	}
	...
	void method2580(GraphicsToolkit class_ra, Class276 class276_37_) {
		...
		class_ra.r(0, 0, ((Class276) this).anInt2923,
				((Class276) this).anInt2923);
		class_ra.ba(2, 0);
		class_ra.B(0, 0, ((Class276) this).anInt2923,
				((Class276) this).anInt2923, ~0xffffff
						| ((Class276) this).anInt2935, 0);
		int i = 0;
		int i_38_ = 0;
		int i_39_ = 256;
		...
		class233_47_.method2153((float) (((Class276) this).anInt2923 / 2),
				(float) (((Class276) this).anInt2923 / 2), (float) i_46_,
				(float) i_46_, 50.0F, 50000.0F, (float) class_ra.method4992(
						(short) 17114).method545(), (float) class_ra
						.method4992((short) -20188).method552(), 1024.0F);
		...
		aClass57_2922.method634(i_49_, i_49_, i_48_, i_48_, 0, ~0xffffff
				| ((Class276) this).anInt2935, 1);
		((Class276) this).aClass57_2925 = class_ra.method5033(0, 0,
				((Class276) this).anInt2923, ((Class276) this).anInt2923, true);
		class_ra.ba(2, 0);
		class_ra.B(0, 0, ((Class276) this).anInt2923,
				((Class276) this).anInt2923, 0, 0);
		aClass57_2937.method634(0, 0, ((Class276) this).anInt2923,
				((Class276) this).anInt2923, 1, 0, 0);
		((Class276) this).aClass57_2925.method632(0, 0, 3);
		class_ra.method5182(class233);
		class_ra.r(anIntArray2938[0], anIntArray2938[1], anIntArray2938[2],
				anIntArray2938[3]);
	}
			...
			for (int i = 0; i < 64; i++) {
				...
				for (int i_55_ = 0; i_55_ < 64; i_55_++) {
					...
					if (i_58_ < 0)
						...
						i_58_ = 255;
					int i_59_ = i_58_ / 2;
					is_50_[i_53_ + i_55_] = is_50_[i_53_ + i_57_] = is_50_[i_54_
							+ i_55_] = is_50_[i_54_ + i_57_] = ~0xffffff
							| i_58_ << 16;
					is[i_53_ + i_55_] = is[i_53_ + i_57_] = is[i_54_ + i_55_] = is[i_54_
							+ i_57_] = 127 - i_59_ << 24 | 0xffffff;
				}
			}
			aClass57_2937 = class_ra.method5031(is_50_, 0, 128, 128, 128,
					-529255066);
			aClass57_2922 = class_ra.method5031(is, 0, 128, 128, 128,
					-965635972);
		}
	}

	void method2582(GraphicsToolkit class_ra, Class276 class276_60_) {
		Class64 class64 = Class64.method751(Class465.aClass243_6520,
				((Class276) this).anInt2918, 0);
		if (class64 != null) {
			class_ra.qa(anIntArray2938);
			class_ra.r(0, 0, ((Class276) this).anInt2923,
					((Class276) this).anInt2923);
			...
			class_ra.IA(1.0F);
			class_ra.m(((Class276) this).anInt2935, 1.0F, 1.0F, (float) i,
					(float) i_61_, (float) i_62_);
			...
			class233_75_.method2153((float) (((Class276) this).anInt2923 / 2),
					(float) (((Class276) this).anInt2923 / 2), (float) i_74_,
					(float) i_74_, 50.0F, 50000.0F, (float) class_ra
							.method4992((short) -8264).method545(),
					(float) class_ra.method4992((short) 11671).method552(),
					1024.0F);
	...
	public Class276(int i, int i_77_, int i_78_, int i_79_, int i_80_,
			int i_81_, int i_82_, boolean bool, int i_83_, int i_84_, int i_85_) {
