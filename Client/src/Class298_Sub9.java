		...
		try {
			...
			if (null != class350 && null != class350.anIntArray3732) {
				...
				for (int i_3_ = 0; i_3_ < class350.anIntArray3732.length; i_3_++) {
					...
					if (i_4_ >= 0
							&& i_4_ < ((Class298_Sub9) this).anIntArray7226.length)
			...
			if (null == drawableModel
				...
				for (int i_7_ = 0; i_7_ < is.length; i_7_++) {
					...
					} else if (!Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(
							is[i_7_]).method6034(bool, null,
							(byte) -79))
						bool_6_ = true;
				}
				if (bool_6_)
				...
				for (int i_8_ = 0; i_8_ < is.length; i_8_++) {
					if (is[i_8_] == -1) {
						...
						class64s[i_8_] = Class298_Sub32_Sub14.aClass477_9400
								.getItemDefinitions(is[i_8_]).method6028(
										bool, null, -1732273011);
				}
						...
						if (class350.anIntArrayArray3710[i_9_] != null) {
							if (null == class64s[i_9_]) {
								...
								if (i_13_ != 0 || i_14_ != 0 || i_15_ != 0)
									class64s[i_9_].method754(i_13_, i_14_,
											i_15_);
								if (i_10_ != 0 || 0 != i_11_ || 0 != i_12_)
									class64s[i_9_].method753(i_10_, i_11_,
											i_12_);
							}
						}
					}
	...
	long method2892(int[] is, int i, int[] is_19_, boolean bool, int i_20_) {
		try {
			...
			for (int i_21_ = 0; i_21_ < is.length; i_21_++) {
				l = l >>> 8
						^ ls[(int) ((l ^ (long) (is[i_21_] >> 24)) & 0xffL)];
				l = l >>> 8
						^ ls[(int) ((l ^ (long) (is[i_21_] >> 16)) & 0xffL)];
			...
			if (null != is_19_) {
				for (int i_22_ = 0; i_22_ < 5; i_22_++)
					l = l >>> 8
							^ ls[(int) ((l ^ (long) is_19_[i_22_]) & 0xffL)];
			}
			l = l >>> 8 ^ ls[(int) ((l ^ (long) (bool ? 1 : 0)) & 0xffL)];
			return l;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aam.q(").append(')').toString());
		}
	}
