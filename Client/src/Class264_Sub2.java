...
public class Class264_Sub2 extends Class264 {
	...
	void method2504(byte[] is, int[] is_0_, int i, int i_1_, int i_2_,
			int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_,
			int i_9_, Class_ta class_ta, int i_10_, int i_11_) {
		...
		int i_14_ = i_7_
				- -912871679
				* (((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anInt7974);
		int i_15_ = i_8_;
		if (i_11_ > i_15_) {
			i_15_ = i_11_;
		...
		int i_16_ = (is_12_.length + i_11_ < i_8_ + i_4_ ? i_11_
				+ is_12_.length : i_8_ + i_4_);
		for (int i_17_ = i_15_; i_17_ < i_16_; i_17_++) {
			...
			for (int i_24_ = -i_19_; i_24_ < 0; i_24_++) {
				...
				if (0 != i_25_) {
					int i_26_ = ((((i & 0xff00) * i_25_ & 0xff0000) + ((i & 0xff00ff)
							* i_25_ & ~0xff00ff)) >> 8);
					i_25_ = 256 - i_25_;
					int i_27_ = is_0_[i_2_];
					is_0_[i_2_++] = ((((i_27_ & 0xff00ff) * i_25_ & ~0xff00ff) + (i_25_
							* (i_27_ & 0xff00) & 0xff0000)) >> 8)
							+ i_26_;
				} else
					i_2_++;
			}
	...
	void method2505(byte[] is, int[] is_28_, int i, int i_29_, int i_30_,
		...
		for (int i_35_ = -i_32_; i_35_ < 0; i_35_++) {
			for (int i_36_ = -i_31_; i_36_ < 0; i_36_++) {
				...
				if (0 != i_37_) {
					int i_38_ = ((((i & 0xff00) * i_37_ & 0xff0000) + (i_37_
							* (i & 0xff00ff) & ~0xff00ff)) >> 8);
					i_37_ = 256 - i_37_;
					int i_39_ = is_28_[i_30_];
					is_28_[i_30_++] = (((i_37_ * (i_39_ & 0xff00ff) & ~0xff00ff) + ((i_39_ & 0xff00)
							* i_37_ & 0xff0000)) >> 8)
							+ i_38_;
				} else
					i_30_++;
	...
	Class264_Sub2(Class_ra_Sub1 class_ra_sub1, Class505 class505,
			Class89[] class89s, int[] is, int[] is_40_) {
	...
	void method2486(char c, int i, int i_44_, int i_45_, boolean bool,
		...
		if ((((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anIntArray7967) != null) {
			if (null == class_ta)
				...
				int i_54_ = 0;
				if (i_44_ < -1278653805
						* (((Class_ra_Sub1) (((Class264_Sub2) this).aClass_ra_Sub1_7122)).anInt7976)) {
					int i_55_ = (-1278653805
							* ((Class_ra_Sub1) (((Class264_Sub2) this).aClass_ra_Sub1_7122)).anInt7976 - i_44_);
					i_49_ -= i_55_;
				...
				if (i < (((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anInt7974 * -912871679)) {
					int i_56_ = (-912871679
							* ((Class_ra_Sub1) (((Class264_Sub2) this).aClass_ra_Sub1_7122)).anInt7974 - i);
					i_48_ -= i_56_;
				...
				if (i + i_48_ > -1416794725
						* (((Class_ra_Sub1) (((Class264_Sub2) this).aClass_ra_Sub1_7122)).anInt7991)) {
					int i_57_ = i_48_
							+ i
							- (((Class_ra_Sub1) (((Class264_Sub2) this).aClass_ra_Sub1_7122)).anInt7991)
							* -1416794725;
				...
				if (i_48_ > 0 && i_49_ > 0)
					method2504(
							((Class264_Sub2) this).aByteArrayArray7123[c],
							(((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anIntArray7967),
							i_45_, i_54_, i_51_, i_48_, i_49_, i_52_, i_53_, i,
							i_44_, ((Class264_Sub2) this).anIntArray7124[c],
	...
	void UA(char c, int i, int i_58_, int i_59_, boolean bool) {
		if ((((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anIntArray7967) != null) {
			...
			if (i_58_ < -1278653805
					* (((Class_ra_Sub1) (((Class264_Sub2) this).aClass_ra_Sub1_7122)).anInt7976)) {
				int i_67_ = ((((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anInt7976)
						* -1278653805 - i_58_);
				i_61_ -= i_67_;
			...
			if (i_61_ + i_58_ > 63686679 * (((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anInt7977))
				i_61_ -= i_61_
						+ i_58_
						- 63686679
						* (((Class_ra_Sub1) (((Class264_Sub2) this).aClass_ra_Sub1_7122)).anInt7977);
			if (i < (((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anInt7974)
					* -912871679) {
				int i_68_ = ((((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anInt7974)
						* -912871679 - i);
				i_60_ -= i_68_;
				i = (((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anInt7974 * -912871679);
				i_66_ += i_68_;
			...
			if (i_60_ + i > (((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anInt7991)
					* -1416794725) {
				int i_69_ = i_60_
						+ i
						- (((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anInt7991)
	...
	void g(char c, int i, int i_70_, int i_71_, boolean bool) {
		if ((((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anIntArray7967) != null) {
			...
			if (i_70_ < -1278653805
					* (((Class_ra_Sub1) (((Class264_Sub2) this).aClass_ra_Sub1_7122)).anInt7976)) {
				int i_79_ = ((((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anInt7976)
						* -1278653805 - i_70_);
				i_73_ -= i_79_;
			...
			if (i < (((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anInt7974)
					* -912871679) {
				int i_80_ = ((((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anInt7974)
						* -912871679 - i);
				i_72_ -= i_80_;
				i = (((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anInt7974 * -912871679);
				i_78_ += i_80_;
			...
			if (i_72_ + i > (((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anInt7991)
					* -1416794725) {
				int i_81_ = i_72_
						+ i
						- (((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anInt7991)
			...
			if (i_72_ > 0 && i_73_ > 0)
				method2505(
						((Class264_Sub2) this).aByteArrayArray7123[c],
						(((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anIntArray7967),
						i_71_, i_78_, i_75_, i_72_, i_73_, i_76_, i_77_);
		}
	}
	...
	void e(char c, int i, int i_82_, int i_83_, boolean bool) {
		if ((((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anIntArray7967) != null) {
			...
			if (i_82_ < -1278653805
					* (((Class_ra_Sub1) (((Class264_Sub2) this).aClass_ra_Sub1_7122)).anInt7976)) {
				int i_91_ = ((((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anInt7976)
						* -1278653805 - i_82_);
				i_85_ -= i_91_;
			...
			if (i < (((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anInt7974)
					* -912871679) {
				int i_92_ = ((((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anInt7974)
						* -912871679 - i);
				i_84_ -= i_92_;
				i = (((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anInt7974 * -912871679);
				i_90_ += i_92_;
			...
			if (i_84_ + i > (((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anInt7991)
					* -1416794725) {
				int i_93_ = i_84_
						+ i
						- (((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anInt7991)
	...
	void method2489(char c, int i, int i_94_, int i_95_, boolean bool,
			Class_ta class_ta, int i_96_, int i_97_) {
		if ((((Class_ra_Sub1) ((Class264_Sub2) this).aClass_ra_Sub1_7122).anIntArray7967) != null) {
			if (null == class_ta)
				...
				if (i_94_ < -1278653805
						* (((Class_ra_Sub1) (((Class264_Sub2) this).aClass_ra_Sub1_7122)).anInt7976)) {
					int i_105_ = (-1278653805
							* ((Class_ra_Sub1) (((Class264_Sub2) this).aClass_ra_Sub1_7122)).anInt7976 - i_94_);
					i_99_ -= i_105_;
				...
				if (i_98_ > 0 && i_99_ > 0)
					method2504(
							...
							i_103_, i, i_94_,
							((Class264_Sub2) this).anIntArray7124[c], class_ta,
							i_96_, i_97_);
			}
		}
	}
	...
	static final int method2508(int i, int i_114_, short i_115_) {
		try {
			int i_116_ = (Class129.method1447(i - 1, i_114_ - 1, 274655009)
					+ Class129.method1447(1 + i, i_114_ - 1, 274655009)
					+ Class129.method1447(i - 1, i_114_ + 1, 274655009) + Class129
					.method1447(1 + i, 1 + i_114_, 274655009));
			int i_117_ = (Class129.method1447(i - 1, i_114_, 274655009)
					+ Class129.method1447(i + 1, i_114_, 274655009)
					+ Class129.method1447(i, i_114_ - 1, 274655009) + Class129
					.method1447(i, 1 + i_114_, 274655009));
			int i_118_ = Class129.method1447(i, i_114_, 274655009);
			return i_118_ / 4 + (i_117_ / 8 + i_116_ / 16);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("xk.o(").append(')').toString());
		}
	}
}
