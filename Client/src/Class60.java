...
public class Class60 {
	...
	final DrawableModel method700(GraphicsToolkit class_ra, int i, boolean bool,
		...
		try {
			...
			if (class432.anIntArray5366 != null)
				class432 = class432
						.method5777(
								(0 == 1596783995 * client.anInt8724 ? (Interface23) (Class87.anInterface23_796)
										: Class128.aClass148_6331), 1333630702);
			if (class432 == null) {
				method707(class_ra, -475225909);
				((Class60) this).anInt595 = -1646192771;
				return null;
			}
			if (!((Class60) this).aBoolean592
			...
			if (bool_1_)
				bool_1_ = bool_1_
						& (((Class60) this).aBoolean598
								& !((Class60) this).aBoolean600 & Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub7_7581
								.method5650(-896655100) != 0);
			if (bool && !bool_1_) {
				((Class60) this).anInt595 = -722933511 * class432.anInt5365;
				return null;
			}
			Class217 class217 = (((Class60) this).aClass365_Sub1_587
					.method4337().aClass217_2599);
			Class331 class331 = client.aClass283_8716.method2675(-1611682495);
			if (bool_1_) {
				class331.method4047(((Class60) this).aClass_na599,
						((Class60) this).aByte588, (int) class217.aFloat2451,
						(int) class217.aFloat2454,
						((Class60) this).aBooleanArray596, 528677416);
				((Class60) this).aBoolean600 = false;
			}
			...
			if (((Class60) this).aClass438_593.method5819((byte) -82)) {
				...
				drawableModel = (class432
						.method5774(
								class_ra,
								i,
								(11 != ((Class60) this).anInt589 * -1598457753 ? -1598457753
										* ((Class60) this).anInt589
										: 10),
								(11 == -1598457753 * ((Class60) this).anInt589 ? 4 + ((Class60) this).anInt590 * 748228569
										: 748228569 * ((Class60) this).anInt590),
								class_xa,
								class_xa_3_,
								(int) class217.aFloat2451,
								class_xa.method6340((int) class217.aFloat2451,
										(int) class217.aFloat2454, -1408801129),
								(int) class217.aFloat2454,
				...
				Class454 class454 = (class432
						.method5785(
								class_ra,
								i,
								(((Class60) this).anInt589 * -1598457753 != 11 ? -1598457753
										* ((Class60) this).anInt589
										: 10),
								(11 == ((Class60) this).anInt589 * -1598457753 ? 748228569 * ((Class60) this).anInt590 + 4
										: 748228569 * ((Class60) this).anInt590),
								class_xa,
								class_xa_3_,
								(int) class217.aFloat2451,
								class_xa.method6340((int) class217.aFloat2451,
										(int) class217.aFloat2454, -1367024792),
		...
		try {
			...
			if ((((Class60) this).aClass351_602 == null || ((Class60) this).aClass351_602.aBoolean3772)
				...
				if (class432.anIntArray5366 != null)
					class432 = (class432
							.method5777(
									(client.anInt8724 * 1596783995 == 0 ? (Interface23) Class87.anInterface23_796
											: Class128.aClass148_6331),
									1897177328));
				if (null != class432)
					((Class60) this).aClass351_602 = Class351.method4232(
			...
			if (null != ((Class60) this).aClass351_602) {
				...
				if (bool)
					...
					((Class60) this).aClass351_602
							.method4233((long) (443738891 * client.anInt8884));
				((Class60) this).aClass351_602.method4227(
						(((Class60) this).aByte603), i, i_4_, i_5_, i_6_);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ck.k(").append(')').toString());
		}
	}
	...
	void method702(GraphicsToolkit class_ra, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ck.u(").append(')').toString());
		}
	}

	Class60(GraphicsToolkit class_ra, Class433 class433, ObjectDefinitions class432, int i,
			int i_8_, int i_9_, int i_10_, Class365_Sub1 class365_sub1,
		...
		((Class60) this).aBoolean598 = (class_ra.method5082()
				&& class432.aBoolean5433 && !((Class60) this).aBoolean591);
	...
	void method703(Class365_Sub1 class365_sub1, int i) {
		try {
			if (((Class60) this).aClass438_593.method5819((byte) -77)) {
				if (((Class60) this).aClass438_593.method5822(
						(client.anInt8884 * 443738891 - -735091231
								* ((Class60) this).anInt594), 1976097000)) {
					if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub7_7581
	...
	void method704(boolean bool, int i, int i_12_, int i_13_) {
		try {
			...
			if (i_14_ == -1) {
				ObjectDefinitions class432 = (((Class60) this).aClass433_585.getObjectDefinitions(
						((Class60) this).anInt601 * 1686561661));
				ObjectDefinitions class432_16_ = class432;
				if (class432.anIntArray5366 != null)
					class432 = (class432
							.method5777(
									(1596783995 * client.anInt8724 == 0 ? (Interface23) Class87.anInterface23_796
											: Class128.aClass148_6331),
									1802349433));
				if (class432 == null)
					return;
				...
				if (class432.method5779(934270378)) {
					if (bool
							&& ((Class60) this).aClass438_593
									.method5819((byte) -5)
							&& class432
									.method5773(((Class60) this).aClass438_593
											.method5823(2076230166), 1402053046))
						return;
					if (1181652947 * class432.anInt5365 != -72440277
							* ((Class60) this).anInt595)
					...
					if (class432.method5780(-1966445745))
						...
						i_12_ = 1;
				} else if (null != class432_16_
						&& class432_16_.method5779(934270378)) {
					if (bool
							&& ((Class60) this).aClass438_593
									.method5819((byte) -12)
							&& class432_16_
									.method5773(((Class60) this).aClass438_593
											.method5823(1572334487), 1867786247))
						return;
			...
			if (i_14_ == -1)
				...
				((Class60) this).aClass438_593.method5824(i_14_, 0, i_12_,
						bool_15_, (byte) 0);
	...
	void method707(GraphicsToolkit class_ra, int i) {
		try {
			if (null != ((Class60) this).aClass_na599) {
				Class217 class217 = (((Class60) this).aClass365_Sub1_587
						.method4337().aClass217_2599);
				client.aClass283_8716.method2675(-1611682495).method4047(
						((Class60) this).aClass_na599,
						((Class60) this).aByte588, (int) class217.aFloat2451,
						(int) class217.aFloat2454,
						((Class60) this).aBooleanArray596, 677085165);
				((Class60) this).aBooleanArray596 = null;
				((Class60) this).aClass_na599 = null;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ck.x(").append(')').toString());
		}
	}

	static final void method708(Class403 class403, int i) {
		try {
			((Class403) class403).anInt5239 -= -783761378;
			int i_17_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]);
			int i_18_ = (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 1]);
			if (i_18_ == -1)
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = -1;
			else
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = GraphicsToolkit.aClass256_5315
						.method2441(i_17_, 2082342727).method3431((char) i_18_,
								166344309);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ck.acw(").append(')').toString());
		}
	}

	public static void method709(Class502 class502, int i, int i_19_,
			Interface3 interface3, int i_20_) {
		try {
			Class403 class403 = Class211.method1950(407967339);
			((Class403) class403).anInterface3_5233 = interface3;
			SubIncommingPacket.method1925(class502, i, i_19_, class403, 536465062);
			((Class403) class403).anInterface3_5233 = null;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ck.u(").append(')').toString());
		}
	...
	static final void method711(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ck.qo(").append(')').toString());
		}
	}

	static final void method712(Class403 class403, short i) {
		try {
			int i_21_ = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]);
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class298_Sub32_Sub14.aClass477_9400
					.getItemDefinitions(i_21_).anInt5720) * 1764050979;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ck.aby(").append(')').toString());
		}
	}

	static final void method713(Class403 class403, byte i) {
		try {
			if (client.aString8804 != null)
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = -1801543887
						* Class489.anInt6071;
			else
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ck.wx(").append(')').toString());
		}
	}

	static final void method714(IComponentDefinition class105, Class119 class119,
			Class403 class403, byte i) {
		try {
			((Class403) class403).anInt5239 -= -1175642067;
			int i_22_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239]);
			short i_23_ = (short) (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 1]);
			short i_24_ = (short) (((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 2]);
			if (i_22_ >= 0 && i_22_ < 5) {
