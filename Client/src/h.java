...
public class h extends DrawableModel implements Interface25 {
	...
	public native void pa(int i, int i_11_, Class_xa class_xa,
			Class_xa class_xa_12_, int i_13_, int i_14_, int i_15_);
	...
	final void method4738(int i, int[] is, int i_16_, int i_17_, int i_18_,
			int i_19_, boolean bool) {
		J(((h) this).nativeid, i, is, i_16_, i_17_, i_18_, i_19_, bool);
	}

	public native void bc(int i);

	native void e(int i, int[] is, int i_20_, int i_21_, int i_22_,
			boolean bool, int i_23_, int[] is_24_);

	public native void bs(int i, int i_25_, Class_xa class_xa,
			Class_xa class_xa_26_, int i_27_, int i_28_, int i_29_);
	...
	native void fq(long l, int i, int[] is, int i_32_, int i_33_, int i_34_,
			int i_35_, boolean bool);

	public boolean method4787(int i, int i_36_, Class222 class222,
			boolean bool, int i_37_) {
		return ((h) this).aJa6674.method5571().method284(this, i, i_36_,
				class222, bool);
	}
	...
	native void fp(h var_h_44_, h var_h_45_, int i, boolean bool,
			boolean bool_46_);
	...
	native void U(ja var_ja, ba var_ba, int i, int i_52_, int[] is,
			int[] is_53_, int[] is_54_, int[] is_55_, short[] is_56_,
			int i_57_, short[] is_58_, short[] is_59_, short[] is_60_,
			byte[] is_61_, byte[] is_62_, byte[] is_63_, byte[] is_64_,
			short[] is_65_, short[] is_66_, int[] is_67_, byte i_68_,
			short[] is_69_, int i_70_, byte[] is_71_, short[] is_72_,
			short[] is_73_, short[] is_74_, int[] is_75_, int[] is_76_,
			int[] is_77_, byte[] is_78_, byte[] is_79_, int[] is_80_,
	...
	native void cl(int i, int[] is, int i_94_, int i_95_, int i_96_,
			boolean bool, int i_97_, int[] is_98_);
	...
	public void method4740(Class222 class222, Class302_Sub1 class302_sub1, int i) {
		if (class302_sub1 == null)
			...
			((h) this).aJa6674.method5571().method279(this, class222,
					ja.anIntArray6704, i);
	...
	public native void bg(int i, int i_107_, Class_xa class_xa,
			Class_xa class_xa_108_, int i_109_, int i_110_, int i_111_);

	public native int RA();

	public native void bp(int i, int i_112_, Class_xa class_xa,
			Class_xa class_xa_113_, int i_114_, int i_115_, int i_116_);
	...
	final void method4760(int i, int[] is, int i_119_, int i_120_, int i_121_,
	...
	native void co(int i, int[] is, int i_123_, int i_124_, int i_125_,
			boolean bool, int i_126_, int[] is_127_);

	native void J(long l, int i, int[] is, int i_128_, int i_129_, int i_130_,
	...
	h(ja var_ja, ba var_ba, Class64 class64, int i, int i_135_, int i_136_,
			int i_137_) {
		((h) this).aJa6674 = var_ja;
		((h) this).aBa6675 = var_ba;
		((h) this).aClass85Array6677 = class64.aClass85Array647;
		((h) this).aClass68Array6676 = class64.aClass68Array613;
		int i_138_ = (class64.aClass85Array647 == null ? 0
				: class64.aClass85Array647.length);
		int i_139_ = (class64.aClass68Array613 == null ? 0
				: class64.aClass68Array613.length);
		int i_140_ = 0;
		int[] is = new int[i_138_ * 3 + i_139_];
		for (int i_141_ = 0; i_141_ < i_138_; i_141_++) {
			is[i_140_++] = ((h) this).aClass85Array6677[i_141_].anInt773
					* -710317103;
		...
		for (int i_142_ = 0; i_142_ < i_139_; i_142_++)
			is[i_140_++] = ((h) this).aClass68Array6676[i_142_].anInt674
					* -180596249;
		int i_143_ = (class64.aClass84Array649 == null ? 0
				: class64.aClass84Array649.length);
		...
		for (int i_146_ = 0; i_146_ < i_143_; i_146_++) {
			...
			Class173 class173 = Class298.method2844(
					class84.anInt768 * 1834782277, -67897652);
		...
		U(((h) this).aJa6674, ((h) this).aBa6675, class64.anInt614,
				class64.anInt626, class64.anIntArray616, class64.anIntArray642,
				class64.anIntArray618, class64.anIntArray619,
				class64.aShortArray620, class64.anInt621,
				class64.aShortArray644, class64.aShortArray646,
				class64.aShortArray624, class64.aByteArray625,
				class64.aByteArray633, class64.aByteArray627,
				class64.aByteArray635, class64.aShortArray629,
				class64.aShortArray617, class64.anIntArray631,
				class64.aByte632, class64.aShortArray615, class64.anInt634,
				class64.aByteArray622, class64.aShortArray623,
				class64.aShortArray636, class64.aShortArray638,
				class64.anIntArray639, class64.anIntArray640,
				class64.anIntArray641, class64.aByteArray645,
				class64.aByteArray628, class64.anIntArray637,
				class64.anIntArray643, class64.anIntArray648, is, i_138_,
				i_139_, i, i_135_, i_136_, i_137_, is_144_);
	}

	public boolean method4746(int i, int i_148_, Class222 class222,
			boolean bool, int i_149_) {
		return ((h) this).aJa6674.method5571().method284(this, i, i_148_,
				class222, bool);
	}
	...
	final void method4761(int i, int[] is, int i_153_, int i_154_, int i_155_,
			int i_156_, boolean bool) {
	...
	native void fx(long l, int i, int[] is, int i_157_, int i_158_, int i_159_,
			int i_160_, boolean bool);
	...
	native void cj(int i, int[] is, int i_184_, int i_185_, int i_186_,
			boolean bool, int i_187_, int[] is_188_);

	native void fc(ja var_ja, ba var_ba, int i, int i_189_, int[] is,
			int[] is_190_, int[] is_191_, int[] is_192_, short[] is_193_,
			int i_194_, short[] is_195_, short[] is_196_, short[] is_197_,
			byte[] is_198_, byte[] is_199_, byte[] is_200_, byte[] is_201_,
			short[] is_202_, short[] is_203_, int[] is_204_, byte i_205_,
			short[] is_206_, int i_207_, byte[] is_208_, short[] is_209_,
			short[] is_210_, short[] is_211_, int[] is_212_, int[] is_213_,
			int[] is_214_, byte[] is_215_, byte[] is_216_, int[] is_217_,
			int[] is_218_, int[] is_219_, int[] is_220_, int i_221_,
			int i_222_, int i_223_, int i_224_, int i_225_, int i_226_,
			int[] is_227_);
	...
	public boolean method4763(int i, int i_231_, Class222 class222,
			boolean bool, int i_232_) {
		return ((h) this).aJa6674.method5571().method284(this, i, i_231_,
				class222, bool);
	}
