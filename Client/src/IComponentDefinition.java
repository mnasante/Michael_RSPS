...
public class IComponentDefinition {
	...
	void method1110(RsByteBuffer class298_sub53, int i) {
		try {
			...
			if (-1215239439 * anInt1144 == 5) {
				...
				anInt1251 = class298_sub53.readInt((byte) -62) * -1448553585;
				aBoolean1180 = class298_sub53.readUnsignedByte() == 1;
				aBoolean1181 = class298_sub53.readUnsignedByte() == 1;
				anInt1170 = class298_sub53.readInt((byte) -1) * -695431873;
				if (i_1_ >= 3)
			...
			if (6 == -1215239439 * anInt1144) {
				...
				if (bool) {
					...
					anInt1190 = class298_sub53.readUnsignedShort()
							* -801721775;
					anInt1262 = class298_sub53.readUnsignedShort() * 1590511671;
					anInt1192 = class298_sub53.readUnsignedShort()
							* -2064327287;
					anInt1284 = class298_sub53.readUnsignedShort()
							* -1066050969;
					...
					anInt1282 = class298_sub53.readShort(1594666911)
							* -1324973519;
					anInt1190 = class298_sub53.readUnsignedShort()
							* -801721775;
					anInt1262 = class298_sub53.readUnsignedShort() * 1590511671;
			...
			if (anInt1144 * -1215239439 == 4) {
				...
				anInt1170 = class298_sub53.readInt((byte) 30) * -695431873;
				anInt1223 = class298_sub53.readUnsignedByte() * 728904583;
				if (i_1_ >= 0)
			...
			if (i_6_ != 0) {
				...
				for (/**/; i_6_ != 0; i_6_ = class298_sub53
					...
					if (i_8_ != 0)
						aBoolean1220 = true;
					byte i_9_ = class298_sub53.readByte(-12558881);
					anIntArray1276[i_7_] = i_6_;
					aByteArray1185[i_7_] = i_8_;
					aByteArray1222[i_7_] = i_9_;
				}
			}
			aString1228 = class298_sub53.readString(506985626);
			...
			if (i_11_ > 0) {
				...
				for (int i_13_ = 0; i_13_ < i_11_; i_13_++)
					aStringArray1195[i_13_] = class298_sub53
							.readString(-1637502084);
			}
			if (i_12_ > 0) {
			...
			aString1230 = class298_sub53.readString(-1953229569);
			...
			aString1237 = class298_sub53.readString(-1171596112);
			int i_17_ = -1;
			...
			if (i_1_ >= 0) {
				anInt1272 = class298_sub53.readUnsignedShort() * -1122372539;
			...
			anObjectArray1244 = method1111(class298_sub53, 1852122968);
			anObjectArray1122 = method1111(class298_sub53, 747815110);
			...
			anObjectArray1245 = method1111(class298_sub53, 1910073926);
			...
			anIntArray1188 = method1118(class298_sub53, 1930385253);
	...
	Object[] method1111(RsByteBuffer class298_sub53, int i) {
		try {
			...
			for (int i_26_ = 0; i_26_ < i_25_; i_26_++) {
				...
				if (i_27_ == 0)
					objects[i_26_] = new Integer(class298_sub53
							.readInt((byte) 52));
				else if (i_27_ == 1)
	...
	public Class264 method1112(Class197 class197, Interface10 interface10, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eg.s(").append(')').toString());
		}
	}

	public Class505 method1113(Class197 class197, Interface10 interface10,
			byte i) {
		try {
	...
	public void method1114(GraphicsToolkit class_ra, DrawableModel drawableModel,
		...
		try {
			...
			if (aClass351_1218 != null)
				aClass351_1218.method4231(class_ra, (long) i, class85s,
						class68s, false);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eg.t(").append(')').toString());
		}
	}
	...
	public Class117 method1116(GraphicsToolkit class_ra, int i) {
		try {
			...
			Class89 class89 = Class89.method987(Class124.aClass243_1480,
		...
		try {
			if (i < 5) {
				if (((IComponentDefinition) this).aShortArray1204 == null) {
					((IComponentDefinition) this).aShortArray1204 = new short[5];
					((IComponentDefinition) this).aShortArray1234 = new short[5];
				}
				((IComponentDefinition) this).aShortArray1204[i] = i_44_;
				((IComponentDefinition) this).aShortArray1234[i] = i_45_;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eg.av(").append(')').toString());
		}
	}
	...
	public Class277 method1121(Class317 class317, Class131 class131, int i) {
		try {
			if (-1 == anInt1283 * 925824753)
				return null;
			long l = (((long) (1779368503 * anInt1304) & 0xffffL) << 48
					| ((long) (anInt1202 * -163313477) & 0xffffL) << 32
					| ((long) (anInt1176 * -1234146137) & 0xffffL) << 16 | (long) (anInt1283 * 925824753) & 0xffffL);
			Class277 class277 = (Class277) aClass348_1296.method4184(l);
			if (class277 == null) {
				class277 = class317.method3845(anInt1283 * 925824753,
						1779368503 * anInt1304, -163313477 * anInt1202,
						anInt1176 * -1234146137, class131, (byte) 89);
				aClass348_1296.method4194(class277, l);
			}
			return class277;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eg.h(").append(')').toString());
		}
	}
	...
	public DrawableModel method1124(GraphicsToolkit class_ra, int i, Class349 class349,
		...
		try {
			...
			if (1 == anInt1184 * 1548853569) {
				...
				if (((IComponentDefinition) this).aShortArray1118 != null) {
					for (int i_50_ = 0; i_50_ < ((IComponentDefinition) this).aShortArray1118.length; i_50_++) {
						l = l >>> 8
								^ ls[(int) ((l ^ (long) ((((IComponentDefinition) this).aShortArray1118[i_50_]) >> 8)) & 0xffL)];
						l = l >>> 8
								^ ls[(int) ((l ^ (long) (((IComponentDefinition) this).aShortArray1118[i_50_])) & 0xffL)];
						l = l >>> 8
								^ ls[(int) ((l ^ (long) ((((IComponentDefinition) this).aShortArray1203[i_50_]) >> 8)) & 0xffL)];
						l = l >>> 8
								^ ls[(int) ((l ^ (long) (((IComponentDefinition) this).aShortArray1203[i_50_])) & 0xffL)];
					}
					i |= 0x4000;
				}
				if (null != ((IComponentDefinition) this).aShortArray1204) {
					for (int i_51_ = 0; i_51_ < ((IComponentDefinition) this).aShortArray1204.length; i_51_++) {
						l = l >>> 8
								^ ls[(int) ((l ^ (long) ((((IComponentDefinition) this).aShortArray1204[i_51_]) >> 8)) & 0xffL)];
						l = l >>> 8
								^ ls[(int) ((l ^ (long) (((IComponentDefinition) this).aShortArray1204[i_51_])) & 0xffL)];
						l = l >>> 8
								^ ls[(int) ((l ^ (long) ((((IComponentDefinition) this).aShortArray1234[i_51_]) >> 8)) & 0xffL)];
						l = l >>> 8
								^ ls[(int) ((l ^ (long) (((IComponentDefinition) this).aShortArray1234[i_51_])) & 0xffL)];
					}
					i |= 0x8000;
				}
	...
	public void method1126(int i, short i_60_, short i_61_, int i_62_) {
		try {
			if (i < 5) {
				if (null == ((IComponentDefinition) this).aShortArray1118) {
					((IComponentDefinition) this).aShortArray1118 = new short[5];
					((IComponentDefinition) this).aShortArray1203 = new short[5];
				}
				((IComponentDefinition) this).aShortArray1118[i] = i_60_;
				((IComponentDefinition) this).aShortArray1203[i] = i_61_;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eg.ad(").append(')').toString());
		}
	}
	...
	public Class57 method1128(GraphicsToolkit class_ra, int i) {
		try {
			...
			aClass348_1135.method4185(class57, l, (class57.method623()
					* class57.method625() * 4), (byte) -114);
			return class57;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eg.n(").append(')').toString());
		}
	}
	...
	public static void method1129(int[] is, Object[] objects, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eg.u(").append(')').toString());
		}
	}

	static void method1130(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 1] = (Class316.aClass362_3318
					.method4307(
							(((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 1]),
							245040087).method4563(Class128.aClass148_6331,
					client.anIntArray8828, (byte) 76)) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eg.m(").append(')').toString());
		}
	}
	...
	static final void method1131(Class403 class403, short i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eg.im(").append(')').toString());
		}
	}

	static final void method1132(Class403 class403, int i) {
		try {
			int i_67_ = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]);
			Class298_Sub36 class298_sub36 = Class18.method359(
					OutcommingPacket.aClass198_2057,
					client.aClass25_8711.aClass449_330, (byte) 37);
			class298_sub36.aClass298_Sub53_Sub2_7396
					.writeShort(i_67_, 16711935);
			client.aClass25_8711.method390(class298_sub36, (byte) -67);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eg.su(").append(')').toString());
		}
	}
	...
	static final void method1133(Class403 class403, short i) {
		try {
			if (null != Class350.aClass298_Sub25_3757) {
				...
				((Class403) class403).aClass298_Sub25_5237 = Class350.aClass298_Sub25_3757;
			} else
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eg.xe(").append(')').toString());
		}
	}

	static final void method1134(Class403 class403, int i) {
		try {
			int i_68_ = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]);
			Class298_Sub37_Sub13 class298_sub37_sub13 = Class298_Sub7
					.method2864(142245824);
			if (null != class298_sub37_sub13) {
				boolean bool = class298_sub37_sub13.method3451(
						i_68_ >> 14 & 0x3fff, i_68_ & 0x3fff,
						Class388.anIntArray4156, -1054516511);
				if (bool) {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eg.aee(").append(')').toString());
		}
	}

	static final void method1135(Class365_Sub1 class365_sub1,
		...
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = bool ? 1
					: 0;
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_69_;
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_70_;
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_71_;
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_72_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eg.apj(").append(')').toString());
		}
	}
