...
public abstract class DrawableModel {
	...
	void method4730(int i, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_,
			int i_10_, float[] fs, int i_11_, float f, float f_12_,
			float f_13_, float[] fs_14_) {
		i -= i_7_;
		i_5_ -= i_8_;
		i_6_ -= i_9_;
		float f_15_ = (float) i * fs[0] + (float) i_5_ * fs[1] + (float) i_6_
				* fs[2];
		float f_16_ = (float) i * fs[3] + (float) i_5_ * fs[4] + (float) i_6_
				* fs[5];
		float f_17_ = (float) i * fs[6] + (float) i_5_ * fs[7] + (float) i_6_
				* fs[8];
		float f_18_;
		float f_19_;
		if (i_10_ == 0) {
	...
	float[] method4731(int i, int i_22_, int i_23_, int i_24_, float f,
		...
		if (f_34_ == 0.0F && f_28_ == 0.0F)
			...
			fs_27_[0] = fs[0] * fs_31_[0] + fs[1] * fs_31_[3] + fs[2]
					* fs_31_[6];
			fs_27_[1] = fs[0] * fs_31_[1] + fs[1] * fs_31_[4] + fs[2]
					* fs_31_[7];
			fs_27_[2] = fs[0] * fs_31_[2] + fs[1] * fs_31_[5] + fs[2]
					* fs_31_[8];
			fs_27_[3] = fs[3] * fs_31_[0] + fs[4] * fs_31_[3] + fs[5]
					* fs_31_[6];
			fs_27_[4] = fs[3] * fs_31_[1] + fs[4] * fs_31_[4] + fs[5]
					* fs_31_[7];
			fs_27_[5] = fs[3] * fs_31_[2] + fs[4] * fs_31_[5] + fs[5]
					* fs_31_[8];
			fs_27_[6] = fs[6] * fs_31_[0] + fs[7] * fs_31_[3] + fs[8]
					* fs_31_[6];
			fs_27_[7] = fs[6] * fs_31_[1] + fs[7] * fs_31_[4] + fs[8]
					* fs_31_[7];
			fs_27_[8] = fs[6] * fs_31_[2] + fs[7] * fs_31_[5] + fs[8]
					* fs_31_[8];
		}
		fs_27_[0] *= f;
		fs_27_[1] *= f;
	...
	void method4732(Class_xa class_xa, int i, int i_41_, int i_42_, int i_43_,
		...
		if (i_44_ != 0) {
			int i_65_ = ((int) (Math.atan2((double) (i_61_ - i_62_),
					(double) i_44_) * 2607.5945876176133) & 0x3fff);
			if (i_65_ != 0) {
				if (i_45_ != 0) {
					if (i_65_ > 8192) {
		...
		if (i_43_ != 0) {
			int i_67_ = ((int) (Math.atan2((double) (i_64_ - i_63_),
					(double) i_43_) * 2607.5945876176133) & 0x3fff);
			if (i_67_ != 0) {
				if (i_46_ != 0) {
					if (i_67_ > 8192) {
	...
	public final void method4735(Class298_Sub37_Sub4 class298_sub37_sub4,
			int i, Class298_Sub37_Sub4 class298_sub37_sub4_70_, int i_71_,
		...
		if (i != -1) {
			...
			if (!ea())
				...
				method4767(class298_sub15, class96, class96_75_, i_72_, i_73_,
						i_74_, null, false, bool, 65535, null);
				ka();
				method4734();
			}
		}
	...
	public abstract void pa(int i, int i_76_, Class_xa class_xa,
			Class_xa class_xa_77_, int i_78_, int i_79_, int i_80_);

	public final void method4736(Class298_Sub37_Sub4 class298_sub37_sub4,
			int i, Class298_Sub37_Sub4 class298_sub37_sub4_81_, int i_82_,
			int i_83_, int i_84_, Class298_Sub37_Sub4 class298_sub37_sub4_85_,
			int i_86_, Class298_Sub37_Sub4 class298_sub37_sub4_87_, int i_88_,
			int i_89_, int i_90_, boolean[] bools, boolean bool) {
		if (i != -1) {
			if (bools == null || i_86_ == -1)
				method4735(class298_sub37_sub4, i, class298_sub37_sub4_81_,
						i_82_, i_83_, i_84_, 0, bool);
			else {
				method4733();
				if (!ea())
					method4734();
					...
					method4767(class298_sub15, class96, class96_91_, i_83_,
							i_84_, 0, bools, false, bool, 65535, null);
					...
					method4767(((Class96) class96_92_).aClass298_Sub15_931,
							class96_92_, class96_93_, i_89_, i_90_, 0, bools,
							true, bool, 65535, null);
					ka();
					method4734();
				}
			}
				...
				for (int i_94_ = 0; i_94_ < ((Class96) class96).anInt925; i_94_++) {
					...
					if (((Class298_Sub15) class298_sub15).aBooleanArray7275[i_95_]) {
						if (((Class96) class96).aShortArray937[i_94_] != -1)
							w(0, 0, 0, 0);
						w(
								(((Class298_Sub15) class298_sub15).anIntArray7278[i_95_]),
								((Class96) class96).aShortArray934[i_94_],
								((Class96) class96).aShortArray930[i_94_],
								((Class96) class96).aShortArray936[i_94_]);
					}
				}
				ka();
				method4734();
	...
	abstract void method4738(int i, int[] is, int i_96_, int i_97_, int i_98_,
			int i_99_, boolean bool);

	public abstract void method4739(Class222 class222,
			Class302_Sub1 class302_sub1, int i);

	abstract void cl(int i, int[] is, int i_100_, int i_101_, int i_102_,
			boolean bool, int i_103_, int[] is_104_);

	abstract void e(int i, int[] is, int i_105_, int i_106_, int i_107_,
			boolean bool, int i_108_, int[] is_109_);

	abstract void w(int i, int i_110_, int i_111_, int i_112_);

	public abstract void method4740(Class222 class222,
			Class302_Sub1 class302_sub1, int i);
	...
	void method4744(int i, int i_123_, int i_124_, int i_125_, int i_126_,
			int i_127_, float[] fs, float f, int i_128_, float f_129_,
			float[] fs_130_) {
		i -= i_125_;
		i_123_ -= i_126_;
		i_124_ -= i_127_;
		float f_131_ = ((float) i * fs[0] + (float) i_123_ * fs[1] + (float) i_124_
				* fs[2]);
		float f_132_ = ((float) i * fs[3] + (float) i_123_ * fs[4] + (float) i_124_
				* fs[5]);
		float f_133_ = ((float) i * fs[6] + (float) i_123_ * fs[7] + (float) i_124_
				* fs[8]);
	...
	public abstract void bg(int i, int i_156_, Class_xa class_xa,
			Class_xa class_xa_157_, int i_158_, int i_159_, int i_160_);

	public abstract void bs(int i, int i_161_, Class_xa class_xa,
			Class_xa class_xa_162_, int i_163_, int i_164_, int i_165_);

	public abstract void bp(int i, int i_166_, Class_xa class_xa,
			Class_xa class_xa_167_, int i_168_, int i_169_, int i_170_);
	...
	public abstract void method4759(Class222 class222,
			Class302_Sub1 class302_sub1, int i);
	...
	abstract void method4760(int i, int[] is, int i_171_, int i_172_,
			int i_173_, int i_174_, boolean bool);

	abstract void method4761(int i, int[] is, int i_175_, int i_176_,
			int i_177_, int i_178_, boolean bool);

	abstract void co(int i, int[] is, int i_179_, int i_180_, int i_181_,
			boolean bool, int i_182_, int[] is_183_);
	...
	public abstract boolean method4763(int i, int i_187_, Class222 class222,
	...
	public final void method4765(Class298_Sub37_Sub4 class298_sub37_sub4,
			int i, Class298_Sub37_Sub4 class298_sub37_sub4_191_, int i_192_,
			int i_193_, int i_194_, int i_195_, int i_196_, boolean bool,
			int[] is) {
		if (i != -1) {
			method4733();
			if (!ea())
				...
				method4767(class298_sub15, class96, class96_197_, i_193_,
						i_194_, i_195_, null, false, bool, i_196_, is);
				ka();
				method4734();
			}
		}
	...
	void method4766(int i, int[] is, int i_198_, int i_199_, int i_200_,
			int i_201_, boolean bool, int i_202_, int[] is_203_) {
		if (i_201_ == 1) {
			if (i == 0 || i == 1) {
				int i_204_ = -i_198_;
				i_198_ = i_200_;
	...
	void method4767(Class298_Sub15 class298_sub15, Class96 class96,
			Class96 class96_210_, int i, int i_211_, int i_212_,
			boolean[] bools, boolean bool, boolean bool_213_, int i_214_,
			int[] is) {
		if (class96_210_ == null || i == 0) {
			for (int i_215_ = 0; i_215_ < ((Class96) class96).anInt925; i_215_++) {
				...
				if (bools == null
						|| bools[i_216_] == bool
						|| (((Class298_Sub15) class298_sub15).anIntArray7278[i_216_]) == 0) {
					short i_217_ = ((Class96) class96).aShortArray937[i_215_];
					if (i_217_ != -1)
						method4766(
								0,
								(((Class298_Sub15) class298_sub15).anIntArrayArray7279[i_217_]),
								0,
								0,
								0,
								i_212_,
								bool_213_,
								i_214_
										& (((Class298_Sub15) class298_sub15).anIntArray7280[i_217_]),
								is);
					method4766(
							(((Class298_Sub15) class298_sub15).anIntArray7278[i_216_]),
							(((Class298_Sub15) class298_sub15).anIntArrayArray7279[i_216_]),
							((Class96) class96).aShortArray934[i_215_],
							((Class96) class96).aShortArray930[i_215_],
							((Class96) class96).aShortArray936[i_215_],
							i_212_,
							bool_213_,
							i_214_
									& (((Class298_Sub15) class298_sub15).anIntArray7280[i_216_]),
							is);
				}
			}
		} else {
			...
			for (int i_220_ = 0; (i_220_ < ((Class298_Sub15) class298_sub15).anInt7268 * 92429039); i_220_++) {
				...
				if (i_218_ < ((Class96) class96).anInt925
						&& ((Class96) class96).aShortArray933[i_218_] == i_220_)
					bool_221_ = true;
				boolean bool_222_ = false;
				if (i_219_ < ((Class96) class96_210_).anInt925
						&& (((Class96) class96_210_).aShortArray933[i_219_] == i_220_))
					bool_222_ = true;
				if (bool_221_ || bool_222_) {
					if (bools != null
							&& bools[i_220_] != bool
							&& (((Class298_Sub15) class298_sub15).anIntArray7278[i_220_]) != 0) {
						if (bool_221_)
							i_218_++;
						if (bool_222_)
							i_219_++;
						...
						if (i_228_ != -1)
							method4766(
									0,
									(((Class298_Sub15) class298_sub15).anIntArrayArray7279[i_228_]),
									0,
									0,
									0,
									i_212_,
									bool_213_,
									(i_214_ & (((Class298_Sub15) class298_sub15).anIntArray7280[i_228_])),
									is);
						else if (i_233_ != -1)
							method4766(
									0,
									(((Class298_Sub15) class298_sub15).anIntArrayArray7279[i_233_]),
									0,
									0,
									0,
									i_212_,
									bool_213_,
									(i_214_ & (((Class298_Sub15) class298_sub15).anIntArray7280[i_233_])),
									is);
						method4766(
								i_224_,
								(((Class298_Sub15) class298_sub15).anIntArrayArray7279[i_220_]),
								i_235_,
								i_236_,
								i_237_,
								i_212_,
								bool_213_,
								i_214_
										& (((Class298_Sub15) class298_sub15).anIntArray7280[i_220_]),
								is);
					}
				}
			}
	...
	void method4780(int i, int i_259_, int i_260_, int i_261_, int i_262_,
			int i_263_, float[] fs, int i_264_, float f, float[] fs_265_) {
		i -= i_261_;
		i_259_ -= i_262_;
		i_260_ -= i_263_;
		float f_266_ = ((float) i * fs[0] + (float) i_259_ * fs[1] + (float) i_260_
				* fs[2]);
		float f_267_ = ((float) i * fs[3] + (float) i_259_ * fs[4] + (float) i_260_
				* fs[5]);
		float f_268_ = ((float) i * fs[6] + (float) i_259_ * fs[7] + (float) i_260_
				* fs[8]);
		float f_269_ = (float) Math.sqrt((double) (f_266_ * f_266_ + f_267_
				* f_267_ + f_268_ * f_268_));
	...
	Class76 method4785(Class64 class64, int[] is, int i) {
		int[] is_276_ = null;
		int[] is_277_ = null;
		int[] is_278_ = null;
		float[][] fs = null;
		if (class64.aByteArray635 != null) {
			...
			for (int i_295_ = 0; i_295_ < i_279_; i_295_++) {
				...
				if (i_296_ > 0) {
					...
					fs[i_295_] = method4731(class64.aShortArray623[i_295_],
							class64.aShortArray636[i_295_],
							class64.aShortArray638[i_295_],
							class64.aByteArray645[i_295_] & 0xff, f, f_297_,
							f_298_);
				}
			}
		}
	...
	public abstract boolean method4787(int i, int i_300_, Class222 class222,
			boolean bool, int i_301_);
	...
	abstract void cj(int i, int[] is, int i_302_, int i_303_, int i_304_,
			boolean bool, int i_305_, int[] is_306_);
}
