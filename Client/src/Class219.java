...
public class Class219 implements Runnable {
	...
	public Class227 method2034(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jf.r(").append(')').toString());
		}
	}

	synchronized boolean method2035(int i) {
		try {
			return (((Class219) this).anInterface12_2466
					.method153(((Class219) this).aLong2468 * 6015775630087136145L));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jf.b(").append(')').toString());
		}
	}
	...
	synchronized void method2036(Interface12 interface12, int i) {
		try {
			...
			((Class219) this).aLong2468 = Class122.method1319((byte) 1)
					* -5051392830202741391L;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jf.p(").append(')').toString());
		}
	}
	...
	public int method2041(byte i) {
		try {
			...
			if (((Class227) ((Class219) this).aClass227_2465).aBoolean2550
					&& (-1457416349 * ((Class219) this).anInt2472 < -1620354451
							* ((Class227) (((Class219) this).aClass227_2465)).anInt2552))
	...
	public void run() {
		try {
				...
				synchronized (this) {
					try {
						...
						if (((Class219) this).anInterface12_2466 instanceof Class224)
							((Class219) this).anInterface12_2466.method160(
									((Class219) this).aBoolean2473, 2139338781);
						else {
							long l_1_ = Class122.method1319((byte) 1);
							if (Class373.aClass_ra4071 != null
									&& null != ((Class219) this).anInterface12_2467
									&& ((Class219) this).anInterface12_2467
											.method151(73548607) != 0
									&& ((6015775630087136145L * ((Class219) this).aLong2468) >= l_1_
											- (long) (((Class219) this).anInterface12_2467
													.method151(-462627527)))) {
								int i = (int) ((l_1_ - (6015775630087136145L * (((Class219) this).aLong2468))) * 255L / (long) (((Class219) this).anInterface12_2467
										.method151(-362403732)));
								int i_2_ = 255 - i;
								i = i << 24 | 0xffffff;
								...
								Class57 class57 = (Class373.aClass_ra4071
										.method5046(
												-2110394505
														* Class462.anInt5683,
												(-1111710645 * Class298_Sub40_Sub9.anInt9716),
												true, -34894995));
								Class52_Sub1 class52_sub1 = Class373.aClass_ra4071
										.method5094();
								class52_sub1.method563(0, class57.method627());
								Class373.aClass_ra4071.method5143(class52_sub1,
										(byte) 28);
								((Class219) this).anInterface12_2467.method160(
										true, 2128455067);
								Class373.aClass_ra4071.method5005(class52_sub1,
										(byte) 8);
								...
								((Class219) this).anInterface12_2466
										.method160(
												(((Class219) this).aBoolean2473 || (Class373.aClass_ra4071 != null && Class373.aClass_ra4071
														.method5074())),
												2145176958);
							}
							try {
								if (null != Class373.aClass_ra4071
										&& !(((Class219) this).anInterface12_2466 instanceof Class224))
									Class373.aClass_ra4071
											.method4988((byte) 101);
							} catch (Exception_Sub1 exception_sub1) {
								IPAddress.method6062(new StringBuilder().append(
										exception_sub1.getMessage()).append(
										Class385.aClient4141
												.method2761((byte) 1))
						...
						if (null != Class373.aClass_ra4071
								&& !(((Class219) this).anInterface12_2466 instanceof Class224)
								&& ((((Class219) this).aClass227_2465.anInt2548 * -861845079) < (-861845079 * Class227.aClass227_2545.anInt2548)))
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jf.run(").append(')').toString());
		}
	}

	synchronized void method2043(long l, String string, int i,
			Class227 class227, int i_4_) {
		try {
