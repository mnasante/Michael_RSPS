...
public class a implements Interface25 {
	...
	native void i(long l, long l_0_, int i, int i_1_, int i_2_, int i_3_,
			int i_4_, int i_5_, int i_6_, boolean[][] bools);

	native void bv(long l, long l_7_, int i, int i_8_, int i_9_, int i_10_,
			int i_11_, int i_12_, int i_13_, boolean[][] bools);
	...
	void method278(GraphicsToolkit class_ra, int[] is, int[] is_19_, int[] is_20_,
			short[] is_21_, int i) {
		b(((a) this).nativeid, class_ra, is, is_19_, is_20_, is_21_, i);
	}

	native void b(long l, GraphicsToolkit class_ra, int[] is, int[] is_22_,
			int[] is_23_, short[] is_24_, int i);
	...
	void method282(Class_xa class_xa, int i, int i_34_, int i_35_, int i_36_,
			int i_37_, int i_38_, int i_39_, boolean[][] bools) {
		i(((a) this).nativeid, ((i) (i) class_xa).nativeid, i, i_34_, i_35_,
				i_36_, i_37_, i_38_, i_39_, bools);
	}

	native void K(long l, GraphicsToolkit class_ra, int i, int i_40_, int i_41_,
	...
	native void ao(long l, GraphicsToolkit class_ra, int[] is, int[] is_50_,
			int[] is_51_, short[] is_52_, int i);

	native void ad(long l, GraphicsToolkit class_ra, int[] is, int[] is_53_,
			int[] is_54_, short[] is_55_, int i);

	native void av(long l, GraphicsToolkit class_ra, int[] is, int[] is_56_,
			int[] is_57_, short[] is_58_, int i);

	native void at(long l, GraphicsToolkit class_ra, int[] is, int[] is_59_,
			int[] is_60_, short[] is_61_, int i);

	native void ah(long l, GraphicsToolkit class_ra, int[] is, int[] is_62_,
			int[] is_63_, short[] is_64_, int i);

	native void bp(long l, long l_65_, int i, int i_66_, int i_67_, int i_68_,
			int i_69_, int i_70_, int i_71_, boolean[][] bools);

	native void ap(long l, GraphicsToolkit class_ra, int i, int i_72_, int i_73_,
	...
	a(ja var_ja, int i, int i_78_) {
		...
		((a) this).aClass233_6673 = new Class233();
		ha(((a) this).nativeid, var_ja, i, i_78_);
	}

	native void ab(long l, long l_80_, long l_81_, int i, int i_82_, int i_83_,
			boolean bool);
	...
	native void as(long l, GraphicsToolkit class_ra, int i, int i_96_, int i_97_,
			int i_98_, int i_99_, int i_100_, int i_101_);
	...
	native boolean bf(long l, long l_104_, int i, int i_105_, float[] fs,
			boolean bool);

	native boolean bd(long l, long l_106_, int i, int i_107_, float[] fs,
			boolean bool);

	native void R(long l, boolean bool);

	void method286(GraphicsToolkit class_ra, int i, int i_108_, int i_109_,
			int i_110_, int i_111_, int i_112_, int i_113_) {
		K(((a) this).nativeid, class_ra, i, i_108_, i_109_, i_110_, i_111_,
				i_112_, i_113_);
	}
	...
	native void bh(long l, long l_114_, int i, int i_115_, int i_116_,
			int i_117_, int i_118_, int i_119_, int i_120_, boolean[][] bools);
}
