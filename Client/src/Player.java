...
public class Player extends Entity {
	...
	public String aString10195;
	public boolean aBoolean10196;
	String aString10197;
	...
	public final void sendAppearence(RsByteBuffer stream, byte i) {
		try {
			...
			aByte10220 = (byte) (flag & 0x1);
			boolean bool = aBoolean10196;
			aBoolean10196 = 0 != (flag & 0x2);
			...
			class217.method2006();
			if (bool_3_)
				((Player) this).aString10199 = stream
						.readJagString(681479919);
			else
				((Player) this).aString10199 = null;
			if (bool_4_)
				((Player) this).aString10197 = stream
						.readJagString(681479919);
			else
				((Player) this).aString10197 = null;
			...
			if (Class242.aClass401_2708 == Class401.aClass401_6557
					&& 1806357379 * client.playerRights >= 2)
				hidden = false;
			int i_5_ = -1;
			anInt10208 = 0;
				...
				if (1 != Class82_Sub18.aClass405_6892.anIntArray5267[i_6_]) {
					...
					if (0 == i_7_)
						...
						if (i_9_ >= 32768) {
							...
							class468s[i_6_] = Class298_Sub32_Sub14.aClass477_9400
									.getItemDefinitions(i_9_);
							int i_10_ = class468s[i_6_].anInt5700 * 1832088845;
							if (0 != i_10_)
			...
			if (-1 == i_5_) {
				...
				for (int i_13_ = 0; (i_13_ < Class82_Sub18.aClass405_6892.anIntArray5267.length); i_13_++) {
					if (0 != (Class82_Sub18.aClass405_6892.anIntArray5267[i_13_])) {
						...
						if ((i_11_ & 1 << i_12_) != 0)
							class464s[i_13_] = Class401
									.method4937(class468s[i_13_],
											stream, (byte) 15);
						i_12_++;
					}
				}
			...
			for (int i_15_ = 0; i_15_ < 10; i_15_++) {
				...
				if (Class22.aShortArrayArrayArray278.length < 1
						|| i_16_ < 0
						|| (i_16_ >= Class22.aShortArrayArrayArray278[i_15_][0].length))
					i_16_ = 0;
				is_14_[i_15_] = i_16_;
			}
			((Player) this).anInt10216 = stream
					.readUnsignedShort() * 148972467;
			aString10200 = stream.readString(-594796753);
			aString10195 = aString10200;
			if (this == Class287.myPlayer)
				RuntimeException_Sub2.aString6305 = aString10200;
			anInt10206 = stream.readUnsignedByte() * 1202458455;
			if (bool_1_) {
				anInt10205 = stream.readUnsignedShort()
						* -1214139113;
				...
				anInt10204 = stream.readUnsignedByte()
						* -1031683529;
			...
			if (0 != 780357347 * anInt10214) {
				...
				anInt10212 = stream.readUnsignedShort()
						* -1578398049;
				anInt10215 = stream.readUnsignedByte()
						* -895284893;
				if (aBoolean10196 != bool || anInt10214 * 780357347 != i_17_
						|| 1728220219 * anInt10194 != i_18_
						|| -1304250511 * anInt10210 != i_19_
						|| i_20_ != anInt10211 * 1899133595
						|| i_21_ != -978842273 * anInt10212
						|| anInt10215 * 933675083 != i_22_)
			...
			aClass366_10209.method4546(method4432(-1515602233), is, class464s,
					is_14_, 1 == aByte10220, i_5_, 775068819);
			if (i_23_ != i_5_) {
	...
	Class335 method4394(GraphicsToolkit class_ra, int i) {
		try {
			if (null == aClass366_10209
					|| !method4469(class_ra, 2048, (byte) 12))
				return null;
			Class222 class222 = class_ra.method5178();
			Class222 class222_26_ = method4347();
			...
			class222
					.method2064(
							0.0F,
							(float) (-20 - (-661498661 * ((Player) this).anInt10122)),
							0.0F);
			Class335 class335 = null;
			((Player) this).aBoolean10129 = false;
			if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub18_7561
					.method5693(-591782935) == 1) {
				Class350 class350 = method4426(-97958061);
				if (class350.aBoolean3756
						&& (164936249 * aClass366_10209.anInt3974 == -1 || (Class15.aClass507_224
								.method6269(
										aClass366_10209.anInt3974 * 164936249,
										-465726953).aBoolean6165))) {
					Class438 class438 = ((aClass438_10078
							.method5819((byte) -70) && aClass438_10078
				...
				for (int i_30_ = client.aClass19Array8869.length - 1; i_30_ >= 0; i_30_--) {
					...
					if (null != class19 && class19.anInt263 * 408071539 != -1) {
						...
						if (10 == class19.anInt266 * 958933333
								&& -841622081 * class19.anInt256 >= 0
								&& (-841622081 * class19.anInt256 < (client.aClass365_Sub1_Sub1_Sub2_Sub2Array8805).length)) {
							Player class365_sub1_sub1_sub2_sub2_35_ = (client.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[class19.anInt256
									* -841622081]);
							if (class365_sub1_sub1_sub2_sub2_35_ != null) {
								Class217 class217 = (Class217
										.method2011(
												class365_sub1_sub1_sub2_sub2_35_
														.method4337().aClass217_2599,
												Class287.myPlayer
														.method4337().aClass217_2599));
				...
				if (aDrawableModelArray10082[i_38_] != null)
					aDrawableModelArray10082[i_38_]
							.method4739(
									...
									(this == Class287.myPlayer ? 1
											: 0));
			}
			if (null != ((Player) this).aClass351_10067) {
				Class69 class69 = ((Player) this).aClass351_10067
						.method4229();
			...
			if (l_42_ >= 262144L && l_42_ <= l_41_) {
				...
				DrawableModel drawableModel_44_ = (Class219
						.method2044(
								class_ra,
								i_43_,
								(((Player) this).anInt10097 * -155466425),
	...
	boolean method4469(GraphicsToolkit class_ra, int i, byte i_45_) {
		try {
			...
			Class438 class438 = ((aClass438_10078.method5819((byte) -54) && !aClass438_10078
					.method5826(-65534)) ? aClass438_10078 : null);
			Class438 class438_47_ = ((aClass438_10077.method5819((byte) -28)
					&& !aBoolean10207 && (!aBoolean10094 || class438 == null)) ? aClass438_10077
					: null);
			int i_48_ = class350.anInt3735 * 250567115;
			int i_49_ = 1110265995 * class350.anInt3736;
			if (i_48_ != 0 || 0 != i_49_
					|| class350.anInt3748 * 1185872679 != 0
					|| 0 != -330229359 * class350.anInt3751)
				i |= 0x7;
			int i_50_ = aClass386_10084.method4719((byte) 0);
			boolean bool = (0 != aByte10130
			...
			DrawableModel drawableModel = (aDrawableModelArray10082[0] = (aClass366_10209
					.method4545(class_ra, i, Class94.aClass349_913,
							...
							Class298_Sub32_Sub14.aClass477_9400,
							Class501.aClass395_6122, Class128.aClass148_6331,
							class438, class438_47_,
							aClass438_Sub2_Sub1Array10112, anIntArray10085,
							i_50_, true, Class82_Sub18.aClass405_6892,
							1284357526)));
	...
	public String method4470(boolean bool, int i) {
		try {
			String string = "";
			if (((Player) this).aString10199 != null)
				string = ((Player) this).aString10199;
			if (bool)
				string = new StringBuilder().append(string)
						.append(aString10200).toString();
			else
				string = new StringBuilder().append(string)
						.append(aString10195).toString();
			if (null != ((Player) this).aString10197)
				string = new StringBuilder().append(string).append(
						((Player) this).aString10197)
						.toString();
			return string;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akm.gk(").append(')').toString());
		}
	}
	...
	public final void method4471(int i, int i_53_, byte i_54_, int i_55_) {
		try {
			...
			for (int i_56_ = 0; i_56_ < currentGraphics.length; i_56_++) {
				if (-1 != currentGraphics[i_56_].id * -967533709) {
					Class398 class398 = (Class158_Sub1.aClass389_8568
							.method4857(-967533709
									* currentGraphics[i_56_].id,
									-1891757366));
					if (class398.aBoolean5215
							&& 1505778629 * class398.anInt5205 != -1
			...
			anInt10221 = 1530078181;
			if (i < 0 || i >= client.aClass283_8716.method2629(-1987519551)
					|| i_53_ < 0
					|| i_53_ >= client.aClass283_8716.method2630(1479162339))
				method4472(i, i_53_, -2049230528);
			else if (scenePositionXQueue[0] < 0
					|| (scenePositionXQueue[0] >= client.aClass283_8716
							.method2629(-1906686754))
					|| scenePositionYQueue[0] < 0
					|| (scenePositionYQueue[0] >= client.aClass283_8716
							.method2630(-964068282)))
				method4472(i, i_53_, -2022261810);
			else {
				if (Class282.aClass282_6541.aByte6542 == i_54_)
					Class303.method3737(this, i, i_53_,
							Class282.aClass282_6541.aByte6542, (byte) 98);
				method4473(i, i_53_, i_54_, (byte) 94);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akm.gy(").append(')').toString());
		}
	}
	...
	public void method4472(int i, int i_57_, int i_58_) {
		try {
			...
			class217.method2006();
			if (this == Class287.myPlayer)
				client.aClass283_8716.method2640((byte) 35).method4324(
						-1515011512);
			if (null != ((Player) this).aClass351_10067)
				((Player) this).aClass351_10067
						.method4220();
	...
	public int getSize() {
		try {
			if (null != aClass366_10209
					&& -1 != aClass366_10209.anInt3974 * 164936249)
				return ((Class15.aClass507_224.method6269(
						164936249 * aClass366_10209.anInt3974, 1333509149).anInt6187) * -2095128707);
			return super.getSize();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akm.q(").append(')').toString());
		}
	}
	...
	final boolean method4366(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akm.bw(").append(')').toString());
		}
	}

	final void method4355(GraphicsToolkit class_ra, Class365_Sub1 class365_sub1,
			int i, int i_68_, int i_69_, boolean bool, int i_70_) {
		try {
			throw new IllegalStateException();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akm.bk(").append(')').toString());
		}
	}
	...
	Class335 method4370(GraphicsToolkit class_ra) {
		if (null == aClass366_10209 || !method4469(class_ra, 2048, (byte) 38))
			return null;
		Class222 class222 = class_ra.method5178();
		Class222 class222_74_ = method4347();
		Class235 class235 = method4337();
		...
		((Player) this).aBoolean10129 = false;
		if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub18_7561
				.method5693(-1650118723) == 1) {
			Class350 class350 = method4426(-231420914);
			if (class350.aBoolean3756
					&& (164936249 * aClass366_10209.anInt3974 == -1 || (Class15.aClass507_224
							.method6269(aClass366_10209.anInt3974 * 164936249,
									-824172978).aBoolean6165))) {
				Class438 class438 = ((aClass438_10078.method5819((byte) -76) && aClass438_10078
						.method5826(-65534)) ? aClass438_10078 : null);
			...
			for (int i_77_ = client.aClass19Array8869.length - 1; i_77_ >= 0; i_77_--) {
				...
				if (null != class19 && class19.anInt263 * 408071539 != -1) {
					...
					if (10 == class19.anInt266 * 958933333
							&& -841622081 * class19.anInt256 >= 0
							&& (-841622081 * class19.anInt256 < (client.aClass365_Sub1_Sub1_Sub2_Sub2Array8805).length)) {
						Player class365_sub1_sub1_sub2_sub2_82_ = (client.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[class19.anInt256
								* -841622081]);
						if (class365_sub1_sub1_sub2_sub2_82_ != null) {
							Class217 class217 = (Class217.method2011(
									class365_sub1_sub1_sub2_sub2_82_
											.method4337().aClass217_2599,
									Class287.myPlayer
											.method4337().aClass217_2599));
	...
	void method4371(GraphicsToolkit class_ra) {
		if (null != aClass366_10209
				&& (((Player) this).aBoolean10128 || method4469(
						class_ra, 0, (byte) 83))) {
			Class222 class222 = class_ra.method5178();
		...
		try {
			if (null != ((Player) this).aClass62_10118) {
				if (null == ((Class62) (((Player) this).aClass62_10118)).aString608)
					return null;
				if (0 == client.anInt8837 * -1168328513
						|| -1168328513 * client.anInt8837 == 3
						|| (client.anInt8837 * -1168328513 == 1 && Class494
								.method6192(aString10195, -1511804216)))
					return (((Player) this).aClass62_10118);
			}
			return null;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akm.bl(").append(')').toString());
		}
	}
	...
	boolean method4352(GraphicsToolkit class_ra, int i, int i_87_) {
		if (null == aClass366_10209
				|| !method4469(class_ra, 131072, (byte) -89))
			return false;
		Class222 class222 = method4347();
		boolean bool = false;
	...
	final void method4375(GraphicsToolkit class_ra, Class365_Sub1 class365_sub1,
			int i, int i_90_, int i_91_, boolean bool) {
		throw new IllegalStateException();
	}
	...
	public int method4476() {
		if (null != aClass366_10209
				&& -1 != aClass366_10209.anInt3974 * 164936249)
			return ((Class15.aClass507_224.method6269(
					164936249 * aClass366_10209.anInt3974, 1538306428).anInt6187) * -2095128707);
		return super.getSize();
	}
	...
	boolean method4350(GraphicsToolkit class_ra, int i, int i_92_, byte i_93_) {
		try {
			if (null == aClass366_10209
					|| !method4469(class_ra, 131072, (byte) 31))
				return false;
			Class222 class222 = method4347();
			boolean bool = false;
	...
	public Class62 method4443() {
		if (null != ((Player) this).aClass62_10118) {
			...
			if (0 == client.anInt8837 * -1168328513
					|| -1168328513 * client.anInt8837 == 3
					|| (client.anInt8837 * -1168328513 == 1 && Class494
							.method6192(aString10195, -1800657283)))
				return ((Player) this).aClass62_10118;
		}
		return null;
	}
	...
	public int method4478() {
		if (null != aClass366_10209
				&& -1 != aClass366_10209.anInt3974 * 164936249)
			return ((Class15.aClass507_224.method6269(
					164936249 * aClass366_10209.anInt3974, 662796254).anInt6187) * -2095128707);
		return super.getSize();
	}

	boolean method4372(GraphicsToolkit class_ra, int i, int i_97_) {
		if (null == aClass366_10209
				|| !method4469(class_ra, 131072, (byte) -34))
			return false;
		Class222 class222 = method4347();
		boolean bool = false;
