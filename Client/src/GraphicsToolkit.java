...
public abstract class GraphicsToolkit {
	...
	public abstract Class66 method4986(Class66 class66, Class66 class66_0_,
			float f, Class66 class66_1_);
	...
	public abstract void N(int i, int i_10_, int i_11_, int i_12_, int i_13_,
			int i_14_, byte[] is, int i_15_, int i_16_);

	public abstract boolean method4998();

	public abstract void method4999(int i, int i_17_, int i_18_, int i_19_,
	...
	public final void method5002(Canvas canvas, int i) {
		try {
			if (aHashtable5313.containsKey(canvas)) {
				Class52_Sub2 class52_sub2 = (Class52_Sub2) aHashtable5313
						.get(canvas);
	...
	public final void method5003(Canvas canvas, byte i) {
		try {
			...
			if (929186669 * ((GraphicsToolkit) this).anInt5310 > 0
	...
	public final void method5005(Class52_Sub1 class52_sub1, byte i) {
		try {
			if (929186669 * ((GraphicsToolkit) this).anInt5310 < 0
					|| (((GraphicsToolkit) this).aClass52_Sub1Array5304[((GraphicsToolkit) this).anInt5310 * 929186669]) != class52_sub1)
				throw new RuntimeException();
			...
			if (((GraphicsToolkit) this).anInt5310 * 929186669 >= 0) {
				...
				((GraphicsToolkit) this).aClass52_Sub1Array5304[((GraphicsToolkit) this).anInt5310 * 929186669]
						.method136();
			} else {
				aClass52_5292 = aClass52_Sub2_5312;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ra.aw(").append(')').toString());
		}
	}

	abstract Class52_Sub2 method5006(Canvas canvas, int i, int i_28_);

	public abstract void method5007(int i, int i_29_, int i_30_, int i_31_,
			int i_32_, int i_33_, Class_ta class_ta, int i_34_, int i_35_,
			int i_36_, int i_37_, int i_38_);

	public abstract Class222 method5008();

	abstract void method5009();

	public abstract void method5010(int i, int i_39_, int i_40_, int i_41_,
	...
	public abstract Class222 method5013();
	...
	public final void method5014(int i, int i_50_, int i_51_, int i_52_,
			int i_53_, int i_54_) {
		try {
			method5019(i, i_50_, i_51_, i_52_, i_53_, 1);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ra.ar(").append(')').toString());
		}
	}

	public final void method5015(int i, int i_55_, int i_56_, int i_57_,
			int i_58_, byte i_59_) {
		try {
			B(i, i_55_, i_56_, i_57_, i_58_, 1);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ra.ac(").append(')').toString());
		}
	}
	...
	public final void method5018(int i, int i_65_, int i_66_, int i_67_,
			int i_68_, int i_69_) {
		try {
			method5091(i, i_65_, i_66_, i_67_, i_68_, 1);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ra.be(").append(')').toString());
		}
	}

	public abstract void method5019(int i, int i_70_, int i_71_, int i_72_,
			int i_73_, int i_74_);

	public abstract void XA(int i, int i_75_, int i_76_, int i_77_, int i_78_);

	public abstract void method5020(int i, int i_79_, float f, int i_80_,
			int i_81_, float f_82_, int i_83_, int i_84_, float f_85_,
	...
	public abstract void method5022(int i, int i_100_, int i_101_, int i_102_,
			int i_103_, int i_104_, Class_ta class_ta, int i_105_, int i_106_);

	abstract void method5023();

	public abstract int method5024(int i, int i_107_);

	public abstract int method5025(int i, int i_108_, int i_109_, int i_110_,
	...
	public abstract Class66 method5028(int i, int i_113_, int i_114_,
			int i_115_, int i_116_, int i_117_);

	public abstract Class57 method5029(int i, int i_118_, boolean bool,
			boolean bool_119_);

	public abstract Class57 method5030(int[] is, int i, int i_120_, int i_121_,
			int i_122_, boolean bool);

	public Class57 method5031(int[] is, int i, int i_123_, int i_124_,
			int i_125_, int i_126_) {
		try {
			return method5030(is, i, i_123_, i_124_, i_125_, true);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ra.bp(").append(')').toString());
		}
	}

	public abstract boolean method5032();

	public abstract Class57 method5033(int i, int i_127_, int i_128_,
			int i_129_, boolean bool);

	public abstract Class_ta method5034(int i, int i_130_, int[] is,
			int[] is_131_);
	...
	public abstract void method5039(int i, int i_147_, int i_148_, int i_149_,
			int i_150_, int i_151_, int i_152_, int i_153_, int i_154_);

	public abstract Class_xa method5040(int i, int i_155_, int[][] is,
			int[][] is_156_, int i_157_, int i_158_, int i_159_);
	...
	public boolean method5041(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ra.cx(").append(')').toString());
		}
	}

	public abstract void method5042(Class69 class69);

	public abstract void method5043(Class222 class222);

	public abstract Class222 method5044();

	public abstract void RA(boolean bool);

	public abstract Class233 method5045();

	public abstract void ey(float f, float f_160_);

	public abstract void m(int i, float f, float f_161_, float f_162_,
			float f_163_, float f_164_);
	...
	public Class298_Sub10 method5049(int i, int i_169_, int i_170_, int i_171_,
			int i_172_, float f) {
		try {
			return new Class298_Sub10(i, i_169_, i_170_, i_171_, i_172_, f);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ra.cg(").append(')').toString());
		}
	}
	...
	public abstract void method5055(float f, float f_175_, float f_176_,
			float[] fs);
	...
	public abstract void method5059(float f, float f_180_, float f_181_,
			float[] fs);

	public abstract void method5060(float f, float f_182_, float f_183_,
			float[] fs);
	...
	public abstract Class233 method5083();

	public abstract int[] eg(int i, int i_188_, int i_189_, int i_190_);

	public abstract Class66 method5084(int i, int i_191_, int i_192_,
	...
	public abstract Class_xa method5087(int i, int i_196_, int[][] is,
			int[][] is_197_, int i_198_, int i_199_, int i_200_);
	...
	public abstract void method5088(int i, int i_202_, int i_203_, int i_204_,
			int i_205_, int i_206_, Class_ta class_ta, int i_207_, int i_208_);
	...
	public abstract void method5091(int i, int i_221_, int i_222_, int i_223_,
			int i_224_, int i_225_);

	public abstract void fy(int i, int i_226_);

	public abstract Class264 method5092(Class505 class505, Class89[] class89s,
			boolean bool);
	...
	public abstract void method5093(int i, int i_229_, int i_230_, int i_231_,
			int i_232_, int i_233_);

	public abstract void fa(int i, int i_234_, int i_235_, int i_236_,
			int i_237_, int i_238_);

	public abstract void fo(int i, int i_239_, int i_240_, int i_241_,
			int i_242_, int i_243_, byte[] is, int i_244_, int i_245_);
	...
	public abstract void ff(int i, int i_254_, int i_255_, int i_256_,
			int i_257_);

	public abstract void fd(int i, int i_258_, int i_259_, int i_260_,
			int i_261_);

	public abstract void ft(int i, int i_262_, int i_263_, int i_264_,
			int i_265_);

	public abstract void fu(int i, int i_266_, int i_267_, int i_268_,
			int i_269_);

	public abstract void fl(int i, int i_270_, int i_271_, int i_272_,
			int i_273_);
	...
	public abstract void method5096(int i, int i_277_, int i_278_, int i_279_,
			int i_280_, int i_281_, Class_ta class_ta, int i_282_, int i_283_);

	public abstract void method5097(int i, int i_284_, int i_285_, int i_286_,
			int i_287_, int i_288_, Class_ta class_ta, int i_289_, int i_290_);

	public abstract void method5098(int i, int i_291_, int i_292_, int i_293_,
			int i_294_, int i_295_, Class_ta class_ta, int i_296_, int i_297_,
			int i_298_, int i_299_, int i_300_);

	public abstract int method5099(int i, int i_301_, int i_302_, int i_303_,
			int i_304_, int i_305_);

	public abstract int method5100(int i, int i_306_, int i_307_, int i_308_,
	...
	public abstract Class57 method5104(int i, int i_311_, boolean bool,
			boolean bool_312_);

	public abstract Class57 method5105(int[] is, int i, int i_313_, int i_314_,
			int i_315_, boolean bool);

	public abstract Class57 method5106(int[] is, int i, int i_316_, int i_317_,
			int i_318_, boolean bool);

	public abstract Class57 method5107(Class89 class89, boolean bool);

	public abstract Class57 method5108(int i, int i_319_, int i_320_,
			int i_321_, boolean bool);

	public abstract Class_ta method5109(int i, int i_322_, int[] is,
			int[] is_323_);

	public abstract Class_ta method5110(int i, int i_324_, int[] is,
			int[] is_325_);
	...
	public abstract Class264 method5113(Class505 class505, Class89[] class89s,
			boolean bool);

	public abstract Class264 method5114(Class505 class505, Class89[] class89s,
			boolean bool);
	...
	public abstract Class_xa method5121(int i, int i_334_, int[][] is,
			int[][] is_335_, int i_336_, int i_337_, int i_338_);

	public abstract Class_xa method5122(int i, int i_339_, int[][] is,
			int[][] is_340_, int i_341_, int i_342_, int i_343_);

	public abstract Class_xa method5123(int i, int i_344_, int[][] is,
			int[][] is_345_, int i_346_, int i_347_, int i_348_);
	...
	public abstract void B(int i, int i_350_, int i_351_, int i_352_,
	...
	public abstract void method5129(Class222 class222);

	public abstract void method5130(Class222 class222);

	public abstract void method5131(Class222 class222);

	public abstract void method5132(Class222 class222);

	public abstract void method5133(Class233 class233);

	public abstract void method5134(Class233 class233);

	public abstract int method5135(int i, int i_360_, int i_361_, int i_362_,
			int i_363_, int i_364_);
	...
	public void method5136(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ra.y(").append(')').toString());
		}
	}

	public abstract void hg(int i, float f, float f_365_, float f_366_,
	...
	public abstract void method5139(int i, int i_373_, float f, int i_374_,
			int i_375_, float f_376_, int i_377_, int i_378_, float f_379_,
			int i_380_, int i_381_, int i_382_, int i_383_);

	public abstract Class66 method5140(int i, int i_384_, int i_385_,
			int i_386_, int i_387_, int i_388_);

	abstract void method5141();

	public abstract Class66 method5142(Class66 class66, Class66 class66_389_,
			float f, Class66 class66_390_);
	...
	public final void method5143(Class52_Sub1 class52_sub1, byte i) {
		try {
			if (929186669 * ((GraphicsToolkit) this).anInt5310 >= 3)
				throw new RuntimeException();
			if (((GraphicsToolkit) this).anInt5310 * 929186669 >= 0)
				((GraphicsToolkit) this).aClass52_Sub1Array5304[929186669 * ((GraphicsToolkit) this).anInt5310]
						.method546();
			else
	...
	abstract void method5150(float f, float f_391_, float f_392_, float f_393_,
	...
	public abstract void method5157(int i, int i_399_, float f, int i_400_,
			int i_401_, float f_402_, int i_403_, int i_404_, float f_405_,
			int i_406_, int i_407_, int i_408_, int i_409_);

	public abstract void method5158(int i, int i_410_, float f, int i_411_,
			int i_412_, float f_413_, int i_414_, int i_415_, float f_416_,
			int i_417_, int i_418_, int i_419_, int i_420_);

	public abstract boolean method5159();

	public abstract void method5160(float f, float f_421_, float f_422_,
			float[] fs);

	public abstract void method5161(float f, float f_423_, float f_424_,
			float[] fs);

	public abstract void method5162(float f, float f_425_, float f_426_,
			float[] fs);
	...
	public final void method5163(Canvas canvas, int i, int i_427_, int i_428_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ra.ai(").append(')').toString());
		}
	}

	public abstract void method5164(float f, float f_429_, float f_430_,
			float[] fs);
	...
	public abstract void method5167(int i, int i_432_, int i_433_, int i_434_,
			int i_435_, int i_436_);

	public abstract void method5168(int i, int i_437_, int i_438_, int i_439_,
	...
	public abstract Class222 method5171();

	public abstract Class233 method5172();
	...
	public abstract Class66 method5179(Class66 class66, Class66 class66_447_,
			float f, Class66 class66_448_);
	...
	public abstract Class66 method5181(int i, int i_453_, int i_454_,
			int i_455_, int i_456_, int i_457_);

	public abstract void hj(int i, int i_458_, int i_459_);

	public abstract void method5182(Class233 class233);

	public abstract Class222 method5183();

	public abstract void method5184(boolean bool);

	public abstract Class66 method5185(int i, int i_460_, int i_461_,
			int i_462_, int i_463_, int i_464_);
	...
	protected void finalize() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ra.finalize(").append(')').toString());
		}
	}
	...
	abstract void method5188(float f, float f_469_, float f_470_, float f_471_,
			float f_472_, float f_473_);

	public abstract void method5189(Class66 class66);

	public abstract void fi(int i, int i_474_, int i_475_, int i_476_,
			int i_477_, int i_478_, byte[] is, int i_479_, int i_480_);

	public abstract void IA(float f);

	public abstract Class57 method5190(int[] is, int i, int i_481_, int i_482_,
			int i_483_, boolean bool);

	static void method5191(int i) {
		try {
			if (null != Class82_Sub6.aClass227_6843) {
				Class288_Sub1.aClass219_7147 = new Class219();
				Class288_Sub1.aClass219_7147
						.method2043(
								-4360787748556788915L * Class230.aLong2560,
								((Class227) Class82_Sub6.aClass227_6843).aClass470_2549
										.method6049(Class321.aClass429_3357,
												-875414210),
								(360399239 * ((Class227) Class82_Sub6.aClass227_6843).anInt2551),
								Class82_Sub6.aClass227_6843, 180676280);
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ra.f(").append(')').toString());
		}
	}

	static void method5192(int i, int i_484_, int i_485_, int i_486_,
			int i_487_, int i_488_, int i_489_,
			Class298_Sub37_Sub15 class298_sub37_sub15, Class264 class264,
			Class505 class505, int i_490_, int i_491_, int i_492_) {
		try {
			if (i > i_485_
					&& i < i_485_ + i_487_
					&& i_484_ > i_489_ - class505.anInt6202 * 1110385787 - 1
					&& i_484_ < i_489_ + -1883958527 * class505.anInt6197
					&& ((Class298_Sub37_Sub15) class298_sub37_sub15).aBoolean9664)
				i_490_ = i_491_;
			...
			if (is != null)
				string = new StringBuilder().append(string).append(
						Class216.method1999(is, (byte) 1)).toString();
			class264.method2480(string, 3 + i_485_, i_489_, i_490_, 0,
					client.aRandom8702, Class368.anInt4005 * 1401020893,
					Class436.aClass57Array5501, Class422_Sub3.anIntArray8372,
					65280);
			if (((Class298_Sub37_Sub15) class298_sub37_sub15).aBoolean9665)
				Graphics.aClass57_573.method645(i_485_ + 5
						+ class505.method6264(string, 1318090489), i_489_
						- 1110385787 * class505.anInt6202);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ra.an(").append(')').toString());
		}
	}

	static final void method5193(Class403 class403, byte i) {
		try {
			int i_493_ = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]);
	...
	static long method5194(CharSequence charsequence, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ra.a(").append(')').toString());
		}
	}

	static void method5195(GraphicsToolkit class_ra, IComponentDefinition class105, int i,
			int i_496_, byte i_497_) {
		try {
			...
			if (null != class117) {
				...
				if (2 != -64305285 * Class3.anInt56
						...
						&& null != Class384.aClass57_4127) {
					Class341 class341 = client.aClass283_8716
							.method2628(681479919);
					int i_498_;
					int i_499_;
					int i_500_;
					int i_501_;
					...
					int i_503_ = (48 + client.aClass283_8716
					...
					Class296 class296 = client.aClass283_8716
							.method2631(-337725639);
					for (Class298_Sub35 class298_sub35 = ((Class298_Sub35) Class3.aClass453_61
							.method5939(1766612795)); class298_sub35 != null; class298_sub35 = ((Class298_Sub35) Class3.aClass453_61
							.method5944(49146))) {
						int i_504_ = class298_sub35.anInt7394 * -774922497;
						int i_505_ = ((class296.anIntArray3168[i_504_] >> 14 & 0x3fff) - -1760580017
						...
						Class248.method2389(class_ra, class_ta, class105, i,
								i_496_, i_507_, i_508_,
								class296.anIntArray3170[i_504_], (byte) 0);
					}
					for (int i_509_ = 0; i_509_ < 1659101557 * Class3.anInt67; i_509_++) {
						...
						ObjectDefinitions class432 = (client.aClass283_8716
								.method2641(2011176396).getObjectDefinitions(
								Class3.anIntArray60[i_509_]));
						if (null != class432.anIntArray5366) {
							class432 = class432.method5777(
									Class128.aClass148_6331, 1042930561);
							if (null == class432)
								continue;
						...
						Class248.method2389(class_ra, class_ta, class105, i,
								i_496_, i_510_, i_511_, class432.anInt5399
										* -1422593103, (byte) 0);
					}
					for (Class298_Sub2 class298_sub2 = ((Class298_Sub2) client.aClass437_8685
						...
						if (i_512_ == Class3.anInt57 * -1694437021) {
							...
							Class443.method5883(class105, class_ta, i, i_496_,
									i_515_, i_516_,
									SubIncommingPacket.aClass57Array2349[0], (byte) 16);
						}
					}
					Class422_Sub10.method5662(class_ra, i_498_, i_499_,
							class105, class_ta, i, i_496_, 826111295);
					Class346.method4171(i_498_, i_499_, class105, class_ta, i,
							i_496_, 1913514572);
					Class74.method832(i_498_, i_499_, class105, class117, i,
							i_496_, -1636621855);
					if (2 != Class298_Sub1.anInt7164 * -863531439) {
						if (Class3.anInt62 * 2076926079 != 0) {
							int i_517_ = (-282230276 * Class3.anInt62 + 2
									- i_498_ / 128 + (Class287.myPlayer
									.getSize() - 1) * 2);
							int i_518_ = (2 + Class3.anInt54 * -1505214580
									- i_499_ / 128 + (Class287.myPlayer
									.getSize() - 1) * 2);
							Class443
									.method5883(
											class105,
											...
											i_517_,
											i_518_,
											(Class234.aClass57Array2598[Class3.aBoolean63 ? 1
													: 0]), (byte) 23);
						}
