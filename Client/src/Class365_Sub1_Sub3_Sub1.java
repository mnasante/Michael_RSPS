...
public class Class365_Sub1_Sub3_Sub1 extends Class365_Sub1_Sub3 implements
		Interface3 {
	...
	Class335 method4394(GraphicsToolkit class_ra, int i) {
		try {
			...
			Class335 class335 = Class73
					.method818((((Class365_Sub1_Sub3_Sub1) this).aBoolean9904),
							1881845078);
	...
	public Class365_Sub1_Sub3_Sub1(Class331 class331, GraphicsToolkit class_ra,
		...
		aClass60_9906 = new Class60(class_ra, class433, class432, i_17_, i_18_,
				plane, i_11_, this, bool, i_19_);
		((Class365_Sub1_Sub3_Sub1) this).aBoolean9904 = 1532834983 * class432.anInt5382 != 0
				&& !bool;
	...
	public static void method4507(long[] ls, Object[] objects, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("wl.r(").append(')').toString());
		}
	}

	public static String[] method4508(String string, char c, int i) {
		try {
			int i_21_ = Class314.method3831(string, c, -452041917);
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("wl.h(").append(')').toString());
		}
	}

	static final void method4509(IComponentDefinition class105, Class119 class119,
			Class403 class403, byte i) {
		try {
			class105.method1122(333321190);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("wl.kx(").append(')').toString());
		}
	}
}
