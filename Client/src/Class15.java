...
public class Class15 {
	...
	Class15(Class_ra_Sub1 class_ra_sub1) {
		...
		((Class15) this).aClass233_190 = new Class233();
		((Class15) this).aClass222_219 = new Class222();
	...
	void method347(Runnable runnable, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ap.f(").append(')').toString());
		}
	}

	void method348(int i) {
		try {
			((Class15) this).aClass2_192 = new Class2(
					((Class15) this).aClass_ra_Sub1_182, this);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ap.a(").append(')').toString());
		}
	}
	...
	static final void method349(Class403 class403, int i) {
		try {
			...
			ItemDefinitions class468 = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(
					i_0_);
			if (-1673957995 * class468.anInt5755 == -1
					&& 809765849 * class468.anInt5709 >= 0)
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = 809765849 * class468.anInt5709;
			else
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = i_0_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ap.aal(").append(')').toString());
		}
	}
	...
	static final void method350(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class379.anIntArray4096[Class173
					.method1823(i_1_, (byte) 0) & 0xffff]);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ap.zl(").append(')').toString());
		}
	}
	...
	static final void method351(Class403 class403, int i) {
		try {
			...
			Class21.method365(class105, class119, false, 1, class403,
					1620962996);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ap.hp(").append(')').toString());
		}
	}
}
